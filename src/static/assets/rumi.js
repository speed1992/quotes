export const RUMI = [
    ...
    "In the desire of the One to know Himself, \n We exist.",
    ...
    "Respond to every call that excites your spirit.",
    "Let yourself be silently drawn by the strange pull of what you really love. It will not lead you astray.",
    "Sit, be still, and listen,because you're drunkand we're atthe edge of the roof.",
    ...
    "People want you to be happy.Don't keep serving them your pain!If you could untie your wingsand free your soul of jealousy,you and everyone around youwould fly up like doves.",
    "When you go through a hard period,When everything seems to oppose you,... When you feel you cannot even bear one more minute,NEVER GIVE UP!Because it is the time and place that the course will divert!",
    "Start a huge, foolish project, like Noah…it makes absolutely no difference what people think of you.",
    "The cure for pain is in the pain.",
    ...
    "You wander from room to roomHunting for the diamond necklaceThat is already around your neck!",
    "You are the universe in ecstatic motion.",
    ...
    "God turns you from one feeling to another and teaches by means of opposites so that you will have two wings to fly, not one",
    "Here is a relationship boosterthat is guaranteed towork:Every time your spouse or lover says something stupidmake your eyes light up as if youjust heard somethingbrilliant.",
    ...
    "When you feel a peaceful joy, that's when you are near truth.",
    "Let the beauty of what you love be what you do.",
    "On a daywhen the wind is perfect,the sail just needs to open and the world is full of beauty.Today is such aday.",
    ...
    "Anyone who knows me, should learn to know me again;For I am like the Moon,you will see me with new face everyday.",
    "There is a secret medicine given only to those who hurt so hard they can't hope.The hopers would feel slighted if they knew.",
    "Within tears, find hidden laughterSeek treasures amid ruins, sincere one.",
    ...
    "You think you are alivebecause you breathe air?Shame on you, that you are alive in such a limited way.Don't be without Love, so you won't feel dead.Die in Love and stay alive forever.",
    "مَنْ لا يركضإلى فتنة العشقيمشي طريقالا شيء فيه حي.",
    "The rose's rarest essence lives in the thorns.",
    "لعل الله يأخذك من حال لآخر .. ويجعلك تختبر الشعور ونقيضه ،لـ يجعل لك جناحين لتطير بهما إليه .. وليس جناحا واحدا !",
    ...
    "وضع الله أمامنا سلّمًا علينا أن نتسلقه درجةً إثر درجةلديك قدمان فلِمَ التظاهر بالعرج ؟",
    "This place is a dream. Only a sleeper considers it real. Then death comes like dawn, and you wake up laughing at what you thought was your grief.",
    "The lion is most handsome when looking for food.",
    "Not only the thirsty seek the water, the water as well seeks the thirsty.",
    ...
    "Pain is a treasure, for it contains mercies.",
    "Do not leave me,hide in my heart like a secret,wind around my head like a turban.\"I come and go as I please,\"you say, \"swift as a heartbeat.\"You can tease me as much as you likebut never leave me.",
    ...
    "Let silence take you to the core of life.",
    "Give your weakness to one who helps.",
    "لا يهدأ قلب العاشق قط ما لم يُبادله المحبوب الوله.وحين يُشع نور الحب فى القلب فذاك يعنى أن هناك إحساساً بالحب فى القلب الآخر.",
    "She loved him so much she concealed his name in many phrases, the inner meanings known only to her.",
    "Love calls - everywhere and always. We're sky bound.Are you coming?",
    "The only lasting beauty is the beauty of the heart",
    ...
    "In the house of lovers, the music never stops, the walls are made of songs & the floor dances",
    "Soul, if you want to learn secrets, your heart must forget about shame  and dignity. You are God's lover, yet you worry what people are saying.",
    "Love is the cure,for your pain will keep giving birth to more painuntil your eyes constantly exhale love as effortlessly as your body yields its scent.",
    "Love is the whole thing. We are only pieces.",
    "I searched for God and found only myself. I searched for myself and found only God.",
    ...
    "To live without youis to be robbed of loveand what is life without it?To live without youis death to me, my lovebut some call it life.",
    "I don't want learning, or dignity, or respectability. I want this music, and this dawn, and the warmth of your cheek against mine.",
    "The universe and the light of the stars come through me.",
    "If in the darkness of ignorance, you don’t recognize a person’s true nature, look to see whom he has chosen for his leader.",
    "I, you, he, she, weIn the garden of mystic lovers,these are not true distinctions.",
    "Learn the alchemy true human beings know. The moment you accept what troubles you've been given the door with open.",
    "The ground's generosity takes in our compost and grows beauty! Try to be more like the ground.",
    "Listen with ears of tolerance! See through the eyes of compassion! Speak with the language of love",
    ...
    "If Light Is In Your HeartYou Will Find Your Way Home.",
    ...
    "Listen, O drop, give yourself up without regret,and in exchange gain the Ocean.Listen, O drop, bestow upon yourself this honor,and in the arms of the Sea be secure.Who indeed should be so fortunate?An Ocean wooing a drop!In God's name, in God's name, sell and buy at once!Give a drop, and take this Sea full of pearls.",
    "I am so close, I may look distant.So completely mixed with you, I may look separate.So out in the open, I appear hidden.So silent, because I am constantly talking with you.",
    "Look past your thoughts, so you maydrink the pure nectar of This Moment.",
    "Whenever we manage to love without expectations, calculations, negotiations, we are indeed in heaven.",
    "Whatever purifies you is the right path, I will not try to define it.",
    "The world's flattery and hypocrisy is a sweet morsel:eat less of it, for it is full of fire.Its fire is hidden while its taste is manifest,but its smoke becomes visible in the end.",
    "As you start to walk on the way, the way appears.",
    "ﻟﻠﻤﺮﺃﺓ ﺣﻀﻮﺭ خفي .. لا يراه ويهتدي به إلا رجل متفتح عارف.فهناك ﻧﻮﻉ ﺁﺧﺮ ﻣﻦ ﺍﻟﺮﺟﺎﻝ .. ﺑﺪﺍﺧﻠﻬﻢ ﺣﻴﻮﺍﻥ ﻣﺤﺒﻮﺱ!ليت هؤلاء ﻳﻘﻮّﻣﻮﻥ ﺃﻧﻔﺴﻬﻢ ﺃﻭﻻ‌ ..ليتهم يعرفون أن ﺍﻟﻤﺤﺒﺔ ﻭﺍﻟﺘﻔﻬﻢ ﻫﻲ ﻣﺎ ﺗﺠﻌﻠﻨﺎ ﺑﺸﺮﺍ ، ﺃﻣﺎ ﺍلشهوة ﻭﺍﻟﺤﻤّﻴﺔ .. ﻓﻼ‌ !فرﺑﻤﺎ ﻛﺎﻧﺖ ﺍﻟﻤﺮﺃﺓ ﻧﻮﺭﺍ ﻣﻦ نور ﺍﻟﻠﻪ .. ﺭﺑﻤﺎ ﻛﺎﻧﺖ ﺧﻼ‌ﻗﺔ ﻭﻟﻴﺴﺖ ﻣﺨﻠﻮﻗﺔ،ﺭﺑﻤﺎ ﻫﻲ ﻟﻴﺴﺖ ﻣﺠﺮﺩ ﺫﻟﻚ ﺍﻟﺸﻜﻞ ﺍﻷ‌ﻧﺜﻮﻱ ﺍﻟﻨﺎﻋﻢ ﺍﻟﺬﻱ ﺗﺮﺍﻩ !",
    "You had better run from me. My words are fire.",
    "Never lose hope, my heart, miracles dwell in the invisible. If the whole world turns against you keep your eyes on the Friend.",
    "Where the lips are silent the heart has a thousand tongues.",
    ...
    "Keep on knocking'til the joy insideopens a windowlook to see who's there",
    "No more words. In the name of this place we drink in with our breathing, stay quiet like a flower.So the nightbirds will start singing.",
    ...
    "إننى أعشق الحزن والألم كى أسعد مليكى الذى لا شبيه له، والدموع التى تنهمر من عينى لأجله هى لآلئ رغم أن الناس يرونها دموعاً.",
    ...
    "Dance until you shatter yourself.",
    "Everyone has been made for some particular work and the desire for that work has been put in every heart.",
    "إن الحكمة الإلهية حدت بنا أن نحب بعضنا بعضاً بدرجات يُمليها القضاء والقدر.وبسبب ذلك القرار المُتخذ مسبقاً فإن كل من فى العالم مقترن بمن يألفه.",
    "Speak a new languageso that the worldwill be a new world.",
    "There is a basket of fresh bread on your head, yet you go door to door asking for crusts.",
    "When the light returns to its source, it takes nothing of what it has illuminated.",
    "I want your sun to reach my raindrops, so your heat can raise my soul upward like a cloud.",
    "Hardship may dishearten at first, but every hardship passes away. All despair is followed by hope; all darkness is followed by sunshine.",
    "The same wind that uproots treesmakes the grass shine.The lordly wind loves the weaknessand the lowness of grasses.Never brag of being strong.The axe doesn't worry how thick the branches are.It cuts them to pieces. But not the leaves.It leaves the leaves alone.",
    "There came one and knocked at the door of the Beloved.And a voice answered and said, 'Who is there?'The lover replied, 'It is I.''Go hence,' returned the voice;'there is no room within for thee and me.'Then came the lover a second time and knocked and again the voice demanded,'Who is there?'He answered, 'It is thou.''Enter,' said the voice, 'for I am within.",
    ...
    "Hear this if you can:If you want to reach himYou have to go beyond yourselfAnd when you finally arrive at the land of absenceBe silentDon’t say a thingEcstasy, not words, is the language spoken there",
    "A strange passion is moving in my head My heart has become a bird which searches in the sky. Every part of me goes in different directions. Is it really so that the one I love is Everywhere?",
    "I said to the night, \"If you are in love with the moon, it is because you never stay for long.\"The night turned to me and said, \"It is not my fault. I never see the Sun, how can I know that love is endless?",
    "Your longing for ME is my message to you,All your attempts to reach ME, Are in reality MY attempts to reach you.",
    "The angel is free because of his knowledge, the beast because of his ignorance. Between the two remains the son of man to struggle.",
    ...
    "The fault is in the one who blames. Spirit sees nothing to criticize.",
    "My friend, you thought you lost Him;that all your life you've been separated from Him.Filled with wonder, you've always looked outside for Him,and haven't searched within your own house.",
    "There are thousands of winesthat can take over our minds.Don't think all ecstasiesare the same!Jesus was lost in his love for God.His donkey was drunk with barley.",
    "I want a trouble-maker for a lover, blood spiller, blood drinker, a heart of flame, who quarrels with the sky and fights with fate, who burns like fire on the rushing sea.",
    "حسبت أني حكمت نفسي،فتأسيت على زمان مضى، أخذاً في اعتباري، شيئاً وحيداً أعلمه لست أدري من أنا،",
    "Thankfulness brings you to the place where the Beloved lives.",
    "Love so needs to lovethat it will endure almost anything, even abuse,just to flicker for a moment. But the sky's mouth is kind,its song will never hurt you, for Ising those words.",
    "قد ينتهي طريق عند بيت واحد،لكن ليس طريق العشق. العشق نهر.اشرب منه.",
    "For the thirst to possess your love,Is worth my blood a hundred times.",
    "There is a loneliness more precious than life. There is a freedom more precious than the world. Infinitely more precious than life and the world is that moment when one is alone with God.",
    "أنا أشبه أنا واحدنا يشبه الآخر",
    "Whoever finds lovebeneath hurt and griefdisappears into emptinesswith a thousand new disguises",
    "You're water. We're the millstone.You're wind. We're dust blown up into shapes.You're spirit. We're the opening and closing of our hands. You're the clarity.We're the language that tries to say it.You're joy. We're all the different kinds of laughing.",
    "If you want to be more alive, love is the truest health.",
    ...
    "People who repress desiresoften turn, suddenly,into hypocrites.",
    ...
    "Into this new love, dieyour way beginson the other sidebecome the skytake an axe to the prison wall,escapewalk out like someonesuddenly born into colordo it now",
    "Your magnificence has made me a wonder. Your charm has taught me the way of love.",
    "The Water said to the dirty one, “Come here.The dirty one said, “I am too ashamed.”The water replied, “How will your shame be washed away without me?”",
    ...
    "Love said to me, there is nothing that is not me. Be silent.",
    "You've seen my descent, now watch my rising.",
    "Bring the pure wine oflove and freedom.But sir, a tornado is coming.More wine, we'll teach this stormA thing or two about whirling.",
    "Although the road is never endingtake a step and keep walking,do not look fearfully into the distance...On this path let the heart be your guidefor the body is hesitant and full of fear.",
    "Let the waters settle and you will see the moon and the stars mirrored in your own being.",
    ...
    "Are you jealous of the ocean’s generosity?Why would you refuse to givethis joy to anyone?Fish don’t hold the sacred liquid in cups!They swim the huge fluid freedom.",
    "O my choice beautyYou've goneBut your love remains in my heartYour image in my eyeO guide on my winding roadI keep turning round and round in the hopes ofFinding you",
    ...
    "حين يطلق الصياد صفيره الذى يشبه صوت الطائرفإن هدفه اصطياد ذلك الطائرإذ يجعله يهبط إلى الأرض نحو الصوت ليجد نفسه واقعا فى الشركذلك ما يفعله التافه الذى يستعمل لفة الدراويش ليغش البسطاء من الناسإن أعمال التقاة من الناس ضوء ودفءوعمل الأشرار خزى واحتيال.",
    "We love that s why life is full of so many wonderful gifts.",
    "Doing as others told me, I was Blind.Coming when others called me, I was Lost.Then I left everyone, myself as well.Then I found Everyone, Myself as well.",
    ...
    "As you live Deeper in the Heart, the Mirror gets clearer and cleaner.",
    "The intelligent desire self-control; children want candy.",
    "Look carefully around you and recognizethe luminosity of souls.Sit beside those who draw you to that.",
    "A servant wants to be rewarded for what he does. A lover wants only to be in love's presence, that ocean whose depth will never be known.",
    "Every story is us",
    "There are thousands of wines that can take over our minds. Don't think all ecstasies are the same!",
    ...
    "لتَكُن غايتك للانتهاء ابتداء\"لستُ علي الدوام ذلك الشخص الذي كنت عليهفأنا أرحل عنِّي في كل مرةٍ أصير فيها إليّ\".",
    ...
    "With passion pray. With passion make love. With passion eat and drink and dance and play. Why look like a dead fish in this ocean of God?",
    "Someone who does not run toward the allure of love walks a road where nothing lives.",
    "ﺍﻟﻌﻤﺮ ﺍﻟﺬﻯ ﻣﺮ ﺑﻠﺎ ﻋﺸﻖ ﻛﺄﻧﻪ ﻟﻢ يكن،ﻓﺎﻟﻌﺸﻖ ﻣﺎﺀ ﺍﻟﺤﻴﺎة، ﺗﻘﺒﻠﻪ ﺑﻘﻠﺒﻚ ﻭﺭﻭﺣﻚ .وﻛﻞ ﻣﻦ ﻟﺎ يعشقون ﺍﻋﺘﺒﺮﻫﻢ أﺳﻤﺎﻛًﺎ ﺧﺮﺟﺖ ﻣﻦ ﺍﻟﻤﺎﺀ.ﺍﻋﺘﺒﺮﻫﻢ ﻣﻮﺗﻰ ﺫﺍﺑﻠﻴﻦ، ﺣﺘﻰ ﻭإﻥ ﻛﺎﻧﻮﺍ ملوكًا",
    "I cannot sleep in your presenceIn your absence, tears prevent meyou watch me my belovedon each sleepiness night andOnly you see the difference",
    "I went inside my heartto see how it was.Something there makes me hearthe whole world weeping.",
    "How will you know the difficulties of being human, if you are always flying off to blue perfection? Where will you plant your grief seeds? Workers need ground to scrape and hoe, not the sky of unspecified desire.",
    "I would love to kiss you.The price of kissing is your life.",
    ...
    "No one can tell if I’m laughing or weeping.I wonder myself.",
    "عشق جان استعشقِ توجان تر\"مولوی",
    "Love asks us to enjoy our life For nothing good can come of death. Who is alive? I ask. Those who are born of love. Seek us in love itself, Seek love in us ourselves. Sometimes I venerate love, Sometimes it venerates me.",
    "come on sweetheartlet's adore one anotherbefore there is no moreof you and me",
    "Peaceful is the one who's not concerned with having more or less.Unbound by name and fame, he is free from sorrow from the world and mostly from himself.",
    "ما لهذا النهار بشمسين في السماء؟ ليس كمثله نهار",
    "make your last journeyfrom this strange worldsoar for the heightswhere there is no moreseparation of you and your homeGod has createdyour wings not to be dormantas long as you are aliveyou must try more and moreto use your wings to show you're alive",
    "Don't turn away. Keep your gaze on the bandaged place. That's where the light enters you.",
    "A lover knows only humility, he has no choice.He steals into your alley at night, he has no choice.He longs to kiss every lock of your hair, don't fret, he has no choice.In his frenzied love for you, he longs to break the chains of his imprisonment, he has no choice.",
    "إنّ النّــــاي نَديمٌ لكُلّ مَن فَرّقَهُ الدّهرُ عن حَبيب، وإنّ أنغامَهُ قد مزّقت ما يغشّى أبصارنا من حُجُب.",
    ...
    "لقد انتقل الحب وهيامه بقوة وذهبا بعيداً فذوت النار ولم تترك خلفها إلا بعض الرماد.",
    "Flow down and down in always widening rings of being.",
    ...
    "You left ground and sky weeping,mind and soul full of grief.No one can take your place in existence,or in absence. Both mourn, the angels, the prophets,and this sadness I feel has taken from methe taste of language, so that I cannot saythe flavor of my being apart.",
    "Conventional opinion is the ruin of our souls.",
    ...
    "Be motivated like the falcon,hunt gloriously.Be magnificent as the leopard,fight to win.Spend less time withnightingales and peacocks.One is all talk,the other only color.",
    "If it is bread that you seek, you will have bread. If it is the soul you seek, you will find the soul. If you understand this secret, you know you are that which you seek.",
    "We can't help being thirsty, moving toward the voice of water.",
    "This poetry. I never know what I'm going to say.I don't plan it.When I'm outside the saying of it,I get very quiet and rarely speak at all.",
    "And patience flees my heart, And reason flees my mind. Oh, how drunk can I get to be,Without your love's security?",
    ...
    "Hall of Love has ten thousand swords. Don't be afraid to use one.",
    "فأدنيتُ من شَفَتي إلى وجنتِكزاعما إنّني أتكلّمُ في خاصةٍ",
    ...
    "لن أستطيع أن اصل إليك وليس في وسعي أن أفصل نفسي عنك",
    ...
    "Sometimes you hear a voice through the door calling you... This turning toward what you deeply love saves you.",
    "Look for the answer inside your question.",
    "Which is worth more, a crowd of thousands,or your own genuine solitude?Freedom, or power over an entire nation?A little while alone in your roomwill prove more valuable than anything elsethat could ever be given you.",
    ...
    "Where lowland is, that's where water goes. All medicine wants is pain to cure.",
    "What? Are you still pretending you are separate from the Beloved?",
    "لست واحدا قائما بداتك أيها الرفيق، بل إنك فلك و بحر عميق.",
    "Without the frown of clouds and lightning, the vines would be burned by the smiling sun.",
    ...
    "فى يوم وفاتى عندما يسيرون بنعشىلا تظن أنى متألم لفراق هذا العالمفلا تبك من أجلى ولا تقل وا أسفاه وا أسفاهفوقوعك فى مخيض الشيطان مدعاة للأسفوعندما ترى نعشى لا تصرخ: الفراقفوصالى هو فى هذا الزمان ولقائىوحين أودع القبر لا تقل الوداع الوداعفالقبر هو حجاب على مجمع الجنان.",
    ...
    "The middle path is the way to wisdom",
    "كن صامتاً، انظر كيف يفتح الله الباب - لماذا انت ضائع في الفكره التي تغلق الباب ؟!",
    ...
    "سأل سائل : ما هو الحب؟فجاءه الرد: ستعرف عندما تضيع فيه..فالأفلاك التي تدور في سماواتهاانما تحركها امواج الحبولولا الحبلكانت كالجليد تتـجمد..",
    "Though Destiny a hundred times waylays you,in the end it pitches a tent for you in Heaven.It is God's loving kindness to terrify you,in order to lead you to His Kingdom of safety.",
    ...
    "I belong to no religion. My religion is love. Every heart is my temple.",
    "My dear soul, flee from the worthless,stay close only to those with a pure heart.Like attracts like.A crow will lead you to the graveyard,a parrot to a lump of sugar.",
    "Your soul is so close to mineThat what you dream, I know. …I know everything you think of: your heart is so close to mine!",
    ...
    "If I gaze at my belovedshe may feel embarrassedand if I do not,she will feel neglected.I can see the stars reflectingin the calm water of her facebut if I look awayI lose my clarity.",
    ...
    "لا تذهب بعيدا لا تبغ السفر فقمرك أمامك هنا لا ترفع الصوت فهو يسمع تحت الشفة منك الدعا",
    "Stop the words now. Open the window in the center of your chest, and let the spirits fly in and out.",
    ...
    "يمكن لي أن أنقسم عن أي واحد عدا من يحتويني ضمنه، أي واحد يمكنه أن يهب العطايا، خص لي أحداً مانعا",
    "My BelovedKnow that my beloved in hidden from everyoneKnow that she is beyond the belief of all beliefsKnow that in my heart she is as clear as the moonKnow that she is the life in my body and in my soul",
    "I love my friendsneither with my heart nor with my mind.  Just in case…Heart might stop.  Mind can forget. I love them with my soul. Soul never stops or forgets.",
    "IGNORANCEI didn’t know love would make me thiscrazy, with my eyeslike the river Ceyhuncarrying me in its rapidsout to sea,where every bitof shattered boatsinks to the bottom.An alligator lifts its head and swallowsthe ocean, then the oceanfloor becomesa desert coveringthe alligator insand drifts.Changes dohappen. I do not know how,or what remains of whathas disappearedinto the absolute.I hear so many storiesand explanations, but I keep quiet,because I don’t know anything,and because something I swallowedin the oceanhas made me completely contentwith ignorance.",
    "لا عاقِلٌ منكر لوجودِك ، لكن أي امرئ لا يسلم بذلك في التو .ليس مكانًا ما لا تكونُ بهِ ، ولا حتّى مكانًا عندما يشهدونك .",
    "When someone critises or disagrees with you, a small ant of hatred and antagonism is born in your heart. If you do not squash that ant at once, it might grow into a snake, or even a dragon.",
    "In compassion and grace, be like the sun...In concealing other's faults, be like the night...In generosity and helping others, be like a river...In anger and fury, be like dead...In modesty and humility, be like the earth...In tolerance, be like the sea...Either appear as you are, or be as you appear..",
    "You have been walking the ocean's edge,holding up your robes to keep them dry.You must dive naked under and deeper under,a thousand times deeper. Love flows down. The ground submits to the sky and suffers what comes.Tell me, is the earth worse for giving in like that?Do not put blankets over the drum.Open completely.",
    ...
    "ﻟﻠﻤﺮﺃﺓ ﺣﻀﻮﺭ خفي .. لا يراه ويهتدي به إلا رجل متفتح عارف فهناك ﻧﻮﻉ ﺁﺧﺮ ﻣﻦ ﺍﻟﺮﺟﺎﻝ ..ﺑﺪﺍﺧﻠﻬﻢ ﺣﻴﻮﺍﻥ ﻣﺤﺒﻮﺱ ليت هؤلاء ﻳﻘﻮّﻣﻮﻥ ﺃﻧﻔﺴﻬﻢ ﺃﻭﻻ‌ ليتهم يعرفون أن ﺍﻟﻤﺤﺒﺔ ﻭﺍﻟﺘﻔﻬﻢ ﻫﻲ ﻣﺎ ﺗﺠﻌﻠﻨﺎ ﺑﺸﺮﺍ ، ﺃﻣﺎ ﺍلشهوة ﻭﺍﻟﺤﻤﻴﺔ .. ﻓﻼ‌ ﺭﺑﻤﺎ ﻛﺎﻧﺖ ﺍﻟﻤﺮﺃﺓ ﻧﻮﺭﺍ ﻣﻦ نور ﺍﻟﻠﻪ  ﺭﺑﻤﺎ ﻛﺎﻧﺖ ﺧﻼ‌ﻗﺔ ﻭﻟﻴﺴﺖ ﻣﺨﻠﻮﻗﺔ ﺭﺑﻤﺎ ﻫﻲ ﻟﻴﺴﺖ ﻣﺠﺮﺩ ﺫﻟﻚ ﺍﻟﺸﻜﻞ ﺍﻷ‌ﻧﺜﻮﻱ ﺍﻟﻨﺎﻋﻢ ﺍﻟﺬﻱ ﺗﺮﺍﻩ",
    "And he misses herLike a wind starved sailHe sits knowing what direction to goBut the current keeps pulling him Down river.",
    "First, when I was apart from you,this world did not exist, nor any other.Second, whatever I was looking forwas always you.",
    ...
    "خارج مضمار كل الأفكاركل مفاهيم الخير والشر ، الفضيلة والخطيئةهناك مرج واسع بلا نهايةسألقاك هناك",
    "There’s a morning when presence comes over your soul. You sing like a rooster in your earth-colored shape. Your heart hears and, no longer frantic, begins to dance.",
    "لا تجزع من جرحك وإلا فكيف للنور أن يتسلل إلى باطنك",
    "Raise your words, not your voice. It is rain that grows flowers, not thunder.",
    "Know mankind well, don't degrade every man as evil, and don't exalt every man thinking he is good. He who cannot discover himself; cannot discover the world.",
    "Friend, we're traveling together.Throw off your tiredness. Let me show youone tiny spot of the beauty that cannot be spoken.I'm like an ant that's gotten into the granary, ludicrously happy, and trying to lug outa grain that's way too big.",
    "My soul is from elsewhere, I’m sure of that, and I intend to end up there.",
    "The feelings trembled and flapped in his chest like a bird newly put in a cage.",
    "With life as short as a half taken breath, don't plant anything but love.",
    "ياسيدي لا تسلمني إلى إغواء النفسلا تتركني مع أي سواك، لخوفي مني اسرع إليكانا منك فأعدني إلي",
    "Your acts of kindness are iridescent wings of divine love, which linger and continue to uplift others long after your sharing.",
    "Do you pay regular visits to yourself? Don't argue or answer rationally. Let us die, and dying, reply.",
    "لا تحزن فالله يرسل الأمل في أكثر اللحظات يأساً، إن المطر الكثير لا يأتي إلا من الغيوم الأشد ظلمة",
    "I'm drenched in the flood which has yet to comeI'm tied upin the prisonthat has yet to existNot having played the game of chessI'm already the checkmateNot having tasteda single cup of your wineI'm already drunkNot having entered the battlefieldI'm already wounded and slainI no longer know the differencebetween image and realityLike the shadowI amandI am not",
    ...
    "I am not from east or westnot up from the groundor out of the oceanmy place is placelessa trace of the tracelessI belong to the beloved",
    ...
    "وه چه بی‌رنگ و بی‌نشان که منمکی ببینی مرا چنان که منمگفتی اسرار در میان آورکو میان اندر این میان که منم",
    "There are no edges to my loving now.",
    ...
    "We are the night ocean filledwith glints of light. We are the spacebetween the fish and the moon,while we sit here together.",
    "people want you to be happy, don't keep serving them your pain",
    ...
    "Dear soul, don't set a high value on someone before they deserve it; You either lose them or ruin yourself...!",
    "What in your life is calling you,When all the noise is silenced,The meetings adjourned...The lists laid aside,And the Wild Iris bloomsBy itselfIn the dark forest...What still pulls on your soul?",
    ...
    "All religions. All this singing. One song. Peace be with you.",
    "النُصح غير ذي جدوى للعاشقين، فإنْ العِشق نهرٌ لا تقوى السدود جميعها على تغيير مساره",
    ...
    "Are you jealous of the ocean's generosity?Why would you refuse to givethis love to anyone?Fish don't hold the sacred liquid in cups!They swim in the huge, fluid freedom.",
    ...
    "مكابدتك لنفسك حرب لا نهاية لها",
    ...
    "Truth lifts the heart, like water refreshes thirst.",
    "نه شرقییم، نه غربییم نه بییم، نه بحرییمنه از کان طبیعیم، نه از افلاک گردانم نه از خاکم، نه از آبم، نه از بادم، نه از آتشنه از عرشم، نه از فرشم، نه از کونم، نه از کانمنه از هندم، نه از چینم، نه از بلغار و صقسینمنه از ملک عراقینم نه از خاک خراسانمنه از دنیی، نه ازعقبی، نه از جنت، نه از دوزخنه از آدم، نه از حوا، نه از فردوس رضوانممکانم لا مکان باشد، نشانم بی نشان باشدنه تن باشد، نه جان باشد، که من از جان جانانم",
    "Leave that which is not,but appears to be. Seek that which is,but is not apparent.",
    "if i can only recount the story of my life right out of my body flames will grow",
    "تا در طلب گوهر کانی کانیتا در هوس لقمهٔ نانی نانیاين نكته رمز اگر بداني داني هر چيز كه در جُستن آني آني",
    "If I love myselfI love you.If I love youI love myself.",
    "هناك شمعة في قلبك .. تنتظر أن تضاءهناك فراغ في روحك .. ينتظر أن يملأ إنك تشعر بهذا ، أليس كذلك ؟!",
    "You run back and forth listening for unusual events,peering into the faces of travelers.\"Why are you looking at me like a madman?\"I have lost a friend. Please forgive me.",
    ...
    "تعالَ .. تعالَ لا يهم من انتَ، و لا إلى أي طريقِ تنتهي تعالَ .. لا يهم من تكون عابر سبيل .. ناسكاً .. أو عاشقاً للحياة تعالَ .. فلا مكان لليأس هنا تعالَ .. حتي لو أخللتَ بعهدك ألف مرةفقط تعالَ لنتكلم عن الله",
    "Angels dance only with You, Belovedand only before You do I bow in adoration.You may accept me or not but I will be at your feet forever.",
    "هل الحياة لتفنى؟ يهب الله أخرى. مجَّد المطلق، وسلم بالمقيد، العشق نبع، فانغمر كل قطرة تنفصل، عمر مستجد",
    "Like the shadowI amandI am not",
    "Don't you know Yet? It is your light that lights the World.",
    "WEAN YOURSELFLittle by little, wean yourself.This is the gist of what I have to say.From an embryo, whose nourishment comes in the blood,move to an infant drinking milk,to a child on solid food,to a searcher after wisdom,to a hunter of more invisible game.Think how it is to have a conversation with an embryo.You might say, \"The world outside is vast and intricate.There are wheatfields and mountain passes,and orchards in bloom.At night there are millions of galaxies, and in sunlightthe beauty of friends dancing at a wedding.\"You ask the embryo why he, or she, stays cooped upin the dark with eyes closed.Listen to the answer.There is no \"other world.\"I only know what I've experienced.You must be hallucinating.",
    ...
    "لتَكُن غايتك للانتهاء ابتداءلستُ علي الدوام ذلك الشخص الذي كنت عليهفأنا أرحل عنِّي في كل مرةٍ أصير فيها إلي",
    ...
    "A new moon teaches gradualnessand deliberation and how one gives birthto oneself slowly. Patience with small detailsmakes perfect a large work, like the universe.",
    "May this marriage be blessed.May this marriage be as sweet as milk and honey.May this marriage be as intoxicating as old wine.May this marriage be fruitful like a date tree.May this marriage be full of laughter and everyday a paradise.May this marriage be a seal of compassion for here and hereafter.May this marriage be as welcome as the full moon in the night sky.Listen lovers, now you go on, as I become silent and kiss this blessed night.",
    ...
    "You are not a drop in the oceanYou are the entire ocean in a drop",
    ...
    "When you are everywhere, you are nowhereWhen you are somewhere, you are everywhere.",
    "Out beyondthe ideas of wrongdoing and right doing,there is a field.I'll meet you there.When the soul lies down in that grass,the world is too full to talk about.Ideas, language, even the phrase 'each other'doesn't make any sense.",
    "Get yourself out of the way, and let joy have more space.",
    ...
    "What else can I say?You will only hearwhat you are ready to hear.Don’t nod your head,Don’t try to fool me—the truth of what you seeis written all over your face!",
    "Be grateful for whoever comes, because each has been sent as a guide from beyond",
    ...
    "I have lived on the lip of insanity, wanting to know reasons, knocking on a door. It opens. I’ve been knocking from the inside.",
    "أيها النور فى الفؤاد تعالغاية الوجد والمراد تعاليا ظريف الدنيا سلام عليكإن دائى وصحتى بيديك",
    "Heartsick, heartbroken—To know love is to know pain.What could be more common?Even so, each broken heart is so singularThat with it we probe the divine.",
    "يا من بكت السماء والأرض على فراقك..وغرق القلب فى الدم، وبكى العقل والروح.",
    "I am bewildered by the magnificence of your beauty, and wish to see you with a hundred eyes. I am in the house of mercy and my heart is a place of prayer.",
    ...
    "The waterwheel accepts water and turns and gives it away, weeping.",
    "This world hurts my headwith its answers.I would burn if I had a choice.",
    "هر روز دلم در غم تو زارتر استوز من دل بی‌رحم تو بی‌زارتر استبگذاشتیم، غم تو مگذاشت مراحقا که غمت از تو وفادارتر است",
    ...
    "Yesterday I was clever, so I wanted to change the world. Today I am wise, so I am changing myself.",
    "If I hold you in my heart, you'll wither;Become a thorn if I hold you in my eyes.No, I'll make a place for you within my soul insteadSo you'll be my love in lives beyond this life.",
    "انظر لكل هذا البهاء المنعكس من روحك .. وغن لنفسك أغنية عشق",
    "إن لم تقبل الجمال في صباحك، سيهجرك طيلة يومك.",
    ...
    "جسمنا يشبه مريم العذراء: كل واحد منا يحمل عيسى بداخله. لكن مالم تظهر فينا آلام المخاض فإن عيسانا لا يولد.",
    "Every moment a taste of that beauty in our mouths, another stashed in a pocket. Impossible to say what: no cypress so handsome, no sunlight, a lonely hiddenness. Other pleasure gathers a crowd, starts a fight, lots of noise there. But soul beauty stays quiet..his amazing whereabouts unknown inside my heart.",
    "متى يكون الليل مظلما مع قمر وجهك، والنهار بدونك ظلام.",
    "الحب النقي هو من يسكن الوحش الذي بداخلك، أطلق العنان للمحبة وكن روحانيا، كن طيبا، كن عاشقا.",
    ...
    "When one of us gets lost, is not here, he or she must be inside us.There’s no place like that anywhere in the world.’ Rumi",
    "Oh you, unceasing sun, to me Your particles communicate The luminous essence of God, Are you our God? I do not know. Intoxicated, I say nought, Bewitched by the magic potion. I cannot differentiate Between my drunk and sober state.",
    "Why are you so enchanted by this worldwhen a mine of gold lies within you?",
    "Oh you, straying heart, just come! Oh you, aching liver, just come! If the path to the gate is closed, Take the way by the wall, but come!",
    "The Ripe FigNow that You live here in my chest,anywhere we sit is a mountaintop.And those other images,which have enchanted peoplelike porcelain dolls from China,which have made men and women weepfor centuries, even those have changed now.What used to be pain is a lovely benchwhere we can rest under the roses.A left hand has become a right.A dark wall, a window.A cushion in a shoe heel,the leader of the community!Now silence. What we sayis poison to someand nourishing to others.What we say is a ripe fig,but not every bird that flieseats figs.",
    "Lovers move like lightning and wind.No contest.Theologians mumble, rumble-dumble, necessity and free will, while lover and belovedpull themselves into each other.",
    "I have spent my life dreaming of your face. Now, I have found it.",
    "I am not this hair,I am not this skin,I am the soul that lives within",
    "Escape from the black cloudthat surrounds you.Then you will see your own lightas radiant as the full moon.",
    ...
    "The heart is like a candlelonging to be lit.Torn from the belovedit yearns to be whole again,but you have to bear the pain.You cannot learn about love.Love appears on the wings of grace.",
    "Your boundaries are your quest.",
    "I said, O Love, tell me this:Does the Lord know you are treating me this way?Love said to me,yes He does, just be totally…totally… silent",
    ...
    "You came suddenly shook me from my sleep and vanished.In my heart you rose like the moonbut as I glanced at you, you disappeared.Having had a glimpse of Your garden,I have no more the patience to endure my existence....",
    "No one can tell if I’m laughing or weeping. I wonder myself. How can I be separated and yet in union?",
    "إننا نسأل الله التوفيق إلى الأدب، فمن لا أدب عنده صار محروما من لطف الرب.وما أساء عديم الأدب إلى نفسه فحسب، بل أضرم النار فى كل الآفاق.",
    "I will whisper secrets in your ears,just nod yes and be silent.A soul moon appeared in the path of my heart.How precious is this journey",
    ...
    "In the blackest of your moments, wait with no fear.",
    "Don’t grieve for what doesn’t come. Some things that don’t happen keep disasters from happening.",
    "كنتُ أطلبُ شخصًا مِن جنسي، لكي أجعلَه قِبلةً وأتوجهُ إليه، فقد مللتُ مِن نفسي.",
    "لذ عنده بالرضا ولا ترتعد من القضا",
    "خرج جوادٌ من مكانٍ غير معروفحملنا حيث ذقنا هُنا العشقوحتى لم نعد نحيا كذلك، هذا الطعم،خمرٌ، نستقيه على الدوام",
    "معك أيها القمر متى تكون الأرض مظلمة؟",
    "I am ashamed to call this love humanand afraid of Godto call it divine",
    ...
    "Both light and shadoware the dance of Love.",
    "Be suspicious of what you want.",
    ...
    "إذا أتى إليك عاقلٌ فقلْ له: \"ليس ثَمَّ طريق\". وإن أتى إليك عاشقٌ فألف مرحبا",
    ...
    "اخترت أن أتعشقك في وحدتي التامة، لأنه في تلك الوحدة تكون أنت لي وحدي.",
    ...
    "Love is an emerald.Its brilliant light wards off dragonsOn this treacherous path.",
    ...
    "You are my shams.",
    "I love you neither with my heartnor with my mind.My heart might stopmy mind can forget.I love you withmy soul becausemy soul never stopsor forgets.-Rumi",
    "Every object, every being,is a jar full of delight.Be a connoisseur,and taste with caution.Any wine will get you high.Judge like a king, and choose the purest,the ones unadulterated with fear,or some urgency about \"what's needed.\"Drink the wine that moves youas a camel moves when it's been untied,and is just ambling about.",
    ...
    "The universe swings again into orbit around us.Am I looking for you or you for me?The question is wrong.As long as I keep using two pronouns,I am this in-between, two-headed thing.",
    "خنک آن قماربازی که بباخت آنچه بودشبنماند هیچش الا هوس قمار دیگر",
    "ألف الدهر بعادي ... جرح البعد فؤاديفقد النوم وسادي ... وسعاداتي نومفأرى الشمل تفرق ... وأرى الستر تمزق وأرى السقف تخرق ... وأرى الموج تلاطموأرى البدر تكور ... وأرى النجم تكدر وأرى البحر تسجر ... وأرى الهلك تفاقمفقد أهداني ربي ... وأتى الجد بحبي نهض الحب لطبي ... وتدارك وتراحمنزل العشق بداري ... معه كأس عقاري هو معراج سواري ... وعلى السطح كسلمبك أحيى وأموت ... بك أمسك وأفوت بك في الدهر سكوت ... بك قلبي يتكلم",
    "Oh soul, you worry too much. Your arms are heavy with treasures of all kinds.",
    ...
    "When you look for God,God is in the look of your eyesIn the thought of looking, nearer to you than your self,or things that have happened to youThere’s no need to go outside.Be melting snow.Wash yourself of yourself.A white flower grows in the quietness.Let your tongue become that flower.",
    ...
    "I could not have knownwhat love is if I had neverfelt this longing. Anythingdone to excess becomesboring, except this overflowthat moves toward you.",
    "Remember, the entrance door to the sanctuary is inside you.",
    "The gates made of lightswing open. You see in.",
    "اي روي تو رويم را چون روي قمر كردهاجزاي مرا چشمت اصحاب نظر كردهباد تو درختم را در رقص درآوردهياد تو دهانم را پر شهد و شكر كردهداني كه درخت من در رقص چرا آيد؟اي شاخ و درختم را پر برگ و ثمر كردهاز برگ نمي‌نازد وز ميوه نمي‌يازداي صبر درختم را تو زير و زبر كرده",
    ...
    "I have put the ear of my soul in the widow of your heart",
    ...
    "Tear off the mask. Your face is glorious.",
    "Wear gratitude like a cloak and it will feed every corner of your life.",
    "فى داخلنا يَصدَحُ صوتٌبأبياتٍ من \"خِسرو\" ، بمَقطَعٍ من \"شِيرين\" .صوتٌ هادئٌ يَستَثيرُناوأحياناً كلماتٌ مثيرةٌ تَجعَلُنا هادئين .",
    ...
    "كيف يمكن أن يغادر هذا العالمَ جزءٌ من هذا العالم؟كيف يمكن أن يترك البللُ المياه؟ما يجرحك، يباركك…الظلام شمعتك.حدودك مسعاك.يمكنني شرح ذلك، لكنْ قد ينكسرُالزجاجُ الذي يغطِّي قلبكولا شئء يُصلح ذلك.هل تكفي هذه الكلماتأو عليَّ أن أعصرَ منها أكثر؟",
    ...
    "jangan tanya apa agamaku. aku bukan yahudi. bukanzoroaster. bukan pula islam. karena aku tahu, begitu suatu namakusebut, kau akan memberikan arti yang lain daripada makna yang hidupdi hatiku.",
    ...
    "Don't run around this worldlooking for a hole to hide in.There are wild beasts in every cave!If you live with mice,the cat claws will find you.",
    "The only lasting beauty is the beauty of the heart.",
    "نحن من أولئك الذين يفرحون دون ذهب أو ثروات نحن هادئون فى ألالم وساكنون فى الخوف وألى آخر دورة الفلك، نحن فرحون بالاستسلام لاتظن أننا مثلك، فرحون نصف فرحة.",
    ...
    "My heart is so smallit's almost invisible.How can You place such big sorrows in it?\"Look,\" He answered,\"your eyes are even smaller,yet they behold the world.― Rumi”",
    ...
    "ليست ترابا هذه الأرضإنها طست من الدممن دماء العاشقينوجراح موت العظام",
    "I am in Love with Loveand Love is in love with me.My body is in Love with the souland the soul is in Love with my body.I opened my arms to Loveand Love embraced me like a lover.",
    "سلام علي أولئك الذين رأو جدار روحك يريد أن يتقض فأقاموه و لم يفكروا أن يتخذوا عليه أجرا",
    "أيها العارف، هل تعرفما هو الليل؟إنه ملاذ العاشقين.وفي هذه الليلة المجيدةفأنا سكران مع القمر.لقد هام القمر عشقاوجن الليل.",
    ...
    "الله يجمع بيننا, و يفرق البعد عن بيننا, سَنَة الوصل سِنَة , و سِنَة الهجر سَنَة",
    "On a day when the wind is perfect, the sail just needs to open and the world is full of beauty.Today is such a day.",
    "Open to me, so that I may open.Provide me your inspirationSo that I might see mine.",
    ...
    "You are not a drop in a oceanYou are entire ocean in a drop",
    ...
    "عندما يحدق صوفي في شخص ما فإنه يغمض عينيه ويفتح عين ثالثة ، العين التي ترى العالم الداخلي",
    ...
    "لا تلبس ثوب العشق إن استطعت ذلك، وإذا ارتديته لا تصرخ عند كل خطر، احترق في هذا الثوب وابقَ صامتًا، فبعد الصبر يأتي يوم الفرح، كن وحيدًا على طريق الشوق، كن رفيقًا للألم..",
    "It doesn’t matter that you’ve broken your vow a thousand times. Still come, and yet again, come.",
    "I say, Show me the way. You say, Put your head under your feet. That way you rise through the starsand see a hundred different ways to be with me.",
    "Body of earth, don't talk of earthTell the story of pure mirrorsThe Creator has given you this splendor--Why talk of anything else?",
    ...
    "All day I think about it, then at night I say it.Where did I come from, and what am I supposed to be doing?I have no idea.My soul is from elsewhere, I'm sure of that,and I intend to end up there.",
    "Excuse my wandering.How can one be orderly with this?It's like counting leaves in a garden,along with the song-notes of partridges,and crows.Sometimes organizationand computation become absurd.",
    ...
    "Listen, open the heart’s window and keep looking at the Beloved. The task of love is to open that window so the heart can be illuminated by His Beauty. Gaze incessantly at the Beloved's face. That is your power, my friend",
    "Set your life on fire. Seek those who fan your flames.",
    "All religions. All this singing. One sone. Peace be with you.",
    "Let the lover be disgraceful, crazy, absent-minded. Someone sober will worry about events going badly. Let the lover be.",
    "I ask a flower, “How is it you are so wise so young?“With the first morning wind andthe first dew, I lost my innocence.”I follow the one who showed me the way.I extend one hand up, and with the other I touch the ground.A great branch leans down from the sky. How long will I keep talking of up and down?This is not my home: silence, annihilation, absence! I go back where everything is nothing.”",
    "Today, like every other day, we wake up emptyand frightened. Don't open the door of yourstudyand begin reading. Take down a musicalinstrument.Let the beauty we love be what we do.There are hundreds of ways to kneel and kissthe ground.",
    "Close the language door andopen the lovers window.The moon won’t use the door, only the window.",
    "The minute I heard my first love story I started looking for you, not knowing how blind that was. Lovers don’t finally meet somewhere. They’re in each other all along.",
    "The grief you cry out fromdraws you toward union.Your pure sadnessthat wants helpis the secret cup.",
    "the sun loved the moon so much he died every night to let her breathe\".",
    "A GivenThe drum we hear inside us nowwe may not hear tomorrow.We have such fear of what comes next. Death.These loves are like pieces of cotton.Throw them in the fire.Death will be a meeting like that flaring up,a presence you have always wanted to be with.This body and this universekeep us from being free.Those of you decorating your cellsso beautifully, do you thinkthey won't be torn down?The eventual demolishing of prisonsis a given. Fire-change, disaster-change,you can trust that those will come around to you.",
    ...
    "Kemarin aku menjadi pintarAku ingin merubah duniaHari ini aku menjadi bijakAku ingin merubah diriku sendiri",
    ...
    "اندر دل بی‌وفا غم و ماتم بادآن را که وفا نیست ز عالم کم باددیدی که مرا هیچ کسی یاد نکردجز غم که هزار آفرین بر غم باد",
    "نی من منم و نی تو توئی نی تو منیهم من منم و هم تو توئی هم تو منیمن با تو چنانم ای نگار ختنیکاندر غلطم که من توام یا تو منی",
    ...
    "Our greatest strength lies in the gentleness and tenderness of our hearth.",
    "العشاق الذين يموتون على وعىيموتون أمام المعشوق ومأنهم السكر.",
    "أيتها الطيور، وأنتم الآن منفصلون عن أقفاصكمأظهروا وجوهكم وقولوا: أين نبتمويا من ولدتم عندما وصلتم إلى الموتهذا هو الميلاد الثانى، ألا فلتولدوا فلتولدوا",
    "کی شود این روان من ساکناین چنین ساکن روان که منم",
    "روحیست بی نشان و ما غرقه در نشانشروحیست بی مکان و سر تا قدم مکانشخواهی که تا بیابی، یک لحظه ای مجویشخواهی که تا بدانی، یک لحظه ای مدانش",
    "Close your eyesFall in LoveStay There چشمانت را ببندعاشق شو همان جا بمان",
    "إن عشق الموتى ليس دائما، لأن الموتى لا يعودون إلينا.وعشق الحى بالنسبة للروح والبصر، أكثر نضارة كل لحظة من البراعم.",
    "Then I looked within my own heartand there I found Him—He was nowhere else.",
    "My dear heart, never think you are better than others. Listen to their sorrows with compassion. If you want peace, don't harbor bad thoughts, do not gossip and don't teach what you do not know.",
    "A Mystic And A DrunkThe Universe turns on an axis.Let my soul circle around a tablelike a beggar, like a planetrolling in the vast, totally helpless and free.The knight and the castle move jaggedlyabout the chessboard, but they're actuallycentered on the king. They circle.If love is your center, a ringgets put on your finger.Something inside the mothis made of fire.A mystic touches the annihilating tipof pure nothing.A drunkard thinks peeing is absolution.Lord, take these impurities from me.The lord replies, First, understandthe nature of impurity. If your key is bent,the lock will not open.I fall silent.King Shams has come.Always when I close, he opens.",
    ...
    "Be motivated like the falcon, hunt gloriously. Be magnificent as the leopard, fight to win. Spend less time with nightingales and peacocks. One is all talk, the other only color.",
    "This is how it is to come near youA wave of light builds in the black pupilof the eye. The old become young.The opening lines of the Qur'an open still more.Inside every human chest there is a hand,but it has nothing to write with.Love moves further in, where languageturns to fresh cream on the tongue.Every accident, and the essence of every being,is a bud, a blanket tucked into a cradle,a closed mouth.All these buds will blossom,and in that moment you will knowwhat your grief was,and how the seed you planted has been miraculously,and naturally, growing.Now silence.Let soul speak inside spoken things.",
    "Your misconceptions veil the holy. The Princess is nakedbeneath the surface of every form. Your boredom wouldvanish if you had more of a clue about the Reality I know.",
    "If God said, ‘Rumi pay homage to everything that has helped you enter my arms,’ there would not be one experience of my life, not one thought, not one feeling, nor any act, I would not bow to.",
    ...
    "You are guardian of a treasure,Oh, just like a sleeping serpentAnd you shall see, I shall make youSpin around like that sleepy snake.Listen to me.",
    ...
    "Friend, our closeness is this : Anywhereyou put your foot, feel me in the firmnessunder you.How is it with this love,I see your world, but not you?",
    ...
    "Everything that is made beautiful and fair and lovely is made for the eye of one who sees.",
    "Няма край на пътешествието,няма край, няма никога край...как може възлюбено сърценякога да спре да се отваря?\"Ако ме обичаш,\" - каза Той -\"Няма само веднъж да умреш.Във всеки мигще умираш във мен,за да се раждаш отново.",
    "گویند که عشق عاقبت تسکین استاول شورست و عاقبت تمکین استجان است زآسایش سنگ زیرینوین صورت بی قرار بالایین است",
    ...
    "Have you ever seen any lover who was satiated with this passion? Have you ever seen any fish that had become satiated with this sea?In separation, the lover is like a name empty of meaning; but a meaning such as belovedness has no need of names.You are the sea, I am a fish—hold me as you desire; show compassion, exercise kingly power—without you, I remain alone.Without you, the world is a torment; may it not be without you for a single instant; by your life I implore this, for life without you is a torture and an agony to me.",
    ...
    "I once had a thousand desires. But in my one desire to know you, all else melted away.",
    "When ink joins with a pen, then the blank papercan say something. Rushes and reeds must be wovento be useful as a mat. If they weren't interlaced, the wind would blow them away.",
    "Woman is a ray of God. She is not that earthly beloved: she is creative, not created.",
    ...
    "Let yourself be silently drawn by the inner pull of what you really love.",
    ...
    "Be crumbled.So wild flowers will come up where you are.You have been stony for too many years.Try something different. Surrender.",
    "A heart filled with desire forsweetness and tender soulsmust not waste itself with unsavory matters.",
    ...
    "Rumi says, Fall in love in such a way that it frees you from any connecting. That",
    "إن كل من أحس بالألم ظفر برائحة تقوده إليه",
    "Why do you stay in prison when the door is so wide open?",
    ...
    "You whispered softly in the ear of my joyous heart.You know what's on my mind, you've heard my thoughts.I closed my mouth and spoke to you in a hundred silent ways.",
    ...
    "Whatever picture you paintor poem you writeHe is beyond that.Whatever height you can reach,He is higher than your 'highest'.Get rid of your talking and your books—it is far betterto let Him be your book.",
    "If God should smile at someone once ..he thenwill not hurt by bitter looks from men",
    "سكران وخرب أنا, وكل ما في منطقي نقد وخطا",
    "If you wish to be a mine of jewels, open the deep ocean within your heart.",
    "A special spark risesfrom the sorrow of a burning heart.Have you ever heardhow the sigh of a broken hearttouches the Beloved?",
    ...
    "Religions have no merit for meAny new religion we createdBrought upon countless discordAmplifying Hatred and AnimosityThe Crusades recurredHuman blood covered the earth, time and again in the name of faithI am neither Muslim, nor Christian nor JewI follow the command of rationaleRationale decrees that the ultimate pleasure is in coexistence Religion on the other hand promises eternal reward by shedding the blood of unfaithfulDifferent thinkers are human tooWhy does religion promote their killing?I shall not shed the blood of fellow humansThis is the reason for my lack of faithI have nothing to do with religion!As for you, my son: “Follow your rationale to reach the pinnacleBefriend all humans on earthThis is the ultimate faith.”",
    "Be full of sorrow, that you may become hill of joy; weep, that you may break into laughter.",
    "I am a tambourine. Don't put me asidetill the fast dancing starts.Play me some all along.Help me with these little sounds.",
    "If you love love, look for yourself.",
    "كنت زهرة, صرت قمرا , صرت فلكا من مئتي طية.كنت يوسف, و من الآن صرت ألد أمثال يوسفظفر قلبي بضياء الروح, فانفتح قلبي و انشرحنسج قلبي حريرا جديدا, صرت عدوا لهذه الخرقة",
    "از بس که برآورد غمت آه از منترسم که شود به کام بدخواه از مندردا که ز هجران تو ای جان جهانخون شد دلم و دلت نه آگاه از من",
    ...
    "I must keep silent. Silent. And let Love describe itself.",
    "Press thy suit, yet with moderation;A blade of grass cannot pierce a mountain.If the sum that illumines the worldWere to dry nigher, the world would be consumed",
    ...
    "Добре е да оставишвсеки отминаващ ден назад,като вода течаща,свободен от тъга.Вчера си отидеи приказката му - изпята.Днес нови семена растат.",
    ...
    "Beauty surrounds us, but usually we need to be walking in a garden to know it.",
    "To see the moon that cannot be seen,turn your eyes inward & look at yourself,in silence...",
    "سمع موسى راعيا يقول: كيف يا رب أخدمك؟ أغسل قدميك، أمشط شعرك، أحلب لك. فدى لك كل غنمي.فنهاه ووبخه.فأوحى الله إليه: أبعثتك لتصل عبادي بي أم لتفصلهم عني؟ ناجاني عبدي بما يعقل. ارجع فقل له إني أحبه.",
    "Stay together, friends.Don't scatter and sleep.Our friendship is madeof being awake.",
    ...
    "There is no spitting on the way we're on.Rain itself turns to spit on those who mock and casually show disrespect to saints.",
    "You know the value of every article of merchandise, but if you don't know the value of your own soul, it's all foolishness.",
    "My home has no address, my tracks leave no trace. I am neither body nor soul ... What can I say? I belong to the Self of the Beloved",
    ...
    "You have read in the text where They love himblends with He loves them.Those joining lovesare both qualities of God. Fear is not.What characteristics do God and human beingshave in common? What is the connection betweenwhat lives in time and what lives in eternity?If I kept talking about love,a hundred new combinings would happen,and still I would not say the mystery.",
    "You are not a drop in the ocean, you are the entire ocean in a drop.",
    ...
    "The way of love is not / a subtle argument. / The door there is devastation. / Birds make great sky-circles / of their freedom. / How do they learn it? / They fall, and falling, / they're given wings.",
    "Your earthly lover  can be very charming and coquettish  but never very faithful.  The true lover is the one who on your final day  opens a thousand doors.",
    ...
    "إن للعشق غربة عن الدنيا و الآخرةو إن للعشاق موتا في كل لحظةو موت العشاق ليس نوعا واحدا",
    "Love is the instrument to unfold divine secrets...Love is the reign timeless, dimensionless...Lover is as distinct as the moon shining among stars on the sky.Beloved is the sparkle in the heart of the Love.",
    "هر روز نو جامی دهد، تسکین و آرامی دهدهر روز پیغامی دهد، این عشق چون پیغمبرم",
    "اي كيست چنين مست ز خمار رسيده؟\tيا يار بود يا ز بر يار رسيدهيا شاهد جان باشد، روبند گشادهيا يوسف مصريست ز بازار رسيدهيا زهره و ماهست درآميخته باهميا سرو روانست ز گلزار رسيدهيا چشمه خضرست روان گشته بدين سويا ترك خوش ماست ز بلغار رسيدهيا برق كله‌گوشه‌ي خاقان شكاريستاندر طلب آهوي تاتار رسيدهيا ساقي دريادل ما بزم نهاده‌ستيا نقل وشكرهاست به قنطار رسيدهيا صورت غيبست كه جان همه جان‌هاستيا مشعله از عالم انوار رسيدهشاه پريان بين ز سليمان پيمبراندر طلب هدهد طيار رسيدهخوبان جهان از پي او جيب دريدهقاضي خرد بي دل و دستار رسيدهاز هيبت خون‌ريزي آن چشم چو مريخمريخ ز گردون پي زنهار رسيدهوز بهر ديت دادن هر زنده كه او كشتهميان زر آورده به ايثار رسيدهاول ديت خون تو جاميست به دستشدركش كه رحيقست ز اسرار رسيدهخاموش كن اي خاسر انسان لفي خسراز گلشن ديدار به گفتار رسيده",
    "Shadows can indicate what’s shining bright   But it’s the sun which fills your soul with light,",
    "Any stateother than what you have experienced seems absurd. You have had certain visions. Beforethem, did not mysticism sound ridiculous? What you've been given has released you fromprison, ten times! And won't this empty desert freedom you feel now someday be confining?",
    "This is love: to fly toward a secret sky , to cause a hundred veils to fall each moment .First to let go of life . Finally to take a step without feet .",
    ...
    "Bear the pain of longing silently, my heartfor this is the cure.The ultimate sacrifice is to curb your desiresand surrender the ego.",
    "See that caravan of camelsloaded with sugar?--His eyes contain that much sweetness.But don't look into His eyesunless you're ready to lose all sight of your own.",
    "نبود چنین مه در جهان ای دل همین جا لنگ شواز جنگ می‌ترسانیم گر جنگ شد گو جنگ شورفتیم سوی شاه دین با جامه‌های کاغذینتو عاشق نقش آمدی همچون قلم در رنگ شودر دوغ او افتاده‌ای خود تو ز عشقش زاده‌ایزین بت خلاصی نیستت خواهی به صد فرسنگ شوبحری است چون آب خضر گر پر خوری نبود مضرگر آب دریا کم شود آنگه برو دلتنگ شومی‌باش همچون ماهیان در بحر آیان و روانگر یاد خشکی آیدت از بحر سوی گنگ شو",
    "MAULANA'S LAST LETTER TO SHAMSSometimes I wonder, sweetest love, if you Were a mere dream in along winter night, A dream of spring-days, and of golden light Which sheds its rays upon a frozen heart; A dream of wine that fills the drunken eye.And so I wonder, sweetest love, if I  Should drink this ruby wine, or rather weep; Each tear a bezel with your face engraved, A rosary to memorize your name...There are so many ways to call you back- Yes, even if you only were a dream.",
    "was deadi came alivei was tearsi became laughterall because of lovewhen it arrivedmy temporal lifefrom then onchanged to eternal",
    ...
    "I said, “Show me what to do.He said, Die.I said, “The water has turned into oil.”He said, Die.I said, “I will become a butterflycircling around your light.”He said, Die.”",
    "Your Soul and Mine. Use to be mingled. Breathing as One. Journeying as One.",
    "A poet I am not!My verses aren’t wortha piece of bread.I don’t seek praise,I don’t run from blame—both are worthless to me.All my skill and poetryfit into a single cup—Unless the wine comes from the Beloved’s handI will not drink one sip of it!",
    ...
    "Pertanyaan dari hati hanya bisa dijawab oleh jawaban dari hati",
    "I am a painter, Painting pictures all the time, Yet when I set them near Your beauty...I want to throw them all away.",
    "Water in the boat is the ruin of the boat, but water under the boat is its support.",
    "Love is the house of God and you are living in that house.",
    "العاشق لا يكون وحيدا ابدا .. فهو دائما في معية المحبوب",
    "We have been secretly fedfrom beyond space and time. That's why we look for something more than this.",
    ...
    "«دع روحك تجذبكَ بصمتٍ إلى ما تحبه، حقاً إنها لن تضللك أبدًا»",
    ...
    "Don't get lost in your pain, know that one day your pain will become your cure.",
    "Оглушал от гласа на желаниетоти не знаеш,че Любимият живеев твоето сърце.Спри шумаи ще чуеш в тишинатаНеговия глас.",
    "You are the Universe in Ecstatic Motion",
    "love entered meand became blood in my veinsemptied me of myselfand filled me with the belovedevery single particle of my bodyis soaked in the belovedmy name is all that's left of mehe became the rest",
    ...
    "Love is neither a tale nor a game. Love is such a powerful torrent that no one can stand in front of it. Love is the flame which, when it blazes, consumes everything other than the Beloved",
    ...
    "Lovely days don’t come to you, you should walk to them.",
    "Why should I be unhappy?Every parcel of my beingis in full bloom.",
    "Drunks fear the policebut the police are drunk too.",
    ...
    "All day I think about it, then at night I say it. Where did I come from, and what am I supposed to be doing? I have no idea. My soul is from elsewhere, I'm sure of that, and I intend to end up there.",
    "O lovers, lovers it is timeto set out from the world.I hear a drum in my soul's earcoming from the depths of the stars.Our camel driver is at work;the caravan is being readied.He asks that we forgive himfor the disturbance he has caused us,He asks why we travelers are asleep.Everywhere the murmur of departure;the stars, like candlesthrust at us from behind blue veils,and as if to make the invisible plain,a wondrous people have come forth.",
    "Life's waters flow from darkness, Search the darkness, don't run from it.",
    "Your heart knows the way. Run in that direction.",
    "چــه دانســتـم که این سـودا مـرا زیـن ســان کـُنـد مجــنـوندلـم را دوزخــی سـازد دو چـشــمـم را کـُنـد جـیـحــونچــه دانســتـم که سـیـلابی مـرا ناگـاه بـربـایـدچـو کَـشــتی ام دراندازد میـانِ قـُلزم پُـر خــوننهــنـگی هـم برآرد سـر خـُورَد آن آبِ دریا راچـُنـان دریـایِ بی‌پـایـان شــود بی‌آب چــون هــامـونچـو این تبـدیـل‌هـا آمـد نـه هـامون مـاند و نه دریاچــه دانم مـن دگـر چـون شـد که چـون غـرق اسـت در بـی‌چـون",
    ...
    "Today, like every other day, we wake up empty… Today, like every other day, we wake up empty and frightened. Don’t open the door to the study and begin reading. Take down a musical instrument. Let the beauty we love be what we do. There are hundreds of ways to kneel and kiss the ground.",
    "I saw many humans on whom there were no clothes, I saw many clothes in which there were no humans.",
    "Again, the filet bows to the lily.Again, the rose is tearing off her gown...The bud is shy, but the wind removes her veil suddenly, 'My friend!'...And the cove to the willow, 'You are the one I hope for...\"The ringdove comes asking, 'Where,where is the Friend?\"...Again, the season of Spring has comeAnd a spring-source rises under everything,A moon sliding from the shadows.Many things must be left unsaid because it's late, but whatever conversation we haven't had tonight, we'll have tomorrow.",
    ...
    "Before I ended up in this dungeon of the world,I was with you all the time.How I wish I’d never fallen intothis earthly trap.I kept telling you over and over again:“I’m perfectly happy here.I don’t want to go anywhere.To travel from this exaltation down to earthis just too difficult a journey.\"You sent me anyway:“Go, don’t be scared.No harm will come to you.I will always be with you.\"You persuaded me by saying: “If you go, you’ll gain new experiences.You’ll progress on your path.You’ll be far more maturewhen you come back home.\"I replied: “O Essence of Knowledge,What good is all this learning and information without you?Who could leave you for knowledge,unless he has no knowledge of you?\"When I drink wine from your hand, I haven’t a care in the world.I become drunk and happy. I couldn’t care less about gain or loss,or people’s good or bad features.",
    ...
    "I manage fine with no others around;I cannot manage without you.My heart bears your brand,it won’t wander away from you.Reason’s eye blurs with your wineheaven’s wheel spins under your thumb Pleasure’s nose follows your lead,I cannot manage without you.",
    ...
    "Lifewithout loveis an empty shell .زندگی بدون عشق صدفی خالی است .",
    "Inside you there’s an artist you don’t know about.",
    "In the driest whitest stretch of pain’s infinite desert, I lost my sanity and found this rose.",
    "Shams is a trumpet note of lightthat starts the atoms spinning,a wind that comes at dawntasting of bread and salt.Move to the edge and over. Fly with the wingshe gives, and if you get tired, lie down,but keep opening inside your soul.",
    "My Soul is my Guide, for my Soul is of that Abode I will not Speak of the Earthly, I am of the Unknown.",
    ...
    "I cried because my 3G was down, until I met a man who had no smartphone.",
    "What talking is forGather the pieces, so I can show you what is. That's what talking is for,to help us be one. Many-ness is having sixty different emotions. Unity is peaceand silence. I know I ought to stop now, but the excitement of this keeps opening my mouthlike a sneeze or a yawn does. Muhammad says, I ask forgiveness seventy timesa day, and I do the same. Forgive my talking so much, but the way God makes mysteriesmanifest quickens and keeps the flow of words continual.",
    "You are searching the world for treasure, but the real treasure is yourself.",
    "From the viewpoint of reality, all the senses see one thing, but from the standpoint of outward form they are each different from the other. When one sense is moved to absorption, all the senses become absorbed in it.Absorption is such that whoever enters it is no longer there. They make no more efforts, they cease to act and move. They are immersed in the water. No action is their action; it is the action of the water. But if they flail about in the water with their hands and feet, they are not truly submerged. If they utter a cry, “I am drowning, this too is not absorption.”",
    ...
    "WHISPERS OF LOVELover whispers to my ear, \"Better to be a prey than a hunter. Make yourself My fool. Stop trying to be the sun and become a speck! Dwell at My door and be homeless. Don't pretend to be a candle, be a moth, so you may taste the savor of Life and know the power hidden in serving.",
    ...
    "العشق هو تلك الشعلة التي عندما اشتعلت أحرقت كل شئ ما عدا المعشوق, و أنت بسبب شوكة واحدة تفر من العشق, فماذا تعرف أنت عن العشق ما خلا الاسم ؟",
    ...
    "The garden of the world has no limits Except in your mind. Its presence is more beautiful than the stars With more clarity Than the polished mirror of your heart.",
    "Unchain yourself, my son, escape its hold! How long will you remain a slave of gold?  -- The Masnavi",
    ...
    "Ignorance is God’s prison. Knowing is God’s Palace",
    "BAK BİL Kİ ATLARIN ÖNÜNE İNCİLER SERİLMEZ.MÜCEVHERLERDEN SARRAFLAR ANLAR ANCAK, BAŞKASI BİLMEZ...NE FARKEDER Kİ KÖR İNSAN İÇİN ELMAS DA BİR CAM DA.SANA BAKAN BİR KÖR İSE, SAKIN KENDİNİ CAMDAN SANMA.",
    "reason is powerless in the expression of love",
    "There is a place where words are born of silence,A place where the whispers of the heart arise.There is a place where voices sing your beauty,A place where every breathcarves your imagein my soul.",
    ...
    "Should your friend dismiss you,Do not be disheartened:Today he rejects you,Tomorrow he'll relent.If he has shut you out,Don't go away. Just stay.Patience is rewarded.He will reinstate you.If he appears to barAll passageways and paths,He will open the secret wayFor you, which others do not know.",
    ...
    "Love is the vital core of the soul,and of all you see, only love is infinite",
    "Roar the lion's knowledge. Writewith gold ink so whoever reads this will feel the ocean's light around them and growin the spirit.",
    "Argue not concerning God,… re-examine all you have been told at church or school or in any book, dismiss whatever insults your soul…. I",
    ...
    "What I most want is to spring out of this personality, then to sit apart from that leaping. I've lived too long where I can be reached.",
    "إن كان حزني من أجلك يميتني كل لحظة، لا تميتني أنت.اترك الجميع يميتني، لكن لا تميتني أنت لاتضرب برجلك من طرحته أرضاولا تمت كذلك من صيرته حيا.",
    "In the slaughterhouse of love, they killonly the best, none of the weak or deformed.Don’t run away from this dying.Whoever’s not killed for love is dead meat",
    "I am the call of love.... Can you hear me in the full grasses, in the scented winds ? It is I who makes the garden smile.",
    "You will learn by readingBut you will understand with love.(Rumi)",
    "We talk about this and that. There’s no rest except on these branching moments.",
    "Where there is pain, cures will come;where there is poverty, wealth will follow.Where there are questions, answers will begiven; where there are ships, water will flow.Spend less time seeking water and acquire thirst! Then water will gush from above and below.",
    "Your legs will get heavy and tired. Then comes a moment of feeling the wings you've grown, lifting.",
    ...
    "The Heart is your Student, For love is the only way we learn.",
    "Не могаМистерията да разбуля.Не могада разкрия това,което съвършено знам - в моята сърцевина най-тайнанещо бляска в радост.Не моганикога да го докосна...",
    "Няма думимежду нас сега.Въпреки че изглежда,че говоря,това е само Твоята любовпреливащаот моята чаша.",
    "I want that love that moved the mountains. I want that love that split the ocean. I want that love that made the winds tremble. I want that love that roared like thunder. I want that love that will raise the dead. I want that love that lifts us to ecstasy. I want that love that is the silence of eternity",
    "look what they've done to me;I am disheveled, bewildered, confused.Now please take my hand.I am wandering about,in awe and amazement of you.Take my hand.Everyonehas someone to take care for them.But look at me: I have no one.Take my hand",
    "YOU MUSTN'T BE AFRAID OF DEATHyou're a deathless soulyou can't be kept in a dark graveyou're filled with God's glowbe happy with your belovedyou can't find any betterthe world will shimmerbecause of the diamond you holdwhen your heart is immersedin this blissful loveyou can easily endureany bitter face aroundin the absence of malicethere is nothing buthappiness and good timesdon't dwell in sorrow my friendghazal number 2594",
    "Choose love. Choose love.Without this beautiful love,life is nothing but a burden.",
    "Крайната безпомощностна любовтае съвсем като смъртта - извън всякакъв контрол,агония на раждане.",
    "We are born of love; Love is our mother",
    "Разрухата носи име тайно,което дори величието не е чуло.Смъртта има смях,който дори и ангелитене познават.Кървавите пръсти на времетовезат гоблени на вечна милост.Искаш техния ред да откриеш?Полудей от любов!",
    ...
    "I have been a seeker and I still am, but I stopped asking the books and the stars. I started listening to the teaching of my Soul.",
    "If love were only spiritual, the practices of fasting and prayer would not exist.",
    "ليس على العاشق ترتيب الكلام.",
    "A Pharaoh said, “I am God and was laid low; a Mansur(Hallaj) said, “I am God” and was saved.The former “I” is followed by God’s curse and the latter“I” by God’s mercy, O loving man;For that one (Pharaoh) was a black stone, this one (Hallaj) acornelian; that one was an enemy to the Light, and this onepassionately enamoured (of it).”",
    "ای وصالت آرزوی عاشقان و ای خیالت پیش روی عاشقانهر کجا کردم نظر بالا و پست جلوه‌ای از روی زیبای تو هستخرقه‌پوشان محو دیدار تواند باده‌نوشان مست رخسار تواندحرفی از اسرار عشقم یاد ده هم بسوزان هم مرا بر باد ده",
    ...
    "The whole world is a form for truth. When someone does not feel grateful for that, the forms appear to be as he feels, they mirror his anger, his greed, his fear. Make peace with the universe. Take joy in it. It will turn to gold… Every moment a new beauty",
    "After days of feasting, fast.After days of sleeping, stay awake one night.After these times of bitter storytelling, joking,and serious considerations, we should give ourselvestwo days between layers of baklava in the quiet seclusionwhere soul sweetens and thrives more than with language.I hear nothing in my ear but your voice.Heart has plundered mind of its eloquence.Love writes a transparent calligraphy, so onthe empty page my soul can read and recollect.Which is worth more, a crowd of thousands,or your own genuine solitude?Freedom, or power over an entire nation?A little while alone in your roomwill prove more valuable than anything elsethat could ever be given you.Rumi, Two days of silence",
    "Put yourself behind my eyes   And see me as I see myself,   For I have chosen to dwell in a place   You cannot see!",
    "Remember, the way you make love is the way God will be with you.",
    "Make me sweet again,  and fresh  and fragrant  and grateful for any small event.",
    ...
    "كل شيء في هذه الدنيا يجذب شيئًا",
    "You are not a drop in a ocean, You are entire ocean in a drop.",
    "A fish wants to dive from dry landinto the oceanwhen it hears the roaring waves.A falcon wants to return from the forestto the King’s wristwhen it hears the drum beating “Return.A Sufi, shimmering with light,wants to dance like a sunbeamwhen darkness surrounds him.”",
    "كان قميص يوسف \"بشرى الوصال\" حين ألقي على يعقوب.",
    "Love rushed into my veins emtying me of myself. Now filled with the Beloved ..... my only possession is  my name",
    ...
    "Stay in the spiritual fire. Let it cook you.",
    "ليس التفاهم باللغات ولكن باﻷحاسيس.",
    "The body is a device to calculatethe astronomy of the spirit.Look through that astrolabeand become oceanic.",
    ...
    "Do not stir the clay every moment, so that your water may become clear, so that your dregs may be illumined, so that your pains may be cured.If you look into muddy water, you see neither the moon nor the sky; sun and moon both disappear when darkness possesses the air.",
    "Be like the cat, so alive after the mouse, never wondering or questioning why,when there is really only God, only God...touching ourpaws.",
    "Sit with lovers and choose their state. Do not stay long with those who are not living in the heart.",
    ...
    "First, when I was apart from you,this world did not exist,nor any other.Second, whatever I was looking forwas always you.",
    "THE AWAKENINGIn the early dawn of happiness you gave me three kisses so that I would wake up to this moment of loveI tried to remember in my heart what I’d dreamt about during the night before I became aware  of this moving  of lifeI found my dreams  but the moon took me away It lifted me up to the firmament and suspended me there I saw how my heart had fallen on your path singing a songBetween my love and my heart things were happening which slowly slowly  made me recall everything You amuse me with your touch although I can’t see your hands. You have kissed me with tenderness although I haven’t seen your lips You are hidden from me.But it is you who keeps me alivePerhaps the time will come when you will tire of kisses I shall be happy  even for insults from you I only ask that you  keep some attention on me",
    "Beg of God the removal of envy, that God may deliver you from externals, and bestow upon you an inward occupation, which will absorb you so that your attention is not drawn away.",
    "While reasonsees only barriers ,Love knows secret paths .وقتی که منطق تنها سدبر سر راه می بیند ،عشق راه مخفی را می یابد .",
    ...
    "First, when I was apart from you,this world did not exist,nor any other.Second, whatever I was looking forwas always you.Third, why did I ever learn to count to three?Fourth, my cornfield is burning!",
    "If A Tree Could WanderOh, if a tree could wanderand move with foot and wings!It would not suffer the axe blowsand not the pain of saws! For would the sun not wanderaway in every night ?How could at ev'ry morningthe world be lighted up? And if the ocean's waterwould not rise to the sky,How would the plants be quickenedby streams and gentle rain? The drop that left its homeland,the sea, and then returned ?It found an oyster waitingand grew into a pearl. Did Yusaf not leave his father,in grief and tears and despair?Did he not, by such a journey,gain kingdom and fortune wide? Did not the Prophet travelto far Medina, friend?And there he found a new kingdomand ruled a hundred lands. You lack a foot to travel?Then journey into yourself!And like a mine of rubiesreceive the sunbeams? print! Out of yourself ? such a journeywill lead you to your self,It leads to transformationof dust into pure gold!",
    "Дођи у воћњак у пролеће.Ту су светлост и вино, и љубавнициу цветовима нара.Ако не дођеш, све то није важно.А ако дођеш, све то није важно.˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷У телу света, кажу они, налази се душаи та душа си тиАли ми имамо пролазе један унутар другогкоје никада нико да спомене.˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷Кад сам с тобом, остајемо на ногама целе ноћи.Кад ниси овде, не могу да заспим.Слава Богу због те две несанице!И због разлике међу њима.˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷˷Играј, кад си начисто разбијен.Играј, ако си подерао завој.Играј усред битке.Играј у својој крви.Играј, кад си савршено слободан.",
    "It is time for us to join the lineof your madmen all chained together.Time to be totally free, and estranged.Time to give up our souls,to set fire to structures and run out in the street.Time to ferment. How else can we leavethe world-vat and go to the lip?We must die to become true human beings.",
    ...
    "Don't try to put out a fireby throwing on more fire",
    "The quiter you become, the more able you are to hear",
    "Life's waters flow from darkness. Search the darkness, don't run from it.",
    "The Reed Flute's WorkI say to the reed flute, You do the work,yet you know sweet secrets too.You share the Friend's breathing.What could you need from me?The reed replies, Knowledge is totaldestruction. I say, Burn me completely thenand leave no knowing.How could I, when it's knowledge that leads us?But this knowledge has lost compassionand grown disgusted with itself.It has forgotten about silence and emptiness.A reed flute has nine holesand is a model of human consciousness,beheaded, though still in love with lips.This is your disgrace, this moaning.Weep for the sounds you make.",
    ".کاتێ دەڕۆیت بێ من مەڕۆ، ئەی گیانی گیان بێ لەش مەڕۆ",
    "The FreshnessWhen it's cold and raining,you are more beautiful.And the snow brings meeven closer to your lips.The inner secret, that which was never born,you are that freshness, and I am with you now.I can't explain the goings,or the comings. You enter suddenly,and I am nowhere again.Inside the majesty.",
    "Worry about the others, who give youdelicious comforts that keep you from prayer.Friends are enemies sometimes,and enemies friends.",
    "The sky itself reels with Love.",
    "Here’s the new rule: break the wineglass, and fall toward the glassblower’s breath.",
    "The woman has great power. She can tie knots in your chest that only God's breathing loosens. Don'ttake her appeal lightly.",
    "Der Elefant, der gestern im Traume Indien sah,Sprang aus der Fessel - wer hat, ihn festzuhalten, Macht?",
    ...
    "You have read in the text where They love himblends with He loves them.Those joining lovesare both qualities of God. Fear is not.",
    "In The EndIn the end, the mountains of imagination were nothingbut a house.And this grand life of mine was nothing but an excuse.You've been hearing my story so patiently for a lifetimeNow hear this: it was nothing but a fairy tale.",
    "Lo, I am with you always means when you look for God,God is in the look of your eyes,in the thought of looking, nearer to you than your self,or things that have happened to youThere’s no need to go outside. Be melting snow.Wash yourself of yourself. A white flower grows in the quietness.Let your tongue become that flower.",
    "A woman is a beam of the divine light she is not the being whom sensual  desire takes as it's object she is a creator it should be said she is not a creature she is infinite love  can find all this",
    ...
    "Longing is the core of mystery.Longing itself brings the cure.The only rule is, suffer the pain.Your desire must be disciplined,and what you want to happenin time, sacrificed.",
    "Be a spot of ground where nothing is growing,where something might be planted,a seed, possibly, from the Absolute.",
    ...
    "هست طومار دل من به درازی ابدبرنوشته ز سرش تا سوی پایان تو مرو",
    ...
    "I hang here like Hallaj, feeling those lipson me, the honor of being lifted upon a crucifixion apple tree.Now the kissing is over.Fold your love in.Hide it like pastry filling.Whisper within witha shy girl's tenderness",
    ...
    "Understand the secret unseen ways of heart to heart contact like this:When two lamps are being lit.The lamps will remain separateBut their light will become intermixed",
    "Ich sehe Deine Schönheit ganz,schließ ich die Augen mein,Und schließ' den Mund ich, trinke ichnur immer Deinen Wein.Verboten gilt mir das Gesprächmit Menschen in der Welt -Doch wenn von Dir gesprochen wird:lang wird mein Wort dann sein!",
    ...
    "Drink from the presence of saints, not from those other jars.",
    "When light returns to its source,it takes nothingof what it has illuminated.It may have shone on a garbage dump, or a garden,or in the center of a human eye. No matter.It goes, and when it does,the open plain becomes passionately desolate,wanting it back.",
    "Farther And Farther From ZeroSuddenly, I fall from the pavilioninto a place where I see the ugliness,hypocrisy, rouge on a sunken face,a thorn lodged in a kidney, the blind croneholding a laurel wreath for the winner,her black ribbons in shreds,her eyes dark with purple,a gold anklet on her shriveled leg.The puppet show looks charming,but go behind the screen and watch who runs it.Wash your hands and face of this charade.Anyone who wants these prizesflares up quickly like a wood chip.There is one who can help,who turns the wheel from non-existenceto a sweet-breathing emptiness.Words are ways we add up breath,counting stress and syllablewith our exacting musical knackthat takes us farther and farther from zero.",
    ...
    "The glowing jewel says, \"Don't be fooled by my beauty - the light of my face comes from the candle of my spirit.Every jewel says to you, \"Be not satisfied with my beauty, for the light in my face derives from the candle of my awareness!",
    "Do you pay regular visits to yourself?Don’t argue or answer rationally.",
    "THE LEVEL OF WORDSGod has said, \"The images that come with human language do not correspond to me,but those who love words must use them to come near.\"Just remember, it'slike saying of the king, \"He is not a weaver.\" Is that praise? Whatever sucha statement is, words are on THAT level of God-knowing.",
    ...
    "Love Has Nothing To Do With The Five Senses Love has nothing to do withthe five senses and the six directions:its goal is only to experiencethe attraction exerted by the Beloved.Afterwards, perhaps, permissionwill come from God:the secrets that ought to be told will be toldwith an eloquence nearer to the understandingof these subtle confusing allusions.The secret is partner with nonebut the knower of the secret:in the skeptic's earthe secret is no secret at all.",
    "I was dead, but came back to life.I was the cry, but I became the smile.Love came and turned meinto everlasting glory.",
    ...
    "You are the comfort of my soul in the season of sorrow. You are the wealth of my spirit in the heartbreak of loss.",
    "When you are everywhere, you are nowhere / When you are somewhere, you are everywhere.",
    "Love and mercy –and not maulingawait you thereBut standing outside the door your suppositionsbar you like a bolt.Don’t set fire to this thicket be silent, heart!hold your tongue,for your tongueis a lick of flame.",
    "You suppose you are the trouble. But you are the cure. You suppose that youare the lock on the door. But you are the key that opens it.",
    "do not waste my words on tired minds.I can only talk to those who are thirstyfor the sea.",
    "GO WITH MUDDY FEETWhen you hear dirty storywash your ears.When you see ugly stuffwash your eyes.When you get bad thoughtswash your mind.andKeep your feet muddy.",
    "Be emptyand weep with the fullness of the reed flute.Be emptyand discover the mysteries of the reed pen.",
    "We have fallen into the sugar shaker.We are the ground beneath you.Let someone else describe the sky.Hold us in silence.Do no throw us backinto some discussion.",
    "The looking itself is a traceof what we are looking for.Be quiet now and wait.It may be that the ocean one,the one that we desire so to move into and become,desires us out here on land a little longer,going our sundry roads to the shore.",
    "Tie two birds together. They will not be able to fly even though they now have four wings.",
    ...
    "لا تتركني،اختبئ في قلبي كما يختبئ السر،التف حول رأسي كعمامة.((آتي وأذهب كما أشاء))،تقول، ((رشيقا مثل نبضة القلب)).يمكنك أن تستفزني كما تشاءلكن لا تتركني أبدا.",
    "Be empty of worrying.Think of who created thought! Why do you stay in prisonwhen the door is so wide open? Move",
    "مثل كأس، جسدي يحمل قلبي،وأفكاري مثل خمرة طازجة.ما المعرفة إلا فخ.كيف أعرف ؟فقد تلقيت هذه الرسالة من القلب",
    "This earth eats men and women, and yet we are sent to eat the world, this place that tries to foolus with tomorrow. Wait until tomorrow, which we outwit by enjoying only thisnow. We gather at night to celebrate being human. Sometimes we call out lowto the tambourine. Fish drink the sea,but the sea does not get smaller! Weeat the clouds and evening light. We are slaves tasting the royal wine.",
    ...
    "hear this if you can:if you want to reach himyou have to go beyond yourselfand when you finally arrive at the land of abscencebe silentdon't say a thingecstasy, not words, is the language spoken there",
    "In the lover's heart is a luteWhich plays the melody of longing.You say he looks crazy—That's only because your ears are not tunedto the music by which he dances.",
    "All change is due to time, therefore if youAre freed from time, you're free from changing too.",
    "If all you can do it crawl, start crawling.",
    "Dance, when you’re broken open.Dance, if you’ve torn the bandage off.Dance in the middle of the fighting.Dance in your blood.Dance, when you’re perfectly free.",
    "don't waste time pining for the pastdon't hold regrets for things that happened long agoif you let the past go, you'll be a Sufiyou'll be the child of the present momentthe young and old of now",
    ...
    "This world's existence is one night long. There's a great lively gathering that night, but some people sleep through it.",
    "يُمكن لي أن أنقسم عن أيِّ واحد ، عدا من يحتويني ضِمنهُ ز",
    "All winter you carved water jars out of ice.How well will they hold the summer snowmelt?",
    "Plunge headfirst into the ocean of your loving. Then look around patiently for the pearl that is yours.28”",
    "you can't untie this knot by listening tofairy talesyou have to do something inside yourselfthe smallest fountain inside of youis better than a raging river outside",
    "Лежа в прахтапри твоите нозе,сърцето ми - заплетенов къдриците на твоята коса.Стига толкоз!Устните си приближии нека твоята целувкадушата ми освободи.",
    "Wash in the wisdom-water,so you will have no regrets about the time here. Love is the vital core of the soul, and of all you see,only love is infinite",
    ...
    "I am filled with you.Skin, blood, bone, brain, and soul.There’s no room for lack of trust, or trust.Nothing in this existence but that existence",
    "You must set fire to have light. Trust means you’re ready to risk what you currentlyhave.",
    "Öğreneceksin yüreğim, Öğreneceksin … Dünyanın hasret, ölümün vuslat olduğunu.",
    "Every midwife knowsthat not until a mother's wombsoftens from the pain of labourwill a way unfoldand the infant find that opening to be born. Oh friend! There is treasure in your heart, it is heavy with child. Listen. All the awakened ones, like trusted midwives are saying, 'welcome this pain.'It opens the dark passage of Grace.",
    ...
    "Izjava \"Samo zbog tebe sam stvorio svjetove\" znači da je sav posao oko stvaranja uradjen zbog oka koje vidi i onog koji gleda",
    ...
    "Sometimes you get frightened as a camel.Sometimes you get stuck in the mudlike a hunted prey.O young fool,how long will you keep running awayfrom yourself?In the end,the thing will happen anyway.Just go in the directionwhere there is no direction.Go, search there.",
    ...
    "Everyone has someone:a friend, a lover, some skill or work.But I am alonewith the dream of my Belovedhidden in the corner of my heart.",
    "You have branded my heart, It will not err elsewhere.Without others, I can cope; Without you, I cannot.You are my wine, my joy, My garden, my springtime,My slumber, my repose, Without you, I can't cope.",
    "Rise up nimbly and go on your strange journey to the ocean of meanings. Leave and don’t look away from the sun as you go.",
    "THE DEATH OF SALADINYou left ground and sky weeping, mindand soul full of grief. No one cantake your place in existence or inabsence. Both mourn, the angels, theprophets, and this sadness I feel hastaken from me the taste of language,so that I can't say the flavor of mybeing apart. The roof of the kingdomwithin has collapsed! When I say theword YOU, I mean a hundred universes.Pouring grief water, or secret dripping in the heart, eyes in the head or eyesof the soul, I saw yesterday that all these flow out to find you when you'renot here. That bright fire bird Saladinwent like an arrow, and now the bowtrembles and sobs. If you know how to weep for human beings, weep for Saladin.",
    "SOMETIMES I FORGET COMPLETELY Sometimes I forget completelywhat companionship is.Unconscious and insane, I spill sadenergy everywhere. My storygets told in various ways: a romance,a dirty joke, a war, a vacancy. Divide up my forgetfulness to any number,it will go around.These dark suggestions that I follow,are they part of some plan?Friends, be careful. Don’t come near meout of curiosity, or sympathy.",
    "Let your eyes get used to light. Don't miss your own splendor! Don't stay in the batlikemind that loves complexity and doubt, the unlit niches. Bats seek those to livein, because there a bat's accomplishments seem greater than they are. He can impressas he confuses you with cave ramifications. Little by little accustom yourself to your own light,",
    "Recognizing MuhammadBefore Muhammad appeared in form,there were scriptural references. People imagined how he would be and calledon his presence in battle and sickness. They had thoughts and language about Muhammad.What good was that? Not everyone recognizes Muhammad. Many have a conceptionof him they can stand to live with. They don't know that if the shadow ofMuhammad's true form falls across a wall, the wall will bleed! And it willno longer have two sides! What a blessing to be one thing. When others saw Muhammad,their awe evaporated, as counterfeit coins turn black in the flame. There are falsecoins who claim they want to be tested, all bravado. And there are touchstones thatdo not reveal impostors. There are mirrors that hide your flaws. Avoid hypocriticalpraise, and keep away from flattering mirrors, if you possibly can.",
    "All of your anxiety is because of your desire for harmony. Seek disharmony and you will gain peace",
    "I said \"show me the ladder, that I may climb up to heaven ' He said \"your head is the ladder, bring your head down under your feet",
    "Forgive me, that I cannot sleep; forgive The thirsty ones that they have no water. Forgive: if you never know forgiveness, You'll never know the blessings that God gives",
    "شرح فقره للناس بصوته القبيح. لكنهم صدقوه ﻷن صوت قلبه كان لطيفا.",
    "I died as mineral and became a plant,I died as plant and rose to animal,I died as animal and I was human,Why should I fear? When was I less by dying?Yet once more I shall die human,To soar with angels blessed above.And when I sacrifice my angel soulI shall become what no mind ever conceived.As a human, I will die once more,Reborn, I will with the angels soar.And when I let my angel body go,I shall be more than mortal mind can know.― Rumi”",
    ...
    "For ages you have come and gonecourting this delusion.For ages you have run from the painand forfeited the ecstasy.So come, return to the root of the rootof your own soul.",
    "I am the bird of the spiritual Garden,  not of this world of dust; for a few days,  they have a cage of my body made.",
    "Life is sweetBut merging with you is far sweeter.",
    "سی پاره به کف، در چلّه شدیسی پاره منم، ترک چله کن",
    "An intelligent man, or woman, is a lamp that guides itself. Lethim or her lead. Trust the knowing they browse. A half-intelligent person is one who letsthe intelligent person be guide. He holds on like the blind to the coat of a helper. Throughanother, he acts and sees and learns. There is a third kind with no intellect at all, whotakes no advice, strolls out into the wilderness, runs a little to one side, stops, limpsthrough the night with no candle, no stub of a candle, no notion what to ask for.The first has perfect intellect. The second knows enough to surrender to the first. Onebreathes with Jesus. The other dies, so Jesus can breathe through him. The thirdflops and flounders in all directions, with no direction, lurches and leaps, tryingeverything, with no way or way out.",
    "Outer eyes are the inner eyes’ reflection,For outer eyes are under their direction....",
    ...
    "The way of God's Messenger is the way of Love.We are the children of Love.Love is our Mother.",
    "Love of one’s countryis part of the faith. But don’t take that literally!Your real “country” is where you’re heading,not where you are.”",
    ...
    "إذا خلع الأصلع قلنسوته، عاد أصلع!",
    "Each night the Moon kisses secretly the Lover who counts the Stars.",
    ...
    "You've come to know the fortunate and the inauspicious stars, but you don't know whether you yourself are fortunate or lucky.",
    "Ancora, dopo tutto questo tempo, il Sole non ha mai detto alla Terra,“tu mi devi.Guarda cosa accade con un amore simileIllumina il cielo.”",
    ...
    "Tragaj za mjesecom na nebu, ne za onim koji je u vodi.Da, u svom vlastitom srcu tragaj za znanjem Poslanika, bez knjige, bez tutora, bez učitelja.",
    "وقفت ذبابة على قشة سابحة على بول حمار فقالت: يا كم أحب ركوب هذا البحر الخضم!كان عالمها بقدر رؤيتها .. وكل عين إنما يكون بحرها بقدر رؤيتها.",
    ...
    "How long will you say, \"I will conquer the whole world How long will you say, \"I will conquer the whole worldand fill it with myself\"?Even if snow covered the world completely,the sun could melt it with a glance.A single spark of God's mercycan turn poison into springwater.Where there is doubt,He establishes certainty.",
    "فرّ يا ولدي من فرعونِ نفسك، ولذ بإله موسى.",
    ...
    "Don’t carry your knowledge-load for some selfish reason.Deny your desires and willfulness,and a real mount may appear under you.",
    "The young man could stand it no more.\"What is this? I've been ambushed by a night patrolin full daylight! Your blitherings try to keep me from the presence of a holy man,but I know what light led me here, the samethat turned the golden calf into words in a sacred story.A saint is a theater where the qualities of God can be seen.Don't try to keep me out. Puff on this candle, and your face will get burned! Rather try blowing out the sun, or fitting a muzzle on the sea!Old bats like you dream that their cave-darkis everywhere, but it's not.",
    "I am your lover, come to my side, I will open the gate to your love. Come settle with me, let us be neighbors to the stars. You have been hiding so long, endlessly drifting in the sea of my love. Even so, you have always been connected to me. Concealed, revealed, in the unknown, in the un-manifest. I am life itself. You have been a prisoner of a little pond, I am the ocean and its turbulent flood. Come merge with me, leave this world of ignorance. Be with me, I will open the gate to your love",
    ...
    "Suddenly Sheikh Kharraqani appears, riding a lion, firewood stacked behind him. His whip, a live serpent. Every sheikh rides a fierce lion, whether you see it or not. Know thiswith your other eyes: There are thousands of lionsunder your teacher's thighs and all of themstacked with wood!",
    "Your love has pierced me to the depths, its ecstasy entwines both bone and nerve",
    "Make it your habit to behold the Light without the glass, so that when the glass is shattered you may not be left blind.",
    "No prayer is complete without prescence",
    "كل من كان له مدد في داخله،فلا يخاف من العالم الذي لا مدد فيه",
    ...
    "Today, you have been inside my eyes all day.I am confused, upside down.You are so near and so obvious,I feel apart from you.I am so aware of you,I know nothing.",
    ...
    "I shall be happy   Even for insults from you   I only ask that you   Keep some attention on me.",
    ...
    "When a frog slips into the water,The snake cannot get it. Then the frog climbs back outand croaks, and the snakemoves toward him again.Even if the frog learned tohiss, still the snake would hear through the hiss the information he needed, the frog voiceunderneath.",
    ...
    "The woman has great power. Se can tie knots in your chest that only God's breathing loosens. Don'ttake her appeal lightly.",
    "Vem, te direi em segredoaonde leva essa dança.Vê como as partículas do are os grãos de areia do desertogiram desnorteados.Cada átomofeliz ou miserável,gira apaixonadoem torno do sol.",
    "A mystic touches the annihilating tipof pure nothing.",
    ...
    "If you show patienceIf you show patience, I'll rid you of this virtue.If you fall asleep, I'll rub the sleep from your eyes.If you become a mountain, I'll melt you in fire.And if you become an ocean, I'll drink all your water.",
    "I could spend a lifetime delighting in the image of the Friend But once my heart beholds the Friend then the pain becomes more precious than a thousand delights.",
    "The art of knowing is knowing who to ignore.",
    ...
    "We beganas a mineral. We emerged into plant lifeand into the animal state, and then into being human,and always we have forgotten our former states,except in early spring when we slightly recallbeing green again.",
    ...
    "Don’t ask me about prayer rocks— Anyplace I put my head is a prayer rock. Don’t talk of direction—All six directions face Him.Gardens, flames, nightingale,whirling dance, and brotherhood—Throw all these awayand throw yourself into His love.",
    "When your heart becomes the grave of your secret, that desire of your will be gained more quickly.",
    ...
    "The differences are just illusion and vanity. Sunlight looks a little different on this wall than it does on that wall and a lot different on this other one, but it is still one light.",
    ...
    "You are the source of my life. You bring rivers from the mountain springs. You brighten my eyes. The wine you offer takes me out of myself into the self we share.",
    ...
    "Do not be afraid of your wound, otherwise how can the light sneak into your depths?\"Rumi",
    ...
    "Your hand opens and closes and opens and closes. If it were always a fist or always stretched open,you would be paralyzed. Your deepest presence is in every small contractingand expanding. The two as beautifully balanced and coordinatedas birdwings.",
    ...
    "Those of you who are scattered,simplify your worrying lives. There is onerighteousness: Water the fruit trees,and don't water the thorns.",
    ...
    "What do you really possess,and what have you gained?What pearls have you brought upfrom the depth of the sea?On the day of death,bodily senses will vanish:do you have the spiritual lightto accompany your heart?When dust fills these eyes in the grave,will your grave shine bright?",
    ...
    "I'll accept your kindness,I'll accept your insult.I'll accept whatever you have to give.Your radiance shines in every atom of creation yet our petty desires keep it hidden.",
    ...
    "O Lord, we’ve erred!’* He sighed with heart aflame, ‘We lost the way as soon as darkness came!’ So destiny can block the sun’s bright light, Turn lions into mice because of fright.",
    "There is a Force within That gives you life Seek that",
    "من مكان لمكان تظل لاهثا وراء عقد الماس دون ان ترى انه يطوق عنقك",
    ...
    "The glowing jewel says, \"Don't be fooled by my beauty - the light of my face comes from the candle of my spirit.",
    ...
    "Look for the answer inside your question",
    "Rumi“ON THE DAY I DIEOn the day I die, when I'm being carriedtoward the grave, don't weep. Don't say,He's gone! He's gone. Death has nothing to do with going away. The sun sets andthe moon sets, but they're not gone.Death is a coming together. The tomblooks like a prison, but it's reallyrelease into union. The human seed goesdown in the ground like a bucket intothe well where Joseph is. It grows andcomes up full of some unimagined beauty.Your mouth closes here, and immediatelyopens with a shout of joy there.",
    ...
    "There is a secret hiddenin the heart of God’s peopleThat secret even Gabriel cannot findSeek it",
    "Be a lamp, or a lifeboat, or a ladder. Help someone's soul heal. Walk out of your house like a shepherd",
    "None that is raw understands the state of the ripe: therefore my words must be brief. Farewell! O son, burst thy chains and be free! How long wilt thou be a bondsman to silver and gold?",
    "No matter how I see myself, I’m nothing.... Anything I am entirely is You!",
    "Dear one, come to the tavern of ruinand experience the pleasures of the soul.",
    "My place is placeless, my trace is traceless,No body, no soul, i am from the soul of souls...!!!",
    "whoever sees you with the eyes of the heartgoes ecstaticbut the blind person stays lost in thoughthundreds of branches from the secret worlds aredropping roses at your feetwhy do you cut down the tree of contentment?",
    "a different kind of fragrancecomes from the gathering of loversa different kind of drunkennesscomes from those wise in lovethe knowledge you learned in school is differentlove is something else altogether",
    "Beautiful days do not come to you. You must walk towards them.",
    "don't be a scholarbe a fool for love insteadif you're the moon in the sky, fall downbecome the dirt on the roadbe together with young and old. good and badif you start out as a pawnyou'll become the king later on",
    "The body is not hidden from the soul, nor is the soul hidden from the body, and yet the soul is not for everyone to see.",
    ...
    "If you want a customer who will pay in gold, could there be a better customer than God, O my heart? He buys our dirty bag of goods, and in return gives us an inner light lent from His splendor.",
    "If a prisoner hadn't lived outside, he would notdetest the dungeon. Desiring knows there's satisfaction beyond this. Straying mapsthe path. A secret freedom opens through a crevice you can barely see. Your loveof many things proves they're one. Every separate stiff trunk and stem in the gardenconnects with nimble root hairs underground. The awareness a wine drinker wants cannotbe tasted in wine, but that failure brings his deep thirst closer. So the heart keeps ignoringthe waterfall and the key, but there is one guiding through all the desiring restlessness.",
    "Pay attention to those who want to change so badly that they cry and dissolve into lovingkindness and freedom.",
    "O heart! What a blessing to have reached The circle of Lovers.",
    "İnsan odur ki, başkasının incitişiyle incinmesin. Ve insan odur ki, incitilmeye müstahak olanı incitmesin...",
    "تلك الكلمات الجميلة التي قالها أحدنا للآخرمخبأة في قلب السماء السري.وذات يوم، مثل قطرات المطر، ستنهمرقصة عشقنا فوق العالم كله.",
    ...
    "I don’t get tired of you. Don’t grow wearyof being compassionate toward me!",
    ...
    "If light is in your heart you will find you way home.",
    "Last year I admired wines.This year I am wandering inside the red world.Last year I gazed at the fire.This year I am burnt kabob.Thirst drove me down to the water,where I drank the moon's reflection.Now I am a lion staring uptotally lost in love with the thing itself.Do not ask questions about longing.Look in my face.Soul-drunk, body-ruined, these twosit helpless in a wrecked wagon.Neither knows how to fix it.And my heart, I would say it is morelike a donkey sunk in a mudhole,strugglings and miring deeper.But listen to me. For one momentquit being sad. Hear blessingsdropping their blossomsaround you. God.",
    "To be one is heart is better than to be one in tongue.",
    "Until the mother faces the pain of childbirth, the child cannot be born. The Divine Trust is in the heart, and the heart is pregnant: the counsels of the prophets and the wise are like the midwife.",
    "آنک ضمیر دانه را علت میوه می‌کندراز دل درخت را بر سر دار می‌کشد",
    "We are all faced with incidents that teach usto be less selfish andjudgmental and morecompassionate and generous.",
    "Once the arrow has left the bow it will never return, and so are words that leave our lips.",
    "Life Is Sweet  But Merging With You Is Far Sweeter",
    ...
    "Advice doesn’t help lovers!They’re not the kind of mountain streamyou can build a dam across. An intellectual doesn’t knowwhat the drunk is feeling!",
    "Some people say about human beings, 'Dust to dust'.But how can that be true of onewho changes road dust to doorway?The crop appears to be one thingwhen it is still in the field.Then the transformation time comes,and we see how it is: half chaff, half grain.",
    "You're crying. You say you've burned yourself.But can you think of anyone who's nothazy with smoke?",
    ...
    "We know that kings oftenhide their treasure in ruins,but this field of rubble ishere because of its great value.",
    "WARRIOR LIGHTJafar, Muhammad's cousin, was a warrior of concentrated light. When he rode upto a walled city, it was no more to him than a gulp of water in his dry mouth. Thishappened at Mutah. No one went out to fight him. \"What's to be done?\" the king askedhis clairvoyant minister. \"If you strap on your sword with this one,\" repliedthe advisor, \"also wrap your shroud around you!\" \"But he's only one man!\"\"Ignore the singularity. Look with your wisdom. He gathers multitudes, as starsdissolve in sunlight.\" Human beings can embody a collective, a majestyof spirit, which is not like having a name or a body. A herd of onagers may displaya thousand antler points; then a lion comes to the edge of their field: they scatter.",
    "Are you jealous of the ocean’s generosity? Why would you refuse to give this love to anyone? Fish don’t hold the sacred liquid in cups! They swim the huge fluid freedom.",
    "همه را بیازمودم ز تو خوشترم نیامدچو فرو شدم به دریا چو تو گوهرم نیامد",
    "Oh, music feeds the calling souls of lovers,Music raises the spirits from its earthly covers.The ashes grow bolder and shed their furListen with stillness that only souls can share.",
    ...
    "Those with lives filled with laughter and sorrow, Have no choice but to live between the two, in borrow.Where is the green garden of love, that’s infinite? More than sorrow and laughter, plenty of fruits in it.",
    "(صار دكًّا منه وانشق الجبل هل رأيتم من جَبَلْ رقصَ الجمل)؟",
    "I walk into a huge pasture. I nurse the milk of millennia.",
    "Your name is Spring.Your name is wine.Your name is the nauseathat comes from wine!",
    "When I entered the cityyou moved away.When I left the cityyou didn't even look up to say good-bye.I'll accept your kindness,I'll accept your insult.I'll accept whatever you have to give.Your radiance shinesin every atom of creationyet our petty desires keep it hidden.",
    "The breezes at dawn have secrets to tell youDon't go back to sleep!You must ask for what you really want.Don't go back to sleep!People are going back and forthacross the doorsill where the two worlds touch,The door is round and openDon't go back to sleep!",
    ...
    "head, that you oftensit down in a fire like aloes wood, and often go outto meet a blade like a battered helmet.",
    "The garden of Love is green without limitand yields manyfruitsother than sorrowand joy.Love is beyond eithercondition:without spring,without autumn,it is always fresh.",
    ...
    "أن أعيش من دونكيعني أن أسلب من الحبوما قيمة الحياة من دونه؟أن أعيش من دونكهو الموت بالنسبة لي، يا حبيبيلكن البعض يطلقون عليه حياة",
    ...
    "No Better Gift\"When the ocean comes to you as a lover, marry, at once, quickly, for God’s sake! Don’t postpone it! Existence has no better gift. No amount of searching will find this. A perfect falcon, for no reason, has landed on your shoulder, and become yours.",
    "When you are looking straight in front of you 1495 How can you see what’s there behind you too?",
    "All roses fall prey to December.All intellect falls prey to love's glory.Since the rose is not eternalWhy be captured by its scent?Let me know your secrets—Only the ones that last forever.",
    ...
    "When water gets caught in habitual whirlpools,dig a way out through the bottomto the ocean. There is a secret medicinegiven only to those who hurt so hardthey can’t hope.",
    "I've come to take you with meeven if I must drag you alongBut first I must steal your heartthen settle you in my soul.",
    "Love, like life, flowsthrough the heart.Feel the thrill of the flowand say nothing.",
    "When have I asked youfor a sop for my soup? I don’t want giftsfrom you. I want you to be readyfor the gifts I give.",
    "The cure of pain is the pain.",
    "tez ömür ağacını tövbe suyuyla sula",
    "I’ve made up so many love stories.Now I feel fictional.",
    "after nourishment, shelter and companionship, stories are the thing we need most in the world.",
    "THIS TORTUREWhy should we tell you our love stories  when you spill them together like blood in the dirt? Love is a pearl lost on the ocean floor, or a fire we can't see, but how does saying that push us through the top of the head  into the light above the head?  Love is no tan iron pot, so this boiling energy won't help. Soul, heart, self. Beyond and within those is one saying,  How long before I'm free of this torture!",
    "فليس هناك شر مطلق في هذه الدنيا، إعلم إذن أن الشر نسبي. ولا يكون أبدًا سم وسكر في وقت واحد لا يكونان قوة لأحد وقيدًا لآخر... وسم الحية يكون حياة لتلك الحية، لكن بالنسبة للإنسان موت. والبحر بالنسبة لأحياء البحر كالحديقة، لكنه لمخلوقات الأرض موت ومصيبة.",
    "Turn back from the outer. Set your eyes within.",
    "جایی که برادر به برادر نکند رحم.بیگانه برای تو برادر شدنی نیست.(In a world where brother does not have mercy on brother, a stranger cannot become your brother)",
    "Be drunk with Love, for Love is all that Exists",
    "A True Man stares at his old shoesand sheepskin jacket. Every day he goes upto his attic to look at his work-shoes and worn-out coat.This is his wisdom, to remember the original clayand not get drunk with ego and arrogance.",
    "For whose sake are good women? For good men!",
    "This world is in deep trouble, from top to bottom. But it can be swiftly healed by the balm of love.",
    "Why think separately of this life and the next when one is born from the last....",
    "Tutto quello che davvero vogliamo è la gioia sconvolgente dell'Amore.",
    "Be empty of worrying.Think of who created thought!",
    ...
    "Light the incense! You have to burn to be fragrant.",
    "When your heart is cleansed of everything you think you are, you'll see yourself as an old beloved soul. It's not possible to see yourself without a mirror so gaze at the beloved; let his face become your mirror.",
    "I dreamt that the Beloved entered my body,pulled out a dagger,and went looking for my heart—He couldn't find it.So he struck anywhere.I woke upcounting this as a blessing.",
    "Do you think I know what I’m doing?That for one breath or half-breath I belong to myself?As much as a pen knows what it’s writing,or the ball can guess where it’s going next.",
    "Dance when you are perfectly free and enjoy every step along the way.",
    "I am happy tonight, united with the Friend.Free from the pain of separation, I whirl and dance with the Beloved.I tell my heart, 'Do not worry, the key to morning I've thrown away.",
    "Sükût, incelik, edep ve zerafet kadını her gittiği yerde sultan yapar",
    ...
    "O famous Moon, shine on me.A ray of your lightwould turn my world into a rosegarden.Now I will move in silence,Like a chess piece,Watching as my whole liferevolves aroundthe position of my King.",
    "Whether slow or speedy, he that seeks will find. Always apply with both hands the pursuit. For search is an excellent guide.",
    "In your light I learn how to love.In your beauty, how to make poems. You dance inside my chest,where no one sees you, but sometimes I do,and that sight becomes this art.",
    "Let your soul turn into a mirror that passionately wants to reflect Joseph.Hand him your present. Now let silence speak. As that begins, we will start out.",
    "Let your soul turn into a mirror that passionately wants to reflect Joseph.Hand him your present. Now let silence speak. As that begins, we will start out.",
    "In every religion there is love, yet love has no religion.",
    "Joseph dreamed the sun and moon were bowing down to worship him. Ten yearswent by and that came to pass. The saying, 'He sees by God's light,' is not an idleidiom. It means something. There is light that can shatter this earth-and-sky.It cannot be seen with eyes. This vision sees only the next step, what's directly in front.",
    ...
    "Lightning, your presence from ground to sky, no one knows what becomes of me, when you take me so quickly.",
    "Just to be held by the ocean is the best luck we could have. It is a total waking-up. (from Buoyancy)",
    "O fish! The bated hook is not your friend! Go deep, go deep.",
    "How can I know anything about the past or the future, when the light of the Beloved shines only Now.",
    "Just to be held by the ocean is the best luckwe could have. It is a total waking-up.",
    "Let your soul turn into a mirror that passionately wants to reflect Joseph.Hand him your present. Now let silence speak. As that begins, we will start out.",
    ...
    "بر شـاهِ خــوبرویان واجـب وفـا نباشـدای زرد رویِ عـاشــق تو صـبـر کـن وفـا کندردی سـت غـیرِ مُردن آن را دوا نباشـد!پس من چگونه گویم کاین دردرا دوا کُن",
    ...
    "There is no worse torture than knowing intellectually about love and the way. Those Egyptian women, when they saw Joseph, they were not judging his handsomeness. They were lost in it, cutting their hands as they cut their food.",
    "Any wine will get you high.Judge like a king, and choose the purest, the ones unadulterated with fear,or some urgency about “what’s needed.",
    "There’s no need to go outside. Be melting snow.Wash yourself of yourself.",
    "Butchers enjoy the mindless chewing of lambs. Likewise the appetites work for a shadow king. Do thesoul work instead. Feed daily on wisdom. Expand your heart. Rest the appetites. Theyare bandits on the road. They stop your spirit and steal valuables. The most vitalthing about you is your soul intelligence. The rest is a mask for that. Don'tlose touch with it. Sensual wantings sometimes block and blur that intelligence as surely as wine or hashish can. Arrogance too is drunken, making youthink things true that aren't.",
    "Aldanma insanoğlunun menfaatine. Allah cenneti vaat etmeseydi Allah'a bile etmezdi secde",
    ...
    "Cerul este Bărbatul, iar pământul, Femeia!",
    "Nisam došao ovdje sa svojom voljom i ne mogu na taj način otići, ko god me je doveo ovdje, morat će me odvesti kući",
    "That hurt we embrace becomes joy. Call it to your arms where it can change.",
    "Ignorance is God’s prison.Knowing is God’s palace. We sleep in God’s unconsciousness.We wake in God’s open hand. We weep God’s rain.We laugh God’s lightning. Fighting and peacefulnessboth take place within God.",
    "No one who really loves,loves existence.",
    "My soul, don't try to answer now!Find a friend, and hide.But what can stay hidden?Love's secret is always lifting its headout from under the covers,\"Here I am!",
    "A lover’s food is the love of bread,not the bread. No one who really loves,loves existence. Lovers have nothing to do with existence.They collect the interest without the capital. No wings, yet they fly all over the world. No hands, but they carry the polo ball from the field. That dervish got a sniff of reality.Now he weaves baskets of pure vision.",
    "Ljubav dolazi sama od sebe i traganje za njom ne može biti naučeno ni u jednoj školi-",
    "Lovers pitch tents on a field of nowhere.",
    "I didn’t come here of my own accord, and I can’t leave that way.",
    "ez uzroka, Bog nam je podario bivstvovanje. Bez uzroka vraća ga sebi",
    "Whoever brought me here will have to take me home.",
    ...
    "Be empty of worrying.Think of who created thought! Why do you stay in prisonwhen the door is so wide open?",
    "All people on the planetare children, except for a very few.No one is grown up except those free of desire.",
    "It is good to be quiet.Say less.",
    "Nada sliči gluhom čovjeku koji je često imao prilike da sluša o nečijoj smrtiali nije nikada o svojoj vlastitoj, niti ikada meditirao o svom vlastitom svršetkuSlijep čovjek je poput pohlepeon, do u najmanje sitnice vidja mahane drugihprenosi ih na sve strane, ali je slijep za svoje vlastite",
    "The whole world’s jealous, for God’s jealousy",
    "Don’t hand me another glass of wine.Pour it in my mouth.I’ve lost the way to my mouth.",
    "Don’t turn your head.Keep looking at the bandaged place.That’s wherethe Light enters you.",
    ...
    "A royal spirit escaped from a prison: why should we rend our garments and how should we gnaw our hands? Since they were monarchs of the (true) religion, ’twas the hour of joy (for them) when they broke their bonds.",
    "Tamo gdje je bol u tom srcu se kreće i lijekTamo gdje je oskudica tim pravcem ide i nafakaNe tragaj za vodom već povećaj svoju žedj kako bi voda mogla poteći prema tebi i sa neba i sa zemlje Dok se ne rodje nježne usne bebinekako bi mlijeko sa majčinih prsa ikako moglo poteći?",
    "The true lover is never free from striving, they revolve restlessly and ceaselessly around the light of God. And God consumes them, making them nothing, destroying the veil of their reason.",
    "Every object, every being,is a jar full of delight. Be a connoisseur,and taste with caution.",
    "Poslušaj i predaj se Bogu i ne dopusti da se tvoje tijelo trese od strahaTvoja svakodnevna nafaka je više privržena tebi nego što si ti njojOn je u ljubavi prema tebi i drži se na odstojanju jedino zbog tvog pomanjkanja samoporicanjaPovjerenje u Boga donosi potunu sitost",
    ...
    "Give up wanting what other people have.That way you’re safe.“Where, where can I be safe? you ask. This is not a day for asking questions,not a day on any calendar.This day is conscious of itself.This day is a lover, bread, and gentleness,more manifest than saying can say. Thoughts take form with words,but this daylight is beyond and beforethinking and imagining. Those two,they are so thirsty, but this gives smoothnessto water. Their mouths are dry, and they are tired. The rest of this poem is too blurryfor them to read.”",
    "Uvijek kad sam se okretao svijetu, pogodio bi me udarac i bol od njihove ruke. I moleći se za pomoć približio sam se Bogu. Vuci su bili ti koji su mi pokazali pravi put. Zato su oni postali izvor mog ozdravljenja, zato je moja molitva namjenjena njima.",
    ...
    "And my heart, I’d say it was morelike a donkey sunk in a mudhole,struggling and miring deeper.",
    "خوشتر آن باشد که سر دلبرانگفته آید در حدیث دیگران!",
    "listen to me: for one moment,quit being sad. Hear blessingsdropping their blossomsaround you.",
    "Everything except love, is devoured by love......",
    "Aroused PassionOh GodLet all lovers be contentGive them happy endingsLet their lives be celebrationsLet their hearts dance in the fire of your loveMy sweetheartYou have aroused my passionYour touch has filled me with desireI am no longer separate from youThese are precious momentsI beseech youDon’t let me waitLet me merge with you",
    "if your eyes are marredwith petty visionswash them with tearsyour teardrops are healersas they begin to arrive",
    ...
    "Do not look back, No one knows how the world ever began. Do not fear the future, Nothing lasts forever. If you dwell on the past or future, You will miss the moment. What is planted in each person's soul will sprout",
    ...
    "Half of life is lost in charming others. The other half is lost in going through anxieties caused by others. Leave this play. You have played enough.",
    "Bez obzira gdje smo i kamo nas put vodio mi sjedimo za Tvojim stolom, za tvojom sofrom. Mi smo golubovi Tvoje tvrdjave, oko Tvog Prijestolja pravimo krugove.",
    "به سکوت گوش کن ، حرفهای زیادی برای گفتن دارد.",
    ...
    "Sinovi mnogih plemenitih ljudi su osramotili svoje očevesa svojim rdjavim djelimaNe računaj takodje ni na osobu koja je obdarena talentima, čak i kada izgleda izvrsna u tom pogleduuzmi poduku iz iblisovog primjeraon je posjedovao znanje ali budući da njegova ljubav nije bila čistau Ademu je samo vidio figuru od ilovače",
    ...
    "When you’re full of food and drink, an ugly metalstatue sits where your spirit should. When you fast,good habits gather like friends who want to help.Fasting is Solomon’s ring. Don’t give itto some illusion and lose your power,but even if you have, if you’ve lost all will and control,they come back when you fast, like soldiers appearingout of the ground, pennants flying above them.",
    "Daleko izvan ideja o dobru i zlu postoji polje - To je naše mjesto susreta",
    ".ئه‌ڤینت دڵنیای کردووم",
    "Love is the whole thing. We are only pieces.",
    "Ako ti zatvori sve puteve i prolaze, pokazat će ti skrivenu stazu koju niko drugi do tada nije upoznao!",
    "Being human means entering this place where entrancing varieties of desire are served. The grapeskin of ego breaks and a pouring begins. Fermentation is one of the oldest symbols for human transformation.",
    "في الليلة الماضية، بين جمع من الناسلمحت حبيبي.كنت محرجا لمعانقتهفوضعت وجهي على خدهمتظاهرا بأني أهمس شيئا في أذنه",
    ".....every form puts a limit on mystery",
    ...
    "A friend remarks to the Prophet, “Why is itI get screwed in business deals?It’s like a spell. I become distractedby business talk and make wrong decisions. Muhammad replies, “Stipulate with every transactionthat you need three days to make sure.”",
    "O soul, leave behind this world of separationand come with us to the world of union.How long will you play in this dusty worldlike a child filling his skirt with worthless stones?Cast away the burdens of the earthand fly upward toward heaven!Put away your childish careand join the royal banquet.Behold the countless ways this body has entrapped you!Break its deadly hold.Rise up, lift your head clear of this delusion.",
    ...
    "All day I think about it, then at night I say it.Where did I come from, and what am I supposed to be doing?I have no idea.My soul is from elsewhere, I’m sure of that,and I intend to end up there.",
    "I am the rose of eternity,not made of water or fire,not of the wandering windor even earth. I play with those.I am not Shams of Tabriz,but a light within his light.If you see me, be careful.Tell no one what you have seen.",
    ...
    "There is no salvation for the soul but to fall in Love. Only lovers can escape out of these two worlds. This was ordained in creation. Only from the heart can you reach the sky: The Rose of Glory can grow only from the heart.",
    "Study me as much as you like, you will not know me, for I differ in a hundred ways from what you see me to be.",
    "The eye of the intellect is drunk with You, the wheeling galaxy is humble before You, the ear of ecstasy is in Your hand; nothing happens without You. The soul is bubbling with You, the heart imbibes from You, the intellect bellows in rapture; nothing happens without You.",
    ...
    "Očistio sam radionicu unutar samog sebe i odbacio sve idoleShvativši vrijednost ludosti, postao sam slobodan od misli",
    "Don’t run around this world looking for a hole to hide in. There are wild beasts in every cave!If you live with mice,the cat claws will find you. The only real rest comeswhen you’re alone with God. Live in the nowhere that you came from,even though you have an address here.",
    "Pokušaj da skontaš razliku izmedju njegovanja zemlje i pustošenja.Kako će ova zemlja postati ružičnjakom ako se prethodno ne uzore i preturi?",
    "Prayer clears the mist and brings back peace to the Soul.",
    "BACKPAIN Muhammad went to visit a sick friend. Such kindness brings more kindness, and there is no knowing the proliferation from there.      The man was about to die. Muhammad put his face close and kissed him. His friend began to revive. Muhammad’s visit re-created him. He began to feel grateful for an illness that brought such light. And also for the backpain that wakes him in the night. No need to snore away like a buffalo when this wonder is walking the world. There are values in pain that are difficult to see without the presence of a guest. Don’t complain about autumn. Walk with grief like a good friend. Listen to what he says. Sometimes the cold and dark of a cave give the opening we most want.",
    "Of the book of God Thou art a copying, A mirror, wherein showed The beauty of the King. All God ever wrought Dwelleth not apart; All thou hast ever sought, Find it in thy heart.",
    ...
    "Like the shadow of a cypress tree in the meadow,like the shadow of a rose, I liveclose to the rose. If I separated myself from you,I would turn entirely thorn.",
    ...
    "Do you think I know what I'm doing?That for one breath or half-breath I belong to myself?As much as a pen knows what it's writing,or the ball can guess where it's going next.",
    "If you’ve an opening in your heart you’ll see The sun’s bright rays wherever you may be— In everything God can be seen through love 1410 Just like the moon among the stars above.",
    ...
    "When souls lie down in that grass, the world is too full to talk about.",
    ...
    "To Love is to be God.Never will a Lover's chestfeel any sorrow.Never will a Lover's robebe touched by mortals.Never will a Lover's bodybe found buried in the earth.To Love is to be God.",
    "even if the whole world’s harpshould burn up, there will still behidden instruments playing.",
    ...
    "...se pare că m am \" pierdut în elocvența tăcerii \" aici !",
    "Ni kršćanin, ni jevrejin, ni musliman, ni hindu, ni budist, ni zen. Ni iz koje vjere i kulture. Niti sam s Istoka niti sa Zapada. Moje je mjesto bezmjesnost, trag bestraga...",
    ...
    "Why think separately of this life and the next when one is born from the last.",
    "Be courageous and discipline yourself. Work. Keep digging your well. Don't think about getting off from work. Submit to a daily practice. Your loyalty to that is a ring on the door. Keep knocking, and the joy insidewill eventually open a windowand look out to see who's there.",
    ...
    "Smell the aroma of beautiful food, then go to the latrine and sniff. \"What happened to you?\" Your dung will answer,\"My beauty was a lure, a trick to get inside you.\"Every matter particle does the sameenchantment. Try to see the beginning and end at once. Would you willingly wear manaclesjust because they're made of gold? Admire the genius of an artist, but also watch whathappens to him or her in old age, how the expert craftsman's craft diminishes.",
    "What you seek is seeking you",
    "Ako životinji njena inteligencija omogućava da bira, strašna je zabluda da čovjek koji je iznad svih zemaljskih stvorenja u pogledu razuma i rasudjivanja,bude ispod životinja u svom izboru. Neka nas Allah dzs zaštiti od takvih besmislica.",
    ...
    "Znaj da je svijet stvorenih stvari sličan čistoj i bistroj vodiu kojoj se ogledaju svojstva SvemogućegMjesec je isti ali voda nije ista vodaPravda je ista pravda i znanost je ista znanostali naraštaji i narodi su zamijenjeni drugimaNaraštaji su iščezli, ali oni (Božanska svojstva) trajni su i vječni",
    "Everything else than sea is a torment to a fish",
    "لكل واحد صديق، أو حبيب،أو مهارة أو عمل.أما أنا فوحيدوحلم محبوبي مخبأ في زواية قلبي.",
    "تا با غم عشق تو مرا کار افتادبیچاره دلم در غم بسیار افتادبسیار فتاده بود اندر غم عشقاما نه چنین زار که این بار افتاد",
    "Friendship and loyalty have patience as the strength of their connection. Feeling lonely and ignoble indicates that you haven't been patient.",
    "Ako otvoriš svoje oko, izgledat ćeš podoban samo za sebe (u svojim očima svako je najbolji).Ali ako dospiješ do ovog gledanja, znat ćeš da sam bez premca.O dušo, ili ti udji u ovu kuću ili ja napuštam tijelo.Svakod dana trpim neugodnost hladnoće, i decembarskog snijega u nadi za proljećem.Božija ljubav je veoma jaka tvrdjava, tovar svoje duše nosim unutar njenih zidina. Za ljubav prijatelja podnosim aroganciju svakog neznanca kamenog srca, za ljubav ružepodnosim trnje.",
    ...
    "I am a painter, a maker of pictures; every moment I shape a beauteous form,And then in Thy presence I melt them all away.",
    ...
    "You must have shadow and light source both.Listen, and lay your head under the tree of awe. When from that tree, feathers and wings sprouton you, be quieter than a dove.Don’t open your mouth for even a cooooooo.",
    "Onome ko ima 10 briga, a srcu uzima brigu o vjeri, Uzvišeni Bog će mu umanjiti preostalih 9 briga da se ne bi morao baviti njima.....\"Prijatelj sam onome ko me se prisjeća (hadis)",
    "Someone was saying yesterday, \"This world began in time, but eternity will inherit it.",
    ...
    "Spirit is beyond either feminine or masculine.It is not sometimes like this and sometimes like that.",
    "صرت إذ مت جمادًا ناميَامت نبتًا صرت حيًّا ساعيَامت حيوانًا إذا بي بشركيف أخشى الموت ماذا أحذر؟ثم أغدو مائتًا بين البشرطائرًا في ملك لا أستقرليس لي إلا سمو نحوهكل شيء هالك إلا وجههثم أسمو طائرًا فوق الملكفأكون الشيء لا يخطر لكثم أفنى فيغنيني المنونمنشدًا إنا إليه راجعون",
    "Be silent, Only the Hand of God Can remove The burdens of your heart.",
    "Here is a story of a young prince who suddenly sees that the ambitious world is a big game of kingof the mountain, a boy scrambling up a pile of sand to call out, \"I am king\"; then anotherthrows him off to make his momentary claim, then another and so on.",
    "Magicians can be confusing, butwhen Moses arrives and throws down the rod that becomes a dragon, how do the trick bowlslook then? When something that alive comes, illusory matters fade. They quit bragging!A body's death, even, is beautiful to those who see with the soul's eye.",
    ...
    "Zlo nestaje onog trena kada krene u potragu za dobrim. Ako je sjeme egoizma gadnog mirisa, ono ipak kada dosegne ruh, zadobija svjetlo. Svaki mineral koji svoje lice okrene prema biljci, nalazi da život izrasta iz stabla njegove sudbine.",
    "bvThere's never a moment when we're not in love. Every hour there may be a new love: love of sleep, love of rest, love of the harp, or simply love of beauty. When we feel enveloped by these feelings, we know we're enveloped by Love.",
    "Be relentless in your looking,because you are the one you seek.",
    "You that change the dull field,who give conversation to damaged ears,make dying alive, award guardianshipto the wandering mind,you who erase the five senses at night,who give eyes allure and a blood clot wisdom,who give the lover heroic strength,you who hear what Sanai said,Lose your life, if you seek eternity.The master who teaches usis absolute light, not this visibility.",
    "Though you read a hundred volumes without a pause, you won't remember a single point without a Divine decree; but if you serve God and read not a single book, you'll learn rare sciences within your own heart.~ Mevlana aka Rumi",
    "There's never a moment when we're not in love. Every hour there may be a new love: love of sleep, love of rest, love of the harp, or simply love of beauty. When we feel enveloped by these feelings, we know we're enveloped by Love.",
    "Soul of all souls, life of all life—you are That.Seen and unseen, moving and unmoving—you are That.The road that leads to the City is endless;Go without head or feetand you’ll already be there.What else could you be?—you are That.",
    ...
    "There are no minarets built in praise ofwhat doubters say, no passionate talk about their lives.The coin faces of officialskeep changing, but not the flame-tongued book of the sun. Be plain as day and a friend to whatlasts. Cynics say the same thing over and over, \"I only know what I see.\" Every external form isa text to study, embodying a truth, the way medicine contains healing. Does a painter paintfor the sake of the picture and not for the eyes of those who will look at it?",
    ...
    "Većina onih koji su predodredjeni za džennet su jednostavni ljudi, iz razloga da bi mogli umaći od zla filozofije",
    ...
    "Being in love is made manifest by soreness of heart: there is no sickness like heart-sickness.The lover's ailment is separate from all other ailments: love is the astrolabe of the mysteries of God.Whether love be from this (earthly) side or from that (heavenly) side, in the end it leads us yonder.",
    "A fool came and sat in a seat above one of the great saints. What difference does it make to the saints whether such a person is above or below the lamp? If the lamp wants to be on high, it does not desire that for its own sake. Its purpose is for the benefit of others, so they can enjoy their share of the light. Wherever the lamp may be, whether below or above, it is still the lamp of the Eternal Sun.",
    "There is no love greater than Love with no object. For then you, yourself, have become Love itself.",
    "من به هیچ مذهبی تعلق ندارم دین من عشق است هر قلب معبد من استI belong to no religion. My religion is love. Every heart is my temple",
    ...
    "Sit near someone who has had the experience.Sit under a tree with new blossoms.Walking the section of the marketwhere chemists sell essences,you will receive conflicting advice.Go toward kindness.If you are not sure where that is,you will be drawn in by fakes.They will take your money and sit you downon their doorstep saying, I’ll be right back.But they have another door they leave by.Do not dip your cup in a potjust because it has reached the simmering point.Not every reed is sugarcane.Not every under has an over.Not every eye can see.Or it may be you cannot thread the needlebecause it already has thread in it.Your loving alertness is a lantern.Keep it protected from windthat makes it crazy.Instead of that airy commotionlive in the water that gently coolsas it flows. Be a helpful friend,and you will become a green treewith always new fruit,always deeper journeys into love.",
    "Yalnızlığın en kötüsü seni anlamayanların arasında kalmaktır.",
    "Be with those who mix with Godas honey blends with milk, and say, “Anything that comes and goes,rises and sets,is not what I love.",
    "He said, “Your witness is invalid; your eye is wet-skirted. Isaid, “By the splendour of your justice, they are just and withoutfault.”He said, “Who was your companion?” I said, “Your fantasy,O King.” He said, “Who summoned you hither?” I said, “Thescent of your cup.”",
    "If You Want What Visible Reality If you want what visible realitycan give, you're an employee.If you want the unseen world,you're not living your truth.Both wishes are foolish,but you'll be forgiven for forgettingthat what you really want is love's confusing joy.",
    ...
    "My mother was destiny. My father, grace.My name is prince of synchronicityand serendipity.",
    "نحن منسوجون من العدم، نجوم منثورة مثل الغبار.",
    ...
    "There is a rational soul leadingyour donkey through the mountain wilderness. When the donkey pulls away and takes offon its own, that clear one chases, calling, \"This place is full of wolveswho would love to gnaw your bones and suck the sweet marrow.\" This sovereignself in you is not a donkey, but more like a stallion, and Muhammad is the stable keeperspeaking quietly, Ta'alaw, in Arabic, Come, come. I am your trainer.",
    "We all face death in the end. But on the way, be careful never to hurt a human heart!",
    "When Divine Love had its effect,It made rest and comfort disagreeable.When he experienced the ecstasy of love,He removed the crown from his head.He exchanged the Royal Throne for a life of poverty.Well done, 0 True Lover, well done!Ask about the ecstasy of love from him,Whose heart has been injured by love.",
    "There is an invisible strength within us; when it recognizes two opposing objects of desire, it grows stronger.",
    "I have a thirsty fish in methat can never find enoughof what it’s thirsty for!",
    "Dans ton âme il y a une âmeCherche-la!Dans le mont de ton corps, une perleTrouve-la!Ô soufi qui avanceSi tu cherchesNe cherche pas hors de toiEn toi, cherche cela!",
    ...
    "Let Go Of Your Worries Let go of your worries and be completely clear-hearted, like the face of a mirror that contains no images. If you want a clear mirror, behold yourself and see the shameless truth, which the mirror reflects. If metal can be polished to a mirror-like finish, what polishing might the mirror of the heart require? Between the mirror and the heart is this single difference: the heart conceals secrets, while the mirror does not.",
    "This is how it always iswhen I finish a poem. A great silence overcomes me,and I wonder why I ever thought to use language.",
    "Create the bounty of madness in your heart (of His love)Not by intelligence alone will you reach to the truth.\"(For if the mind is not enlightened by revelation,It is better to remain an ignorant one.)",
    ...
    "Who knows whether the candle's wax tears are shed on account of its converse with the fire or its separation fro the honey of the hive?",
    ...
    "Consult with the assembly of righteous,For the Prophet 1ft was also ordered to do that.The minds of men are like lighted lamps,The light of twenty lamps surely gives more light than one",
    ...
    "All day I think about it, then at night I say it.Where did I come from, and what am I supposed to be doing?I have no idea.My soul is from elsewhere, I am sure of that,and I intend to end up there . . .I didn't come here of my own accord, and I can't leave that way.Let whoever brought me here take me back.",
    ...
    "All good and bad are part of the dervish.Whoever is not so is not a dervish.",
    "But let's suppose for a moment that my inspiration is not divine. Still, you would agree, my speaking is not inferior to the workings of a bee? The Quran says, God has inspired the bee. This universe is filled with honey. Human beings feed on it and evolve upwardwith the same, but more profound, inspiration as the bee.",
    "God breaks your heart, and keeps breaking your heart, until it stays broken.",
    "Water and bread with us you can’t compare 895 But, once they’re eaten, turn to flesh in there, Water and bread don’t look compatible, The end-result shows that it’s possible. So if it’s something different that you like It must at least in some way be alike;",
    "ولا تسعني الأرض ولا السماء ولا يسعني العرش أيضًا، واعلم أن هذا يقينًا أيها العزيز، ويسعني قلب عبدي المؤمن ويا للعجب، وان كنت تبحث عني، فاطلبني في تلك القلوب.",
    ...
    "But since the power to free or bind is His I am left with empty hands and wonder from whom comes this self-conceit of mine? When unconscious, I am nothing when conscious, I am in torment. Truly the state of possessing nothing suits me better since",
    ...
    "I burst my breast, striving to give vent to sighs,And to express the pangs of my yearning for my home.He who abides far away from his homeIs ever longing for the day he shall return.",
    "You are two hands, two legs, and two eyes,But if your heart and the Beloved are also two,what good is that?You call out, 'I am the lover',but these are mere words.If you see lover and Beloved as two,you either have double visionor you can't count.",
    ...
    "Pale sunlight,pale the wall.Love moves away.The light changes.I need more gracethan I thought.",
    ...
    "Your curly hair is seduction of infidelity while your moon-face is piety, Glimpse it from the infidel's eye you'll then see bot as a source of blessing. In every moment like the Moon the venerated \"bot\" shows its face, Until the Arab symbols surfaced, the heart then hid its secrets.",
    ...
    "The fire puffed up with pride its flaming head, But soon the wind pronounced that ‘it is dead’.",
    "رأى الأسد نفسه في عتوّ، فلم يعرف نفسه من العدوّ. حسب العدو صورة نفسه؛ فلا جرم سلَّ سيفه على رأسه. كم من ظُلْمٍ تراه في غيرك، وإنما فيه صورة طبعك. انعكس فيهم لا جرم كونُك، غرورك ونفاقك وظلمك. هذا أنت فإنما لنفسك الطعنة، وعلى نفسك تنسج خيوط اللعنة. وأنت لا ترى في نفسك هذا السُّوء، وإلا رأيت نفسك العدو المشنوء.",
    "Your hand opens and closes, opens and closes. If it were always a fist or always stretched open, you would be paralyzed. Your deepest presence is in every small contracting and expanding, the two as beautifully balanced and coordinated as birds' wings.\"-",
    "If love were only spiritual, the practises of fasting and prayer would not exist.The gifts of lovers to one another are, in respect to love, nothing but forms;yet, they testifyto invisible love.",
    "If words come out of the heart, they will enter the heart.",
    ...
    "وضعتَ على عينك زجاجة زرقاء، فازرقَّت أمامك الأرض والسماء. إن يكن ازرقَّ زجاجُ كوَّتك، ازرقَّ ضوء الشمس في نظرك. لا تَعْمَ فهذا اللون منك بَدَا، فالْحَ نفسك إذًا ولا تَلْحَ أحدَا.",
    ...
    "If a branch is laden with fruit, it pulls the branch down, whereas a branch that bears no fruit holds its head up high, like a poplar tree. The Prophet was extremely humble, because the fruits of this world and the next were gathered upon him. He was thus the most humble of men.",
    ...
    "سَلِّط النور على النار حينًا بعد حين، لتصير نارك نورًا أيها المسكين.",
    "Love wants its tale revealed to everyone, But your heart’s mirror won’t reflect this sun, Don’t you know why we can’t perceive it here? Your mirror’s face is rusty—scrape it clear!",
    ...
    "Junnaiyd says there is a sobriety that contains all drunkenness, but there is no drunkenness that contains all sobriety.",
    "Be still! Be quiet! Find acquaintance with silence. Go inside, delve into your heart. Take a day off from the clamour.",
    "God is manifest among fellow humans as the moon shines among starsRUMI",
    "now the time has arrived to become the soul of the souls",
    "ComeLet’s cherish each otherLet us liveattuned to each otherEnmity takes the light out of friendshipLet’s banish all enmity from our heartsDoes it bring joy to your heart to imagine me dead?Why are we like this? worshiping death hating life?If I dieYou’ll want to make upPretend I’m dead now Come,let’s reconcile our hearts nowIn submitting to God our egos have already diedIf I dieyou’ll come to kiss my graveWe are now like thisComenowand kiss my face",
    "over the moon’s. Jupiter lifts a",
    "گر تو خواهی کت شقاوت کم شودجهد کن تا از تو حکمت کم شود",
    "Believers are each other’s mirrors’, * friend. The Prophet said this—won’t you comprehend?",
    ...
    "Muhammad is tasting continuallythe wine of the agreement he made with God before the creation of the universe,the wine of the question Am I not your Lord? and of the answer Yes! The sevensleepers sipped that and slept three hundred and nine years. The Egyptian women drankone cup and were lost in Joseph's beauty. Pharaoh's magicians inhaled this fragrance,and the gallows looked like lovers coming toward them. Jafar lost his hands and feetin battle, yet flew because he tasted this Yes. Yes.",
    ...
    "Prošlost i budućnost prikrivaju Boga pred našim očima, i jedno i drugo spaliti vatrom.",
