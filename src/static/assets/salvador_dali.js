export const SALVADOR_DALI = [
    ...
    "_ ماهي الموضة؟_ الشيء الذي لم يكن موضة",
    "Instead of stubbornly attempting to use surrealism for purposes of subversion, it is necessary to try to make of surrealism something as solid, complete and classic as the works of museums.",
    ...
    "An unpredictable, faithful and objective hazard seems to have systematically singled out my life to make what are normally uneventful incidents violent, phenomenal and memorable.",
    ...
    "Şi pentru că nu reuşesc să împărtăşesc niciuna dintre uimirile lor \"cabotine\", le spun că nu mă miră absolut nimic din ce se întâmplă în univers şi chiar aşa şi este. Unul dintre barcelonezi - un ceasornicar foarte cunoscut, ajuns la capătul răbdării îmi zice:- Nu vă miră nimic! Bine. Să ne imaginăm că e miezul nopţii şi că la orizont se vede o geană de lumină, ca şi cum ar fi zorile. Priviţi atent şi chiar vedeţi răsărind soarele. La miezul nopţii! Nici asta nu v-ar mira?- Nu, răspund, câtuşi de puţin.Ceasornicarul barcelonez strigă:- Ei bine, pe mine m-ar mira! Şi încă aşa de tare, încât aş crede c-am înnebunit. Atunci Salvador Dali a lăsat să cadă unul din acele răspunsuri lapidare al căror secret el singur îl deţine:- Da' de unde?! Eu aş crede că soarele a-nnebunit.",
    ...
    "Oslové by chtěli, abych dodržoval rady, které vyhlašuji pro ostatní. To je nemožné, já jsem totiž zcela odlišný.",
    ...
    "//What is surrealism?//A spontaneous method of irrational knowledge based on the critical and systematic objectivity of the associations and interpretations of delirious phenomena.",
