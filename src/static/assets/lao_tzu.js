export const LAO_TZU = [
    ...
    "The best of all teachers is the one who helps people so that eventually they don't need him.",
    ...
    "The journey of a thousand miles \nstarts from beneath your feet.\n\nNOTE: Other translations exist, such as:Great trees grow from the smallest shoots;a terraced garden, from a pile of earth,and a journey of a thousand milesbegins by taking the initial step.",
    "Sages do not accumulate for themselves. The more they give to others, the more they possess of their own. The way of Heaven is to benefit others and not to injure.",
    ...
    "To understand the limitation of things, desire them.",
    "Give evil nothing to opposeand it will disappear by itself.",
    "Men are born soft and supple; dead they are stiff and hard. Plants are born tender and pliant; dead, they are brittle and dry. Thus whoever is stiff and inflexible is a disciple of death. Whoever is soft and yielding is a disciple of life. The hard and stiff will be broken. The soft and supple will prevail.",
    "By letting go it all gets done.",
    ...
    "Fill your bowl to the brimand it will spill.Keep sharpening your knifeand it will blunt.Chase after money and securityand your heart will never unclench.Care about people's approvaland you will be their prisoner. Do your work, then step back.The only path to serenity.",
    ...
    "Do not conquer the world with force, for force only causes resistance. Thorns spring up when an army passes. Years of misery follow a great victory. Do only what needs to be done without using violence.",
    "in the pursuit of knowledge: everyday something is added.in the pursuit of enlightenment:everyday something is dropped.",
    ...
    "I thought I know you,but it was only me.The you that you truly areis not the you I see.My mind has formed your imagebut you have already travelled onI want to see only youbut I see you through me",
    "The inner is foundation of the outerThe still is master of the restlessThe Sage travels all dayyet never leaves his inner treasure",
    "Every step is on the path.",
    ...
    "As to the roaming of sages,They move in utter emptiness,Let their minds meander in the great nothingness;They run beyond conventionAnd go through where there is no gateway.They listen to the soundlessAnd look at the formless,They are not constrained by societyAnd not bound to its customs.- Lao-tzu",
    ...
    "NOT LAO TZU!!!! Watch your thoughts; they become words. Watch your words; they become actions. Watch your actions; they become habit. Watch your habits; they become character. Watch your character; it becomes your destiny.",
    ...
    "The Sage sees the worldas an expansion of his own selfSo what need has he to accumulate things?",
    ...
    "Respond intelligently even to unintelligent treatment.“The words of truth are always paradoxical.”",
    ...
    "He who feels puncturedMust once have been a bubble,He who feels unarmedMust have carried arms,He who feels belittledMust have been consequential,He who feels deprivedMust have had privilege.",
    ...
    "The gentlest thing in the worldovercomes the hardest thing in the world.That which has no substanceenters where there is no space.This shows the value of non-action.Teaching without words,performing without actions:that is the Master's way.",
    ...
    "To Know others is perceptive,to know yourself is wise.To conquer others is forceful,to conquer yourself is strong.",
    ...
    "If you don’t stand sincere by your wordshow sincere can the people be?Take great care over words, treasure them.",
    "The skilful traveller leaves no traces of his wheels or footsteps;",
    ...
    "When the intelligent and animal souls are held together in one embrace, they can be kept from separating.",
    "The master leadsby emptying people's mindsand filling their cores,by weakening their ambitionand toughening their resolve.",
    ...
    "Lao Tzu \"The key to growth is the introductionof higher dimensions of consciousnessinto our awareness.",
    "Chase after money and securityAnd your heart will never unclench.Care about people's approvalAnd you will be their prisoner.Do your work, then step back.The only path to serenity.",
    ...
    "السيطرة على التنفس تجلب التوتروعندما تبالغ في بذل المجهود يكون الارهاقاغلق فمكواضبط حواسكتحكم في حدتكبسط مشاكلككن واحدا مع تراب الأرضهذه هي الوحدة الأولى*من يحقق هذه الحالة لا يهمه الأصدقاء ولا الأعداء ولا يهتم بالطيب ولا بالخبيثولا بالمجد أو المهانةتلك أعلى حالات الانسان",
    ...
    "A sage traveling all dayis never far from the supplies in his cart,and however spectacular the viewshe remains calm and composed.",
    ...
    "The tree too thick to embraceemerges from a seedling.A nine-storey tower rises from a brick.A thousand-mile journey begins under your feet.",
    "When there is no desire, all things are at peace.",
    ...
    "من يقف على أطراف أصابعه لا يمكن أن يكون ثابتا من يوسع خطوته لا يستطيع تنظيمها الذي يتفاخر لا يحقق شيئاًوالذي يتباهى لا يظل طويلاً",
    ...
    "Why is the sea king of a hundred streams?Because it lies below them.This is why the sea is king of a hundred streams.",
    "Thirty spokes converge at the hub,but emptiness completes the wheel.Clay is shaped to make a pot,and what’s useful is its emptiness.Carve fine doors and windows,but the room is useful in its emptiness.What isis beneficial, while what is notalso proves useful.",
    ...
    "Emptiness appears barrenyet is infinite fullness",
    ...
    "Moved by deep love, a man is courageous.And with frugality, a man becomes generous,And he who does not desire to be ahead of theworld becomes the leader of the world.",
    ...
    "تخلى تتفوق انحن تستقم أفرغ نفسك تمتليء استهلك نفسك تجددها ارض بالقليل تصبح غنياًامتلك الكثير تصيبك الفوضى والارتباك",
    "العقلاء لا يستعرضون قدراتهم لذلك تشع منهم القوة انهم لا يتفاخرون لذلك يحيط بهم التقدير هم لا يتشاجرون لذلك لا يتشاجر معهم أحد",
    ...
    "There was something undifferentiated and yet complete which existed before heaven and earthsoundless and formless, it depends on nothing and does not change. It operates everywhere and is free from danger. It may be considered the mother of the universe.",
    ...
    "Work at things before they’ve begunand establish order before confusion sets in,for a tree you can barely reach aroundgrows from the tiniest rootlet,a nine-tiered towerstarts as a basket of dirt,a thousand-mile journeybegins with a single step.",
    "Fill your bowl to the brim and it will spill, Keep sharpening your knife and it will be bluntCare about people's approval and you will be their prisoner.",
    ...
    "Colour's five hues from th' eyes their sight will take;Music's five notes the ears as deaf can make;The flavours five deprive the mouth of taste;The chariot course, and the wild hunting wasteMake mad the mind; and objects rare and strange,Sought for, men's conduct will to evil change.",
    ...
    "Nothing under heavenis as yielding as water.And yet in attacking the hard,the unyielding,nothing can surpass it.Nothing can take its place.The weak overcomes the strong,the soft surpasses the hard.In all the world, there’s no onewho doesn’t know this,but no one can master the practice.",
    ...
    "To know non-knowing is optimalto imagine one knowsis affliction of mind",
    ...
    "He assists in developing people but he does not presume ownership over them.",
    ...
    "Quand l’esprit humain, absolument arrêté, est complètement vide et calme, il est un miroir pur et net, capable de mirer l’essence ineffable et innommable du Principe lui-même.",
    "Rendre le bien pour bien et bien pour le mal, c'est la bonté efficace.Être sincère avec ceux qui sont sincères et avec ceux qui ne le sont pas, c'est la sincérité efficace.",
    ...
    "ruin. To do good, work well, and lie low is the way of the blessing.",
    ...
    "Wild winds never last all morningand fierce rains never last all day.",
    ...
    "For things sometimes lead and sometimes follow,sometimes sign and sometimes storm,sometimes strengthen and sometimes weaken, sometimes kill and sometimes die.",
    ...
    "When beauty is defined, illusions of non-beauty manifestWhen goodness is identified, badness becomes an option",
    ...
    "The world’s most difficult affairsbegin in easiness.The world’s greatest affairsalways begin in the small.",
    ...
    "The mark of a moderate manis freedom from his own ideas.Tolerant like the sky,all-pervading like sunlight,firm like a mountain,supple like a tree in the wind,he has no destination in viewand makes use of anythinglife happens to bring his way.",
    ...
    "Who thinks his great achievements poorShall find his vigour long endure.Of greatest fulness, deemed a void,Exhaustion ne'er shall stem the tide.Do thou what's straight still crooked deem;Thy greatest art still stupid seem,And eloquence a stammering scream.",
    ...
    "When the people have many weapons, the nation grows more benighted.",
    ...
    "The masters were said to be profound because they show the greatest wisdom when comfortable in Life’s mysterious and unknown depths",
    "Be square but do not cut; be sharp but do not stab; be straight forward but do not unrestrained; be bright but do not dazzle.",
    ...
    "The wise person acts but does not take credit. Leads, but does not rule.",
    ...
    "Cut doors and windowsto make a room.Where the room isn't, there's room for you.So the profit in what isis in the use of what isn't.",
    "Giving birth without possessing, animating without subjecting,fostering without dominating.",
    "Practice not-doing and everything will fall into place.",
    "When people devote themselves to somethingthey always ruin it on the verge of success.Finish with the same care you took in beginningand you’ll avoid ruining things.",
    ...
    "This world has no need for weapons,Which soon turn on themselves.Where armies camp, nettles grow;After each war, years of famine.The most fruitful outcomeDoes not depend on force,But succeeds without arroganceWithout hostilityWithout prideWithout resistanceWithout violence.",
    ...
    "And whether a man dispassionatelySees to the core of lifeOr passionatelySees the surfaceThey are essentially the same",
    ...
    "When the people are too foolish to recognize danger,  disaster will surely come.",
    ...
    "A man is born into certain relationships and as a result has certain duties. For instance, he has a duty of loyalty to his lord, a filial duty to his parents, a duty to help his friends, and a duty of common humanity towards his fellow beings.",
    "The wise person treats the good person with goodness, he also treats the bad person with goodness – this is how you become good. The wise person gives the truthful person his trust, he also gives the untruthful his trust – this is how you become trustworthy.",
    ...
    "Manifest plainness and embrace the genuine; lessen self-interest and make few your desires.",
    ...
    "The grace of Taoand divine nature (Te)are not orderedbut eternal spontaneousaction of the One",
    "Darum: Wer LEBEN hat,hält sich an seine Pflicht,wer kein LEBEN hat,hält sich an sein Recht",
    "Tao ‘is’ before wordsand before deeds",
    "Когда все в Поднебесной узнают, что прекрасное является прекрасным,появляется и безобразное. Когда все узнают, что доброе является добром, возникает и зло. Поэтому бытие и небытие порождают друг друга, трудное и легкое создают друг друга, длинное и короткое взаимно соотносятся, высокое и низкое взаимно определяются, звуки, сливаясь, приходят в гармонию,предыдущее и последующее следуют друг за другом. Поэтому совершенномудрый, совершая дела, предпочитает недеяние; осуществляяучение, не прибегает к словам; вызывая изменения вещей, [он] не осуществляет их сам; создавая, не обладает [тем, что создано]; приводя в движение, не прилагает к этому усилий; успешно завершая [что-либо], негордится. Поскольку он не гордится, его заслуги не могут быть отброшены.",
    ...
    "People are mysterious entities – try to take hold of them and you will only lose them.",
    "He who knows much about others may be learned, but he who understands himself is more intelligent. He who controls others may be powerful, but he who has mastered himself is mightier still.",
    ...
    "Where there is lack of faith, There is a lack of respect. Employ reticence, and care with words. When the work is done and the task complete The people will say: ‘It just happened.",
    ...
    "Upon disaster depends good fortune;within good fortune hides disaster.Where will it end?For nothing is certain;what is correct goes astray;what is right goes wrong.Our confusion goes on and on.",
    "Therefore the wise are sharp but not cutting,Pointed but not piercing,Straightforward but not unrestrained,Brilliant but not blinding.",
    "He who knows he has enough, is rich",
    "When the world's on the Way,they use horses to haul manure.When the world gets off the Way,they breed warhorses on the common.The greatest evil: wanting more.The worst luck: discontent.Greed's the curse of life.To know enough's enoughis enough to know.",
    "The one who detaches and sees from afar sees clearly.",
    "One gains by losing and loses by gaining.",
    "Mold clay into a bowl. The empty space makes it useful.",
    "Разглеждайте трудността, докато е още лека. Запознайте се с голямото, докато е още малко. Най-трудните подвизи на света отначало са лесни; най-големите дела отначало са малки.",
    ...
    "Knowledge of the eternal is all-embracing.To be all-embracing leads to righteousness,Which is majestic.To be majestic leads to the Heavenly.To be Heavenly leads to the Way.",
    ...
    "Bir insanın ne kadar tabusu varsa o kadar mutsuzdur",
    ...
    "You render the small vast and few many,use integrity to repay hatred,see the complexity in simplicity,find the vast in the minute.",
    ...
    "To be in favor or disgraceis to live in fear.To take the body seriouslyis to admit one can suffer.",
    ...
    "Of fame or life, Which do you hold more dear?Or life or wealth, To which would you adhere?Keep life and lose those other things; Keep them and lose your life:-- which brings Sorrow and pain more near?",
    ...
    "Hyvällä matkailijalla ei ole pysyviä suunnitelmia eikä hän yritä päästä perille.",
    ...
    "People who are goodI treat well.People who are not goodI also treat well. - Chapter 49",
    "El gran gobernante pasa inadvertido por el pueblo. A éste sucede el que es amado y elogiado por el pueblo. Después, el que es temido. Y finalmente, el despreciado.",
    "Pon en desuso la sagacidad y la búsqueda del beneficio y el robo y la estafa dejarán de tener lugar entre los tuyos.",
    "To know and to think we know not, is the crown. Not to know and to think we know, is the affliction.",
    "Si un hombre quiere darle forma al mundo, modelarlo a su capricho, difícilmente lo conseguirá. El mundo es un jarro sagrado que no se puede manipular ni retocar. Quien trata de hacerlo, lo deforma. Quien lo aferra, lo pierde. Por eso el sabio no intenta modelarlo, luego no lo deforma. No lo aferra, luego no lo pierde. Hay quienes marchan adelante, hay quienes marchan atrás. Hay quienes permanecen callados, hay quienes hablan. Algunos son fuertes, otros débiles. Algunos medran, otros perecen. Luego el sabio rechaza el exceso, la extravagancia y la propia complacencia.",
    "If you are depressed, you are living in the past. If you are anxious, you are living in the future. If you are at peace, you are living in the present",
    "Wanting to reform the world without discovering one’s true self is like trying to cover the world with leather to avoid the pain of walking on stones and thorns. It is much simpler to wear shoes.",
    "是 以 聖 人 處 無 為 之 事 ， 行 不 言 之 教 ﹔ 萬 物 作 而 弗 始 ， 生 而 弗 有 ， 為 而 弗 恃 ， 功 成 而 不 居",
    "If you look to others for fulfillment, you will never truly be fulfilled.",
    "حيثما تعسكر القوات ينبت شجر الشوكوفي أعقاب الجيوش الجرارة يذوي الحصاداذا كان لابد من الحرب فعجل في إنهائهاعجل في إنهائها ولاتتفاخرعجل في إنهائها ولاتتبجحعجل في إنهائها ولاتتغطرسعجل في إنهائها ولاتروّع الناس",
    "Or fame or life,Which do you hold more dear?Or life or wealth,To which would you adhere?Keep life and lose those other things;Keep them and lose your life:-- which bringsSorrow and pain more near?",
    ...
    "Who thinks his great achievements poorShall find his vigour long endure.",
    "He who knows (the Tao) does not (care to) speak (about it); he who is (ever ready to) speak about it does not know it.",
    "She who is centered in the Taocan go where she wishes, without danger.She perceives the universal harmony,even amid great pain,because she has found peace in her heart.",
    ...
    "If you are compassionate,  you can be truly courageous;  if you are economical, you can be truly generous;  if you are humble, you can be truly helpful. If you are brave but lack compassion,  are generous but lack economy, and try to help others but lack humility,  you’ve lost the way.",
    ...
    "The man who is content with what he has  is not in danger of loss. The man who knows when to stop is free to go on.",
    "Quien valora lo que tiene y se conforma, es un hombre rico.",
    "There is no greater illusion than fear, no greater wrong than preparing to defend yourself, no greater misfortune than having an enemy. Whoever can see through all fear will always be safe. --loc 710Tao Te Ching: A New English VersionPaperback – Sep 5 2006 | Unabridgedby Lao Tzu and Stephen MitchellISBN-10: 0061142662",
    "Don’t glorify heroes, And people will not contend. Don’t treasure rare objects, And no one will steal. Don’t display what people desire, And their hearts will not be disturbed.",
    ...
    "As coisas recebem sua forma de acordo com sua natureza e se completam conforme as circunstâncias de sua condição.",
    ...
    "Those who possess moderation will endure;   they have deep roots and strong stems. This is the secret to a long life,  and lasting insight into the Tao.",
    ...
    "The effects of simplicity are profound indeed,  deep and far reaching.",
    ...
    "The way that is bright seems dull. The way forward seems to lead back. The smooth way seems rough. The highest virtue seems a valley. The purest whiteness seems stained. Excessive virtue seems defective. Solid virtue seems inactive.",
    "Solo cuando nos cansamos de nuestra enfermedad, dejamos de estar enfermos.",
    ...
    "He is free from self-display, and therefore he shines; from self-assertion, and thereforehe is distinguished; from self-boasting, and therefore his merit is acknowledged; from self-complacency, and therefore he acquiressuperiority.",
    "The Tao that can be told is not the eternal Tao. The name that can be named is not the eternal name.",
    ...
    "Connected to everything but attached to nothing. Attachment is rooted in fear. You lose your fear of loss when you realize you're already whole.",
    ...
    "The wise wear plain clothes and keeps their gems out of sight.",
    ...
    "A tree too big to embraceIs born from a slender shoot.A nine-storey towerRises from a pile of earth.A thousand-mile journeyBegins with a single step.",
    "The wise recognize the limits of their knowledge;  the foolish think they know everything.",
    "Gentle flexibilityis the way of the humble master",
    ...
    "Tell me and I'll listen, Show me and I'll watchLet me experience and I'll learn",
    "The Tao is divine. The Tao is the Eternal.  Death is not to be feared.",
    ...
    "Those who steal from others impoverish themselves;  those who give to others become rich. Those who fight do not win;  those who win do not fight. This is the way of the Tao.",
    ...
    "I have three treasures which I hold and keep.The first is mercy; the second is economy;The third is daring not to be ahead of others.Nowadays men shun mercy, but try to be brave;They abandon economy, but try to be generous;They do not believe in humility, but always try to be first. This is certain death.",
    ...
    "The Master, by residing in the Tao,sets an example for all beings.Because he doesn't display himself,people can see his light.Because he has nothing to prove,people can trust his words.",
    "Those who know don't tell.Those who tell don't know.from 56",
    "There is no need to run outside for better seeing…Rather abide at the center of your being; for the more you leave it the less you learn. Search your heart and see…The way to do is to be.",
    "The best fighter is never angry",
    "Do you have the patience to wait till your mud settles and the water is clear?",
    "We gain by losing, Lose by gaining.",
    "Chase after money and securityand your heart will never unclench.Care about people's approvaland you will be their prisoner.",
    "Good music, the Chinese held, insures peace and uprightness; bad music leads to lewdness and social decline.",
    "No se puede conocer el Tao solo nombrándolo, porque el origen del universo es solo uno de sus nombres. Todo lo que existe y puede existir es su creación, porque el universo es solo un mapa de lo que existe y puede existir. La vida superficial sirve para sentir al universo, la vida interior, para entenderlo. Las dos vidas existen dentro del Tao y ninguna de ellas por separado puede contenerlo. El Tao es infinitamente más grande y más sutil que el universo.",
    "Teniendo poco, estarás satisfecho; con mucho, estarás confundido.",
    "The worldHe who changes it will destroy it.He who seizes it will lose it.",
    ...
    "Plan for the difficult while it is still easy. The greatest things in the world are done while still slight. So wise leaders never do big things; that’s how they achieve greatness.",
    "Los cinco colores hacen que los ojos se cieguen; correr con caballos y la caza hacen que la mente se vuelva salvaje. Los bienes que son difíciles de obtener, son un obstáculo para la conducta apropiada. Los cinco sabores hacen que se confunda el paladar; los cinco tonos hacen que los oídos se ensordezcan. Por tanto, el gobierno del sabio se preocupa por lo interior y no por la vista. Por eso, evitando uno, toma lo otro.",
    "Extreme love exacts a great price. Many possessions entail heavy loss. Know what is enough— Abuse nothing. Know when to stop— Harm nothing. This is how to last a long time.",
    "Sometimes gain comes from losing,And sometimes loss comes from gaining",
    ...
    "If you overesteem great men,people become powerless.If you overvalue possessions,people begin to steal.The Master leadsby emptying people’s mindsand filling their cores,by weakening their ambitionand toughening their resolve.He helps people lose everythingthey know, everything they desire,and creates confusionin those who think that they know.",
    "There is no greater calamity Than not knowing what is enough. There is no greater fault Than desire for success.",
    "Acepta poco y serás más, inclínate y serás recto, vacíate y quedarás lleno, desciende y ascenderás, desea lo necesario y conseguirás lo imprescindible.",
    "Conocer y no saberlo, ésta es la perfección. No conocer y creer saberlo, éste es el mal.",
    "Seal the openings, shut the doors,And until your last day you will not be exhausted.Widen the openings, interfere,And until your last day you will not be safe.",
    ...
    "Those who understand others are intelligent Those who understand themselves are enlightened1 Those who overcome others have strength Those who overcome themselves are powerful",
    "Conocer el propio mal es liberarse del mal. El sabio no tiene mal; porque lo reconoce, no lo padece.",
    "Things exalted then decay.This is going against the Way.What goes against the Way meets an early end.",
    ...
    "Without going out the door, Know the world. Without peeping through the window, See heaven’s DAO. The further you travel, The less you know. This is why the Sage Knows without budging, Identifies without looking, Does without trying.",
    ...
    "understanding the Tao helps remove us from a frame of mind that demands strict dualistic, either-or categories",
    "Ser Valiente pero Prudente: Normativa necesaria para alcanzar la Armonía con el Cosmos",
    "El valor del osado le conduce a la muerte. El valor del prudente le conserva la vida. Uno es el perjudicado y el otro el beneficiado.",
    "Knowing others is Wisdom, Knowing yourself is Enlightenment.",
    ...
    "Lo duro y lo rígido son propiedades de la muerte. Lo blando y flexible son propiedades de la vida.",
    "If you want to accord with the Tao, just do your job, then let go.",
    "El Tao del cielo es quitar al que le sobra y dar al que le falta.",
    "¿Qué hombre que tiene de sobra le daría sus riquezas al mundo? Sólo el hombre que posee al Tao.",
    ...
    "Por eso, el sabio hace su trabajo sin acumular nada por él, realiza su obra sin apropiarse de ella, y no se vanagloria de su sabiduría.",
    "I take no action and people are reformed. I enjoy peace and people become honest. I do nothing and people become rich. I have no desires and people return to the goodand simple life",
    ...
    "為無為",
    "What is meant by saying that honour and great calamity are to be (similarly) regarded as personal conditions? What makes me liable to great calamity is my having the body (which I call myself); if I had not the body, what great calamity could come to me?吾有大患，及吾有身；及吾无身，吾有何患",
    "Quién practica el no-obrar todo lo gobierna.",
    "Misery!—happiness is to be found by its side! Happiness!—misery lurks beneath it! Who knows what either willcome to in the end?祸兮福所倚，福兮祸所伏",
    "The greatest of rulers is but a shadowy presence;",
    "While protecting the people, they do not control them. They are motherly and fatherly, but not domineering. They persuade with words, not weapons.",
    "Knowing others is intelligence; knowing yourself is true wisdom. Mastering others is strength; mastering yourself is true power.",
    "Those who are good at military action achieve their goal and then stop.",
    "Conquistar a otros, significa tener poder. Conquistarse a uno mismo, significa tener fortaleza.",
    "Darse cuenta de que nuestro conocimiento es ignorancia,es una noble comprensión interna.Considerar nuestra ignorancia como conocimientoes enfermedad mental.",
    ...
    "la habilidad del sabio de lograr lo grandioso, proviene de no engrandecerse. Así es capaz de lograr lo grandioso.",
    ...
    "The Masteracts without doing anythingand teaches without saying anything.Things arise and she lets them come;things disappear and she lets them go.She has but doesn't possess,acts but doesn't expect.When her work is done, she forgets it.That is why it lasts forever.",
    ...
    "See others as yourself.See families as your family.See towns as your town.See countries as your country.See worlds as your world.How do I know that the world is such?By this.",
    "Quisiera poseer la sabiduría para poder marchar por el Gran Camino sin temor a desviarme. El Gran Camino es llano y recto, pero la gente elige los senderos tortuosos.",
    "Govern large countrieslike you cook little fish.",
    "O Tao imaginou o Um, o Um exalou o Dois, o Dois é pai do Três e o Três, pai de todas as coisas.",
    "¿Cómo puedo entonces conocer el mundo? Porque lo veo por mí mismo.",
    "A raiz da grandeza é a humildade. O que é elevado se fundamenta no que é baixo.",
    "aquele que teve de comandar a matança de milhares de homens deve chorar por eles com maior dor.",
    ...
    "Onde quer que se encontrem grandiosos exércitos, a colheita será pobre.",
    "Know others by knowing yourself.",
    "It gives them life yet claims no possession; It benefits them yet exacts no gratitude; It is the steward yet exercises no authority. Such is called the mysterious virtue.",
    "Aquele que viu o brilho da glória, e não esqueceu dos desgraçados, se torna como um grande vale por onde fluem todas as águas do mundo.",
    "Habla solo lo necesario, Controla tus emociones, Simplifica los problemas, Deshazte de la confusión, Atenúa tu resplandor,",
    "Na Era do Ouro, as pessoas não estavam conscientes de seus governantes. Na Era de Prata, elas os amavam e cantavam. Na Era de Bronze, elas os temiam. E por fim, na Era do Ferro, elas os desprezavam.",
    ...
    "Stillness is the ruler of haste.",
    "To know that you do not know is the best.To pretend to know when you do not know is a disease.",
    "Shut the doors,* And all your life you will not run dry. Unblock the openings, Add to your troubles,",
    ...
    "They put others first,  and so become great. They are not focused on outcomes or achievements;  therefore they always succeed.",
    "Knowing others is wisdom, knowing yourself is Enlightenment.",
    ...
    "A man of the highest virtue does not keep to virtue and that is why he hasvirtue. A man of the lowest virtue never strays from virtue and that is why heis without virtue. The former never acts yet leaves nothing undone. The latteracts but there are things left undone. A man of the highest benevolence acts,but from no ulterior motive. A man of the highest rectitude acts, but fromulterior motive. A man most conversant in the rites acts, but when no oneresponds rolls up his sleeves and resorts to persuation by force.",
    ...
    "Good things seem to change into bad, and bad things often turn out for good. These things have always been hard to comprehend.",
    ...
    "The effectiveness of action is in the right timing.",
    ...
    "Conquering others takes force. Conquering yourself is true strength. Knowing what is enough is wealth.",
    ...
    "The Tao is called Great Mother: empty yet inexhaustible, it gives birth to infinite worlds. It is always present within you. You can use it any way you want.",
    ...
    "Bring things to life and nurture them, But have no thoughts of possession.Act without relying on anything;Bring things along, but do not take charge.This is the dark and mysterious virtue.",
    ...
    "El cielo es eterno y la tierra permanece.El cielo y la tierra deben su eterna duracióna que no hacen de sí mismosla razón de su existencia.",
    ...
    "See simplicity in the complicated. Achieve greatness in little things.",
    "The uses of notThirty spokes meet in the hub.Where the wheel isn't is where it's useful.Hollowed out,clay makes a pot.Where the pot's not is where it's useful.Cut doors and windows to make a room.Where the room isn't,there's room for you.So the profit in what is is in the use of what isn't.",
    "goodness, if it is not sincere, is not really goodness.",
    ...
    "En lo alto no es luminoso,en lo bajo no es oscuro.Es eterno y no puede ser nombrado,retorna al no-ser de las cosas.Es la forma sin formay la imagen sin imagen.Es lo confuso e inasible.De frente no ves su rostro,por detrás no ves su espalda.",
    "La “clarividencia, es el adorno del Tao, y el inicio de la estupidez.”",
    ...
    "When rulers resort to force, things flourish for a time, but then decay.",
    ...
    "they do not exist for themselves. That is why they endure.",
    ...
    "A leader is best when people barely know that he [or she] exists,Of a good leader who talks little,When the work is done,The aim is fulfilledThey will say, “We did this ourselves.",
    ...
    "Quien conoce la eternidadda cabida a todos.Quien da cabida a todos es grandioso.Quien es grandioso es celestial.Quien es celestial es como Tao.Quien es como el Tao es perdurable.Aunque su vida se extinga, no perece.",
    ...
    "El Tao es algo confuso e intangible.Es confuso e intangible, pero tiene formas.Es confuso pero brillante porque abarca muchas cosas.Es profundo y oscuro pero contiene una esencia.Esta esencia es verdadera.",
    ...
    "Creating, yet not possessingWorking, yet not taking creditWork is done, then forgottenTherefore it lasts forever",
    ...
    "to live in the mountains and forests or cut yourself off from human affairs to enter the Way. Success and fame, wealth and honor",
    "As much as they embrace the world, the world will embrace them.",
    "They who act with violence become violent. They who act with virtue become virtuous.",
    ...
    "What is is beneficial, while what is not also proves useful.",
    ...
    "Without going abroad, you can have knowledge of the world. Without gazing at the stars, you can perceive the heavenly Tao. The more you wander, the less you know. The wise explore without traveling, discern without seeing, finish without striving, and arrive at their destination without leaving home.",
    "We hammer wood for a house, but it is the inner space that makes it liveable. We work with being, but non-being is what we use.",
    ...
    "Those who know both their masculine  and their feminine sides  become fruitful like the valleys of earth.",
    "The Way of Self-Reliance starts with recognizing who we are, what we’ve got to work with, and what works best for us.",
    "Sometimes gain comes from losing,and sometimes loss comes from gaining.",
    "Property was thus appall’dThat the self was not the same;Single nature’s double nameNeither two nor one was call’d.Reason in itself confounded,Saw division grow together;To themselves yet either neitherSimple were so well compounded.",
    ...
    "poets, untraveled and inexperienced, Emily Brontë and Emily Dickinson, prove Lao Tzu’s point: it’s the inner eye that really sees the world.",
    ...
    "He who is attached to things will suffermuch.He who saves will suffer heavy loss.A contented man is neverdisappointed.He who knows when to stop does notfind himself in trouble.He will stay forever safe.",
    ...
    "İyilik bilmez gökyüzüEn büyük iyiliği de budur işte.",
    ...
    "What should be abolished must first be cherished.What should be deprived must first be enriched.",
    ...
    "Hold your ground and you will last long. Die without perishing and your life will endure.",
    "A MODEL FOR OTHERS A tree that is well-planted is not easily uprooted.  A treasure that is well-guarded  is not easily taken away.",
    ...
    "Saber que no se sabe es lo mejor.",
    ...
    "It may be called immense. By not making itself great, It can do great things.",
    "The wise, while valuing themselves,  do not overestimate themselves. They reject flattery and gain true merit.",
    ...
    "Hay quienes quieren dominar el mundo y tratan de hacerlo; presagio que simplemente no tendrán éxito. El mundo es una vasija sagrada, no es algo que se pueda dominar. Aquellos que lo dominan, lo destruyen; los que se aferran a él, lo pierden.",
    ...
    "El sabio no acumula nada; pero cuanto más actúa para otros, más ha ganado para sí mismo; y cuanto más le da a otros, más se ha dado a sí mismo.",
    ...
    "To live till you dieIs to live long enough",
    "My own definition of leadership is this: The capacity and the will to rally men and women to a common purpose and the character which inspires confidence. —General Montgomery",
    "The progress of the Way seems retreating.",
    "There is no crime greater than having too many desires;1 There is no disaster greater than not being content; There is no misfortune greater than being covetous. 105aHence in being content,2 one will always have enough.",
    "Los cielos perduran; la tierra tiene una larga duración. La razón por la cual perduran y tienen larga duración, es que no se generan a sí mismos, por eso viven largo tiempo. Por tanto, el sabio se aparta, y así está al frente. Remueve la preocupación de sí mismo, y así permanece.",
