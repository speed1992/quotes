export const PASCAL = [
    ...
    "When I consider the small span of my life absorbed in the eternity of all time, orthe small part of space which I can touch or see engulfed by the infinite immensityof spaces that I know not and that know me not, I am frightened and astonished tosee myself here instead of there...now instead of then.",
    ...
    "S'il se vante, je l'abaisse,S'il s'abaisse, je le vante;Et le contredis toujours,Jusqu'à ce qu'il comprenneQu'il est un monstre incompréhensible.",
    ...
    "Inima îşi are propriile raţiuni pe care raţiunea nu le cunoaşte|",
    "We sail within a vast sphere, ever drifting in uncertainty, driven from end to end.",
    ...
    "Истинското красноречие се смее над превзетостта, истинската нравественост се смее над нравоучението.",
    ...
    "Това писмо ми излезе малко дълго, защото не ми стигна времето да го направя по-късо.",
    ...
    "A good portrait can only be made by reconciling all our contradictory features, and it is not enough to follow through a series of mutually compatible qualities without reconciling their opposites; to understand an author’s meaning all contradictory passages must be reconciled.",
    ...
    "Κακώς έχουμε αφαιρέσει τον χαρακτηρισμό του λογικού από τον έρωτα, αντιπαραβάλλοντας τα χωρίς πραγματική βάση, διότι έρωτας και λογική είναι ένα και το αυτό. Αποτελεί ο έρωτας μια στιβάδα σκέψεων που κατατείνει προς μια πλευρά χωρίς να καλοεξετάζει τα πάντα - συνιστά όμως πάντοτε μια λογική, δεν πρέπει δε και δεν μπορούμε να ευχόμαστε να ήταν διαφορετικά, γιατί τότε θα ήμασταν πολύ δυσάρεστες μηχανές. Ας μην αποκλείουμε λοιπόν τη λογική απ' τον έρωτα, γιατί αποτελεί αναπόσπαστο μέρος του.",
    ...
    "Bu sonsuz mekânların ebedi suskunluğu beni ürkütüyor.",
    "Kind words do not cost much, yet they accomplish much.",
    ...
    "أرى رحائب الكون المخيفة التي تحتضنني، وأراني لاصقًا بزاوية من هذا الامتداد الفسيح فما أعرف سببًا لوجودي في هذا المكان دون ذاك، ولا سببًا لأن يكون هذا الأجل القصير من الحياة قد خصص لي في هذه النقطة لا في النقطة الأخرى من الأزل السابق ومن الأبد اللاحق. لا أرى من كل جانب إلا لانهايات تشتمل علي كذرة وكظل يستمر لحظة ولا يفيء. كل ما أدري أني لا محالة مائت. ولكن أكثر ما أجهله هو ذلك الموت عينه الذي لا استطيع تلافيه.",
    "No one dies so poor that he does not leave something behind.",
    "Δεν αρέσει στον άνθρωπο να μένει με τον εαυτό του κι εκτός τούτου, αγαπά: πρέπει λοιπόν να γυρέψει αλλού τι ν' αγαπήσει. Κι αυτό μπορεί να το βρει μόνο στην ομορφιά' όντας όμως ο ίδιος το ωραιότερο δημιούργημα του Θεού, πρέπει να βρει εντός του το πρότυπο της ομορφιάς που αναζητεί εκτός. Καθένας δύναται να διακρίνει μέσα του τις πρώτες ακτίνες της και αντιλαμβανόμενοι κατά πόσον ό,τι συναντούμε στον εξωτερικό κόσμο προσεγγίζει ή απέχει απ΄το πρότυπο αυτό, διαμορφώνουμε την ιδέα του ωραίου και του άσχημου για όλα τα πράγματα. Ωστόσο, μολονότι ο άνθρωπος ψάχνει με τι να πληρώσει το μέγα κενό που επέφερε βγαίνοντας απ' τον εαυτό του, παρά ταύτα δεν μπορεί να ικανοποιηθεί με οποιοδήποτε αντικείμενο. Η καρδιά του είναι απέραντη' πρέπει τουλάχιστον να είναι κάποιο πρόσωπο που της μοιάζει, που να είναι όσο πιο κοντά της. Γι' αυτό και η ομορφιά που μπορεί να ικανοποιήσει τον άνθρωπο βρίσκεται όχι μόνο στην αναλογία, αλλά και στην ομοιότητα: αυτή την περιορίζει και την εγκλείει στη διαφορά του φύλου.",
    ...
    "L’objet de ce discours est de montrer quel est le véritable sens des SS. pères et du Concile de Trente dans ces aproles : « Les commandemens ne sont pas impossibles aux justes : » cette proposition est susceptible de deux sens. Le premier, qu’il n’est pas impossible que les justes accomplissent les commandemens ; le second, que les commandemens sont toujours possibles à tous les justes, de ce plein et dernier pouvoir auquel il ne manque rien de la part de Dieu, pour agir.",
    ...
    "The last function of reason is to recognize that there is an infinity of things which are beyond it. It is but feeble if it does not see so far as to know this.",
    "Το πρώτο αποτέλεσμα του έρωτα είναι να εμπνέει μεγάλο σεβασμό: αισθανόμαστε ευλάβεια γι' αυτόν που αγαπάμε. Είναι πολύ σωστό: δεν αναγνωρίζουμε στον κόσμον όλο τίποτε πιο μεγάλο απ' αυτό.",
    "What astonishes us most is to observe that everyone is not astonished at his own weakness.",
    "Если ваша религия ложна, вы ничем не рискуете, считая её истинной; если она истинна, вы рискуете всем, считая её ложной.",
    "Words differently arranged have a different meaning, and meanings differently arranged have different effects.",
    ...
    "For after all what is man in nature? A nothing in relation to infinity, all inrelation to nothing, a central point between nothing and all and infinitely far fromunderstanding either. The ends of things and their beginnings are impregnablyconcealed from him in an impenetrable secret. He is equally incapable of seeingthe nothingness out of which he was drawn and the infinite in which he is engulfed.",
    "So imprudent are we that we wander in the times which are nor ours, and do not think of the only one which belongs to us; and so idle are we that we dream of those times which are no more, and thoughtlessly overlook that which alone exists.",
    ...
    "إنك لا تستطيع أن تعرض حدثا واحدا في حياة شخص ما و تزعم أنك قلت كل شئ عنه",
    ...
    "Суть себялюбия и вообще яеловеческого \"я\" в том, что оно любит только себя и печётся только о себе",
    ...
    "It is not from space that I must seek my dignity, but from the government of mythought. I shall have no more if I possess worlds. By space the universeencompasses and swallows me up like an atom; by thought I comprehend the world.",
    ...
    "Thus passes away all man's life. Men seek rest in a struggle against difficulties; and when they have conquered these, rest becomes insufferable. For we think either of the misfortunes we have or of those which threaten us.",
    "Nous ne nous tenons jamais au présent. Nous anticipons l’avenir comme trop lent à venir, comme pour hâter son cours ; ou nous rappelons le passé, pour l’arrêter comme trop prompt. Si imprudents que nous errons dans les temps qui ne sont pas nôtres et ne pensons point au seul qui nous appartient !",
    "O rei está rodeado de pessoas cujo único pensamento é divertir o rei, e evitar que ele pense em si mesmo. Porque ele será infeliz, embora rei, se pensar em si mesmo.",
    ...
    "Järelikult tuleb õiglus ja jõud ühendada; ja selleks teha nii, et selle käes, kes on õiglane, oleks jõud, või see, kelle käes on jõud, oleks õiglane",
    ...
    "Fascinatio nugacitatis -Pentru ca patima să nu ne vatăme, să trăim ca şi cum n-am avea decât opt zile de trăit.",
    "[82] Wisdom leads us back to childhood. Except ye become as little children.1",
    ...
    "The right way is to want what God wants. Christ alone leads to it. Via Veritas.1",
    ...
    "[123] Contradictions. Contempt for our existence, dying for nothing, hatred of our existence.",
    ...
    "Mais Dieu, en imposant, avertit de faire ce qu’on peut, et de demander ce qu’on ne peut pas. »",
    "يود الإنسان أن يكون عظيما و يري أنه صغير, و يود أن يكون سعيدا و يري أنه شقي, و يود أن يكون موضع الحب و التقدير من الناس,و يري أن أخطاءه لا تجلب سوي كراهيتهم و احتقارهم.إن الحرج الذي يقع فيه نتيجة هذا التناقض يولد لديه أسوأ النزعات الإجرامية التي يمكن تخيلها, ذلك أنه يبدأ في كره الحقيقة التي تدينه و تريه عيبه",
    ...
    "İnsanoğlunun tüm mutsuzluğu tek başına sessizce bir odada oturamamaktan kaynaklanır."
]