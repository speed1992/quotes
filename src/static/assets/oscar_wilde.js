export const OSCAR_WILDE = [
    ...
    "Oh! I don't think I would like to catch a sensible man. I shouldn't know what to talk to him about.",
    "When you really want love you willfind it waiting for you.",
    "Its a beautiful woman's fate to be the subject of conversation where ever she goes",
    ...
    "Oscar Wilde was suing the Marquis of Queensbury in 1895 for libel accusing Wilde of homosexualityCounsel: Have you ever adored a young man madly?Wilde: I have never given adoration to anyone except myself.",
    "I am one of those who are made for exceptions, not for laws.",
    ...
    "And the wild regrets and the bloody seatsNone knew so well as IFor he who lives more lives than oneMore deaths than one, must die.",
    "The one person who has more illusions than the dreamer is the man of action.",
    "Some cause happiness wherever they go; others, whenever they go.",
    "Perhaps in nearly every joy, as certainly in every pleasure, cruelty has its place.",
    "There were sins whose fascination was more in the memory than in the doing of them, strange triumphs that gratified the pride more than the passions, and gave to the intellect a quickened sense of joy, greater than any joy they brought, or could ever bring, to the senses.",
    ...
    "Words!Mere words! How terrible they were! How clear, and vivid, and cruel! One could notescape from them. And yet what a subtle magic there was in them!",
    "In fact, now you mention the subject, I have been very bad in my own small way.I don't think you should be so proud of that, though I am sure it must have been very pleasant.",
    "Poor? What does that matter? When poverty creeps in at the door, love flies in through the window.",
    "For life is terribly deficient in form. Its catastrophes happen in the wrong way and to the wrong people. There is a grotesque horror about its comedies, and its tragedies seem to culminate in farce.",
    ...
    "between the famous and the infamous there is but one step, if as muchas one",
    ...
    "إن الجمهور متسامح إلى حد مدهش، فهو يصفح عن كل شئ إلا العبقرية.",
    ...
    "What you have told me is quite a romance, a romance of art one might call it, and the worst of having a romantic of any kind is that it leaves one so unromantic.",
    ...
    "يا بني لا توجد امرأة عبقرية. النساء جنس زخرفي لا أكثر. ليس لديهن ما يقال لكنهن يقلنه بأسلوب ساحر. إنهن يمثلن انتصار المادة على الروح كما يمثل الرجال انتصار العقل على الأخلاق!",
    "Prism! Where is that baby?",
    ...
    "We lose too soon, and only find delightIn withered husks of some dead memory.",
    ...
    "ثمة شيء في وجهه يجعلك تثق به على الفور، كأن هذا الفتى ظَلَّ في معزل عن آثام العالم.",
    ...
    "Disobedience, in the eyes of anyone who has read history, is man's original virtue. It is through disobedience that progress has been made, through disobedience and through rebellion. Sometimes the poor are praised for being thrifty. But to recommend thrift to the poor is both grotesque and insulting. It is likeadvising a man who is starving to eat less. For a town and countrylaborer to practice thrift would be absolutely immoral. Man shouldnot be ready to show that he can live like a badly fed animal. Heshould decline to live like that, and should either steal or go onthe rates, which is considered by many to be a form of stealing. As for begging, it is safer to beg than to take, but it is finer totake than to beg. No: a poor man who is ungrateful, unthrifty, discontented and rebellious, is probably a real personality, and has much to him. He is at any rate a healthy protest. As for the virtuous poor, one can pitythem, of course, but one cannot possibly admire them. They have made privateterms with the enemy, and sold their birthright for very bad pottage.",
    ...
    "Saat üçü vurdu, dördü vurdu, dört buçuğu vurdu ama o yerinden kımıldamadı. Hayatın örgüsü içindeki parlak renkli lifleri bir araya toplamaya, onlarla bir örüntü dokumaya çalışıyordu; içinde dolaştığı, tutkunun kan rengi labirentinde yolunu bulmaya çalışıyordu.",
    ...
    "آدم‌هایی که دشمن ندارند، ولی تمام دوستانشان از آن‌ها دوستانه بیزارند.",
    ...
    "We shall be notes in that great SymphonyWhose cadence circles through the rhythmic spheres,And all the live World's throbbing heart shall beOnce with our heart",
    "Ah! That must be Aunt Augusta. Only relatives, or creditors, ever ring in that Wagnerian manner.",
    "We shall be notes in that great Symphony Whose cadence circles through the rhythmic spheres,And all the live World's throbbing heart shall be One with our heart, the stealthy creeping yearsHave lost their terror now, we shall not die,The Universe itself shall be our Immortality!",
    ...
    "I like men who have a future and women who have a past,",
    "Можете ли да си спомните някое голямо прегрешение, което сте извършили на младини, херцогиньо? — попита той, като я погледна през масата.\t— Боя се, че мога да си спомня твърде много — отвърна тя.\t— Тогава извършете ги отново — каза сериозно той. — За да си възвърне младостта, човек трябва просто да повтори безумствата си.\t— Прекрасна теория! — възкликна херцогинята. — Непременно трябва да я приложа на практика.\t— Опасна теория! — процеди през стиснатите си устни сър Томас. Лейди Агата само поклати глава, но не можа да скрие усмивката си. Мистър Ърскин слушаше внимателно.\t— Да — продължи лорд Хенри, — това е една от най-големите тайни на живота. В наше време по-голямата част от хората бавно гинат от едно всеобщо заболяване — благоразумието, и откриват, когато е твърде късно, че единственото нещо, за което никога не бива да се съжалява, са собствените им грешки.",
    ...
    "وأنا في كل يوم أزداد اقتناعاً بأن ما كان يصلح لآبائنا لم يعد يصلح لنا، سواء أكان ذلك في الفن أو في السياسة. والمثل الفرنسي يقول: الأجداد دائماً مخطئون.",
    ...
    "He did not wring his hands, as doThose witless men who dareTo try to rear the changeling HopeIn the cave of black Despair.",
    ...
    "Don’t change, Dorian; at any rate, don’t change to me. We must always be friends. “Yet you poisoned me with a book once. I should not forgive that. Harry, promise me that you will never lend that book to anyone. It does harm.” “My dear boy, you are really beginning to moralise. You will soon be going about warning people against all the sins of which you have grown tired. You are much too delightful to do that. Besides, it is no use. You and I are what we are, and will be what we will be.”",
    "إن الفنانين ذوي الشخصية الجذابة الذين قابلتهم في حياتي كانوا فنانين رديئين. الفنانون الجيدون يتواجدون في أعمالهم، وبالتالي تجدهم مملين في شخوصهم، والشاعر العظيم حقا هو أقل الناس شاعرية في كلامه وحياته.",
    ...
    "He who lives more lives than oneMore deaths than one must die",
    "Those who try to lead the people can only do so by following the mob",
    ...
    "Какво ще кажеш за изкуството? — попита тя.— То е болест.— А любовта?— Илюзия.— А религията?— Моден заместител на вярата.— Ти си скептик.— Не съм. Скептицизмът е началото на вярата.— Какъв си тогава?— Да определиш, значи да ограничиш.",
    "حينما يفعل الرجل شيئا أحمق تماما يكون هذا ناجما عن دوافع نبيلة.",
    ...
    "fantastic shadows of birds",
    "إن الناس الجديرين بالمعرفة هم أولئك الذين يعرفون كل شيء والذين لا يعرفون أي شيء.",
    ...
    "يسرني أنك لم تصنع شيئا قط. لم تنحت تمثالا أو ترسم لوحة أو تخلق أي شيء خارج نفسك. كانت الحياة هي فنك الوحيد. إن أيامك هي (السوناتات) التي قمتَ بتأليفها!",
    ...
    "To be good is to be in harmony with oneself,\" He replied, touching the thin stem of his glass with his pale, fine-pointed fingers. \"Discord is to be forced to be in harmony with others. One's own life-that is the important thing. As for the lives of ones's neighbors, if one wishes to be a prig or a Puritan, one can flaunt one's moral views about them, but they are not one's concern.",
    "I am always saying what I shouldn't say; in fact, I usually say what Ireally think--a great mistake nowadays. It makes one so liable to bemisunderstood.",
    ...
    "Bad art is a great deal worse than no art at all.",
    "nasza przyszłość będzie taka sama jak przeszłość i grzech, popełniony kiedyś raz, ze wstrętem, będziemy powtarzać po wielokroć - już z przyjemnością.",
    "Cecily: “Miss Prism says that all good looks are a snareAlgernon: “They are a snare that every sensible man would like to be caught in.”Cecily: “Oh, I don’t think I would care to catch a sensible man. I shouldn’t know what to talk to him about.”",
    ...
    "There are only two ways, as you know, ofbecoming civilized. One is by being cultured, the other is by being corrupt.",
    ...
    "Words! Mere words! How terrible they were! How clear, and vivid, and cruel! One could not escape from them. And yet what a subtle magic there was in them! They seemed to be able to give a plastic form to formless things, and to have a music of their own as sweet as that of viol or of lute. Mere words!",
    ...
    "إن محبي البَشَر يفقدون كل إحساس بالإنسانية!",
    ...
    "that is one of the great secrets of life. Nowadays most people die of a sort of creeping common sense, and discover when it is too late that the only things one never regrets are one's mistakes.",
    "Have some bread and butter. The breadand butter is for Gwendolen. Gwendolen is devoted to bread andbutter.",
    "Fathers should be neither seen nor heard. That is the only proper basis for family life.",
    ...
    "Винаги е по-трудно да унищожаваш, отколкото да създаваш, а когато трябва да унищожаваш простащина и глупост, задачата изисква не само смелост, но и презрение.",
    ...
    "There are terrible temptations that it requires strength--strength andcourage--to yield to. To stake all one's life on one throw--whether thestake be power or pleasure I care not--there is no weakness in that.There is a horrible, a terrible, courage.",
    ...
    "Само на ограничените хора са нужни години, за да се освободят от дадено чуство. Ала онзи, който е господар на себе си, може да сложи край на една скръб тъй лесно, както и да си намери ново забавление.",
    ...
    "But there are moments when one has to choose between living one’s own life, fully, entirely, completely - or dragging out some false, shallow, degrading existence that the world in its hypocrisy demands.",
    "إن قوة ذاكرة المرأة لشئ مزعج، وهي إن دلت على شئ فهو ان عقولهن لا تعمل ابداً.",
    ...
    "Pentru a-ți recâștiga tinerețea trebuie doar să-ți repeți nebuniile.",
    ...
    "ALLONBY.––La ventaja de jugar con fuego, lady Caroline, es que no nos quemamos. Sólo se quema la gente que no sabe jugar con él.",
    ...
    "Those who find beautiful meanings in beautiful things are the cultivated. For these there is hope. They are the elect to whom beautiful things mean only beauty.",
    "İnsan her zaman âşık olmalıdır: Bu yüzden asla evlenmemelidir.",
    ...
    "Творец е оня, който създава прекрасни неща.\tИзкуството се стреми да разкрие себе си и да скрие твореца.\tКритик е оня, който в друга форма или с нови средства изразява чувството си за прекрасното.\tИ най-висшата, и най-низшата форма на критиката е един вид автобиография.\tОния, които в прекрасното откриват грозота, са покварени, без обаче да са обаятелни. Това е непростим недостатък.\tОния, които в прекрасното откриват нещо прекрасно, са културно издигнати хора. За тях все още има надежда.\tИзбраници са ония, за които прекрасното означава само Красота.\tНе съществуват нравствени или безнравствени книги. Книгите са добре написани или зле написани. Това е всичко.\tВраждебността на деветнадесетия век към Реализма е гневът на Калибан*, видял собствения си образ в огледалото.\t[* Калибан — герой на Шекспир от пиесата „Буря“, характерен с отблъскващата си външност и с грубия си, жесток нрав. — Б. пр.]\tВраждебността на деветнадесетия век към Романтизма е гневът на Калибан, който не е видял собствения си образ в огледалото.\tНравственият живот на човека е една от темите в творчеството на твореца, но нравствеността на изкуството се проявява в съвършеното използуване на несъвършени средства.\tТворецът не се стреми да докаже каквото и да било. Дори безспорните истини могат да бъдат доказани.\tТворецът не е моралист. Морализмът у твореца е непростима маниерност на стила.\tТворецът не бива да бъде обвиняван в болезненост. Творецът може да изобразява всичко.\tМисълта и Езикът са за твореца инструменти за творчество. Добродетелта и Порокът са за твореца материал за творчество.\tОт гледна точка на формата първообраз на всички изкуства е изкуството на музиканта. От гледна точка на чувствата първообраз на всички изкуства е изкуството на актьора.\tИзкуството има външна форма и вътрешен смисъл.\tОния, които се стремят да проникнат под външната форма, се излагат на опасност.\tОния, които тълкуват вътрешния смисъл, също се излагат на опасност.\tИзкуството всъщност отразява ония, които го възприемат, а не живота.\tРазличните мнения за едно произведение на изкуството доказват, че то е оригинално, сложно и жизнено.\tДори когато критиците се различават в мненията си, художникът остава верен на себе си.\tМожем да простим някому, че е създал нещо полезно, стига сам да не започне да се възхищава от него. Единственото извинение за оня, който е създал нещо безполезно, е неговото безгранично възхищение от собствената му творба.\tИзкуството е напълно безполезно.",
    "There is no doubt that genius lasts longer than beauty.",
    "I can resist anything but temptation.",
    ...
    "There is the same world for all of us, and good and evil, sin andinnocence, go through it hand in hand. To shut one's eyes to half oflife that one may live securely is as though one blinded oneself thatone might walk with more safety in a land of pit and precipice.",
    "To be popular, one must be a mediocrity.",
    "We are never more true to ourselves than when we are inconsistent.",
    ...
    "It was better to know the worst, whatever it was, than to be left in this hideous uncertainty.",
    ...
    "Death must be so beautiful. Lying in the soft brown earth, with the grass waving above your head, and listening to silence. I’d love to have no yesterday, and no tomorrow – to be at peace!’ He",
    ...
    "Le cose vere della vita non si imparano nè si studiano. Ma si incontrano",
    ...
    "At least,I have not made my heart a heart of stone,Nor starved my boyhood of is goodly feast,Nor walked where beauty is a thing unknown.",
    ...
    "LADY BRACKNELLThis noise is extremely unpleasant. It sounds as if he was having an argument. I dislike arguments of any kind. They are always vulgar, and often convincing.",
    ...
    "And self-sacrifice is a thing that should be put down by law.  It is so demoralising to the people for whom one sacrifices oneself.  They always go to the bad.",
    ...
    "Women treat us just as Humanity treats its gods. They worship us, and are always bothering us to do something for them', answered Lord Henry, toying with some fruits. 'I should have said that whatever they ask for they had first given to us,' murmured Dorian Gray, gravely. 'They create Love in our natures. They have a right to demand it back.",
    ...
    "L'arte, tutta, è ad un tempo superficie e simbolo.Coloro che si avventurano sotto la superficie lo fanno a loro rischio e pericolo.Coloro che interpretano il simbolo lo fanno a loro rischio e pericolo.L'arte, tutta, è completamente inutile.",
    ...
    "It is not the perfect, but the imperfect, whohave need of love. It is when we are wounded by our own hands that love should come to cure us—else what use is love at all?",
    "Yo adoro los placeres sencillos. Son el último refugio de los hombres complicados.",
    "The well-bred contradict other people. The wise contradict themselves.",
    "لا شيء هو الصواب بعينه.",
    "The gods have given me almost everything. But i let myself be lured into long spells of senseless and sensual ease.",
    "The very essence of romance is uncertainty.  If ever I get married, I’ll certainly try to forget the fact.",
    ...
    "I am one of those who are made for exceptions, not for laws. But while I see that there is nothing wrong in what one does, I see that there is something wrong in what one becomes. It is well to have learned that.",
    ...
    "And his Soul mocked him and said, \"Surely thou hast but little joy out of thy love. Thou art as one who in time of dearth pours water into a broken vessel. Thou givest away what thou hast, and nought is given to thee in return. ...",
    "There is a luxury in self-reproach. When we blame ourselves we feel that no one else has a right to blame us. It is the confession, not the priest, that gives us absolution.",
    "Вечна младост, неограничена страст, изтънчени тайни наслаждения, необуздани радости и още по-необуздани прегрешения - ето какво го очакваше. А портретът щеше да носи бремето на неговият позор.",
    "I am dying beyond my means.",
    "One can always be kind to people about whom one cares nothing. I",
    ...
    "Днес по улиците на Йерусалим се влачи един луд, който носи на раменете си дървен кръст. Той е символ на животите, провалени от подражание.",
    "Eᴠᴇʀʏᴛʜɪɴɢ ɪɴ ᴛʜᴇ ᴡᴏʀʟᴅ ɪs ᴀʙᴏᴜᴛ sᴇx, ᴇxᴄᴇᴘᴛ sᴇx. Sᴇx ɪs ᴀʙᴏᴜᴛ ᴘᴏᴡᴇʀ!",
    "To get into the best society, one has either to feed people, amuse people, or shock people.",
    ...
    "Now it seems to me that love of some kind is the only possible explanation of the extraordinary amount of suffering that there is in the world. I cannot conceive of any other explanation. I am convinced that there is no other, and that if the world has indeed, as I have said, been built of sorrow, it has been built by the hands of love, because in no other way could the soul of man, for whom the world was made, reach the full stature of its perfection. Pleasure for the beautiful body, but pain for the beautiful soul.",
    "Those who are faithful know only the trivial side of love: it is the faithless who know love's tragedies.\" And Lord Henry struck a light on a dainty silver case and began to smoke a cigarette with a self-conscious and satisfied air, as if he had summed up the world in a phrase. There",
    ...
    "But were things different: had I not a friend left in the world; were there not a single house open to me in pity; had I to accept the wallet and ragged cloak of sheer penury: as long as I am free from all resentment, hardness and scorn, I would be able to face the life with much more calm and confidence than I would were my body in purple and fine linen, and the soul within me sick with hate.And I really shall have no difficulty. When you really want love you will find it waiting for you.",
    ...
    "Selfishness is not living as one wishes to live, it is asking others to live as one wishes to live: and unselfishness is letting other people's lives alone, not interfering with them. A",
    "Sooner or later we have all to pay for what we do.",
    ...
    "There is only one thing in the world worse than being talked about, and that is not being talked about. Life",
    ...
    "There are things that are right to say but that may be said at the wrong time and to the wrong people. The",
    ...
    "L'uomo è un essere dalle molteplici vite e dalle innumeri sensazioni; una creatura complessa e multiforme, porta seco strane eredità di pensiero e di passioni e perfino la sua carne è inquinata dalle misteriose malattie dei morti.",
    ...
    "When one is in love one begins by deceiving oneself, and one ends by deceiving others. That is what the world calls a romance. The",
    "When I like people immensely I never tell their names to anyone. It is like surrendering a part of them. I have grown to love secrecy. It seems to be the one thing that can make modern life mysterious or marvellous to us",
    ...
    "E' un errore credere che la passione che si prova nell'atto di creare si rispecchi nel creato. L'arte è sempre estranea a quanto creiamo. La forma e il colore ci parlano di forma e colore, e nient'altro.",
    "The terror of society, which is the basis of morals, the terror of God, which is the secret of religion--these are the two things that govern us.",
    ...
    "Moderation is a fatal thing. Nothing succeeds like excess. Actions",
    ...
    "To become the spectator of one's own life is to escape the suffering of life. The",
    ...
    "لا وجود للتأثير الطيب يا مستر جراي، فالتأثير في حد ذاته يتنافى مع الأخلاق، هذا إذا أردت أن يكون حكمك واقعياً.",
    ...
    "I adore simple pleasures. They are the last refuge of the complex. There",
    ...
    "You see, it is a very dangerous thing to listen.  If one listens one may be convinced; and a man who allows himself to be convinced by an argument is a thoroughly unreasonable person. lady basildon.",
    "wartość idei w żaden sposób nie zależy od szczerości tego, kto ją głosi. Wprost przeciwnie; istnieje duże prawdopodobieństwo, że im bardziej jest nieszczery, tym bardziej stanowi ona czysty wytwór jego intelektu, nieskażony jego osobistymi potrzebami, pragnieniami czy przesądami.",
    ...
    "A we wszystkich romansach najgorsze jest to, że człowiek wychodzi z nich pozbawiony wszelkiego romantyzmu.",
