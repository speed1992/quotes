export const HIPPOCRATES = [
    ...
    "The chief virtue that language can have isclearness, and nothing detracts from it somuch as the use of unfamiliar words.",
    ...
    "All the most acute, most powerful, and most deadly diseases, and those which are most difficult to be understood by the inexperienced, fall upon the brain.",
    "الطبيب الذي يحب الحكمة لا يقل عن الآلهة في شيء",
    "What medicines do not heal, the lance will; what the lance does not heal, fire will.",
    "La ocasión en fugazla experiencia inseguray el juicio difícil",
    ...
    "Primum non nocere.",
    "Let food be thy medicine and medicine be thy food.Excerpt From: Daria Sanetra. “Your Emotional Belly Cure”. Apple Books.”",
    "Ars longa, vita brevis.",
