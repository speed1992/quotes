export const data = [
    ...
    "ليس شرّكم بل الكثير من خيركم هو الذى يقرفنى فى الحقيقة",
    ...
    "آن که اینجا یارای خندیدنش نیست نباید بخواند زیرا \"موجود خبیثی\" ست درجانش که نمی خنداندش",
    ...
    "كل الحقائق المكتومة تتحول إلى سموم",
    ...
    "فلتحذر أن لا يأسرك فى آخر المطاف معتقد ضيّق: جنون قاسى متشدد !",
    "أن تكونوا قد عرفتم اليأس, ففى ذلك الكثير مما يستحق الإكبار",
    ...
    "الفاعل وحده هو الذى يتعلم",
    "وعندها تعلمت أن أصعب على الإنسان أن يجيد العطاء من أن يجيد الاخذ, وأن العطاء فن, وهو أرقى أشكال المكر فى براعة الخير",
    ...
    "لا يهم اذا لم تكن لديك أية سعادة متبقية لتعطيها لي فلا يزال لديك أسفك",
    ...
    "الحق أقول لكم ، إن خيراً و شراً خالدين في الثبات - أمر لا وجود له ! كل شئ محكوم بضرورة تجاوز نفسه على الدوام .",
    ...
    "بعض الناس لا يحق لك أن تمد يدك إليهم, بل كف الوحش وأريد أن تكون لكفك مخالب ايضا",
    "من أصقاع المستقبل تأتى رياح تخفق بأجنحة سرية, والأذن المرهفة هى التى تتلقى رسالة البشرى",
    ...
    "أى شئ إذا هى هذه الكنائس إن لم تكن أقبية وقبوراً لله ؟",
