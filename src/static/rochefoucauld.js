export const ROCHEFOUCAULD = [
    ...
    "The reason that lovers never weary each other is because they are always talking about themselves.",
    "Perfect valour is to do without witnesses whatone would do before all the world.",
    ...
    "The only thing constant in life is change.",
    "It is a great act of cleverness to conceal one's being clever.",
    "There are bad people who would be less dangerous if they were quite devoid of goodness.",
    ...
    "Where love is, no disguise can hide it for very long; where it is not, none can simulate it.",
    ...
    "Hope and fear are inseparable; and there is no fear without hope, or hope without fear.",
    "The wise man finds it better not to enter the encounter than to conquer.",
    "Tres clases hay de ignorancia: no saber lo que debiera saberse, saber mal lo que se sabe y saber lo que no debiera saberse.",
    "The restraint we lay upon ourselves to be constant, is not much better than an inconstancy.",
    ...
    "Διαθέτω πνεύμα, δεν κωλύομαι να το πω, σε τι άλλωστε θα ωφελούσε μια ψευτοσεμνοτυφία σχετικά μ'αυτό; Το να 'μαστε επιφυλακτικοί όταν πρόκειται να μιλήσουμε για τα προτερήματά μας, είναι σαν να προσπαθούμε επιτηδευμένα να τα κρύψουμε κάτω από μιαν επίφαση μετριοφροσύνης για να κάνουμε τους άλλους να νομίζουν πως είμαστε πολύ καλύτεροι απ' όσο ομολογούμε. Διαθέτω πνεύμα, πνεύμα όμως μολυσμένο από τη μελαγχολία, έτσι που, μολονότι διαθέτω ευγλωττία, γερή μνήμη και ελάχιστη σύγχυση, είμαι τόσο κατειλημμένος από τις ζοφερές μου σκέψεις που συχνά εκφράζω πολύ άσχημα τις ιδέες μου.",
    "Good advice is something a man gives when he is too old to set a bad example.",
    "Few are sufficiently wise to prefer censure which is useful to praise which is treacherous.",
    "Whatever pretext we give to our afflictions it is always interest or vanity that causes them.",
    "Existen tres tipos de ignorancia:No saber lo que se debe saberSaber lo que no se debe saberLo que se sabe, saberlo mal",
    ...
    "451.—No fools so wearisome as those who have some wit. 452.—No",
    "Idiots and lunatics see only their own wit.",
    "CXXI.—There is nothing more natural, nor more deceptive, than to believe that we are beloved.",
    "The vivacity which increases in old age is not far removed from folly.",
    ...
    "Many persons wish to be devout; but no one wishes to be humble.",
    ...
    "It is as proper to be boastful alone as it is ridiculous to be so in company.",
    ...
    "Μου αρέσουν τα αναγνώσματα κάθε λογής, ιδιαιτέρως εκείνα που μπορούν να καλλιεργήσουν το μυαλό και να δυναμώσουν την ψυχή πάνω απ' όλα, δοκιμάζω μέγιστη απόλαυση στο να διαβάζω μαζί μ' έναν άνθρωπο ευφυή, μια που έτσι μπορείς να στοχάζεσαι διαρκώς πάνω σ' εκείνα που διαβάζεις, και τέτοιοι στοχασμοί σχηματίζουν τα θεμέλια για την πιο απολαυστική και επωφελή συνομιλία.",
    ...
    "If a woman’s temper is beyond control there can be no control of the mind or heart.",
    ...
    "The greater number of good women are like concealed treasures, safe as no one has searched for them.",
    ...
    "Good and evil ordinarily come to those who have most of one or the other.",
    "Ordinary men commonly condemn what is beyond them.",
    ...
    "We commonly praise the good hearts of those who admire us. (See",
    ...
    "—The daily employment of cunning marks a little mind,",
    "Intrepidity",
    ...
    "We sometimes think that we hate flattery, but we only hate the manner in which it is done.",
    "Κατά καιρούς, το μυαλό μας δεν λειτουργεί παρά για να μας οδηγήσει σ' ανόητα επιχειρήματα.",
    ...
    "Cunning and treachery are the offspring of incapacity.",
    "Too great cleverness is but deceptive delicacy, true delicacy is the most substantial cleverness.",
    "He saw a cottage with a double coach-house, A cottage of gentility, And the devil was pleased, for his darling sin Is the pride that apes humility.",
    "When not prompted by vanity we say little.",
    ...
    "Το να θέλεις από μόνος σου να παραμένεις συνετός είναι μεγάλη τρέλα",
    ...
    "478. L’imagination ne saurait inventer tant de diverses contrariétés qu’il y en a naturellement dans le cœur de chaque personne.",
    ...
    "What a tiresome malady is that which forces one to preserve your health by a severe regimen.",
