export const HERACLITUS = [
    ...
    "Silence, healing.",
    "All things are in flux; the flux is subject to a unifying measure or rational principle. This principle (logos, the hidden harmony behind all change) bound opposites together in a unified tension, which is like that of a lyre, where a stable harmonious sound emerges from the tension of the opposing forces that arise from the bow bound together by the string.",
    "What was scatteredgathers.What was gatheredblows away.",
    "All are one",
    "The awake share a common world, but the asleep turn aside into private worlds.",
    ...
    "All things come into being by conflict of opposites.",
    "Life has the name of life, but in reality it is death.",
    "ἀθάνατοι θνητοί, θνητοὶ ἀθάντατοι, ζῶντες τὸν ἐκείνων θάνατον, τὸν δὲ ἐκείνων βίον τεθνεῶτες (Mortals are immortals and immortals are mortals, the one living the others' death and dying the others' life.)",
    "What are men? Mortal gods. What are gods? Immortal men.",
    "Without injustices,the name of justicewould mean what?",
    "To get everything you want is not a good thing. Disease makes health seem sweet. Hunger leads to the appreciation of being full-fed. Tiredness creates the enjoyment of resting",
    ...
    "τήν τε οἴησιν ἱερὰν νόσον ἔλεγε καὶ τὴν ὅρασιν ψεύδεσθαι(Thinking is a sacred disease, and sight is deceptive.)",
    ...
    "Character is destiny.",
    "To God all things are fair and good and right, but men hold some things wrong and some right.",
    "γραφέων ὁδὸς εὐθεῖα καὶ σκολιὴ μία ἐστί, φησί, καὶ ἡ αὐτή(The path of writing is crooked and straight)",
    ...
    "Things keep their secrets.",
    "Σίβυλλα δὲ μαινομένῳ στόματι καθ' Ἡράκλειτον ἀγέλαστα καὶ ἀκαλλώπιστα καὶ ἀμύριστα φθεγγομένη χιλίων ἐτῶν ἐξικνεῖται τῇ φονῇ διὰ τὸν θεόν(And the Sibyl, with raving lips uttering things mirthless, unbedizened, and unperfumed, reaches over a thousand years with her voice, thanks to the god in her.)",
    "Panta rei.",
    "You cannot step into the same river twice",
    ...
    "Stupidity is better kept a secret than displayed.",
    "Πάντα ῥεῖ καὶ οὐδὲν μένει(All is flux, and nothing abides)",
    ...
    "Βίος ανεόρταστος μακρά οδός απανδόκευτος (Uncelebrated life is like a long innless road)",
    ...
    "Change alone is unchanging.",
    "The soul is undiscoveredthough explored foreverto a depth beyond report.",
    ...
    "Stupidity is better kept a secret than displayed.",
    "The cosmos worksby harmony of tensions,like the lyre and bow.",
    ...
    "باليقظة - نملك عالمًا واحدًا ,بالحُلُمِ - كُلٌ يملك عالمه .",
    ...
    "Graspings: wholes and not wholes, convergent divergent, consonantdissonant, from all things one and from one thing all.",
    "The most beautiful arrangement is a pile of things poured out at random",
    "The living, though they yearnfor consummation of their fate,need rest, and in their turn leavechildren to fulfil their doom.",
    "Nada é permanente, excepto a mudança.",
    "Under the combthe tangle and the straight pathare the same.",
    ...
    "The immortals are mortal, the mortals immortal, each living in the other's death and dying in the other's life.",
    ...
    "It is the thunderbolt that steers the course of all things.τὰ δὲ πάντα οἰακίζει Κεραυνός",
    ...
    "إن الحمير لتفضل القش علي الذهب",
    ...
    "Change is the only constant.",
    "One would never discover the limits of soul, should one traverseevery road so deep a measure does it possess",
    ...
    "Give me one man from among ten thousands, if he be the best.",
    "Εάν δεν αναμένετε το απροσδόκητο, δεν θα το αναγνωρίσετε όταν φτάσει.",
    "Τα παντα ρει",
    ...
    "Into the same rivers we both step and do not step; we both are and are not.",
