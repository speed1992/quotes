export const SENECA = [
    ...
    "كئيبة تلك الحياة التي يشعر الانسان بالخجل لقبولها.",
    ...
    "من ليس لديه شئ يأمل فيه ليس أمامه شئ ييأس منه .",
    ...
    "No delicate breeze brings comfort with icy breath of windto the hearts which pant on the flames.",
    ...
    "He who needs riches least, enjoys riches most.\"[8]",
    ...
    "يجب عدم المحافظة على حياة يشعر الانسان بالخجل لقبولها.",
    ...
    "صادقُ أمام الجميع كاذبُ أمام نفسه.",
    ...
    "We are all tied to Fortune, some by a loose and golden chain, and others by a tight one of baser metal: but what does it matter? We are all held in the same captivity, and those who have bound others are themselves in bonds - unless you think perhaps that the left-hand chain is lighter. One man is bound by high office, another by wealth; good birth weighsdown some, and a humble origin others; some bow under the rule of other men and some under their own; some are restricted to one place by exile, others by priesthoods: all life is a servitude.",
    ...
    "ما أصعب أن تتخلص النفس من الغضب بعد أن تُدفع إليه.",
    ...
    "Elämä avautuu suurena sille, joka osaa järjestää sen viisaasti.",
    ...
    "We are all tied to Fortune, some by a loose and golden chain, and others by a tight one of baser metal: but what does it matter? We are all held in the same captivity, and those who have bound others are themselves in bonds - unless you think perhaps that the left-hand chain is lighter. One man is bound by high office, another by wealth; good birth weighsdown some, and a humble origin others; some bowunder the rule of other men and some under their own; some are restricted to one place by exile, others by priesthoods: all life is a servitude.",
    ...
    "for when one strays away from Nature one is compelled to crave, and fear, and be a slave to the things of chance.",
    ...
    "There is a comeliness even in grief. This should be cultivated by the wise man; even in tears, just as in other matters also, there is a certain sufficiency; it is with the unwise that sorrows, like joys, gush over.",
    "det ille veniam facile, cui venia est opus - the one who needs pardon should readily grant it",
    "This saying of Stilbo makes common ground with Stoicism; the Stoic also can carry his goods unimpaired through cities that have been burned to ashes; for he is self-sufficient. Such are the bounds which he sets to his own happiness.",
    ...
    "to rouse your spirit against Fortune and to be on the watch for all her missiles, not as if they might possibly come, but as if they were bound to come.",
    ...
    "I hold that one is braver at the very moment of death than when one is approaching death.",
    ...
    "God is near you, is with you, is inside you. Yes, Lucilius, there resides within us a divine spirit, which guards us and watches us in the evil and the good we do. As we treat him, so will he treat us. No man, indeed, is good without God – is any one capable of rising above fortune unless he has help from God?",
    "He who has made a fair compact with poverty is rich.",
    "It takes the whole of life to learn how to live, and - what will perhaps make you wonder more - it takes the whole of life to learn how to die.",
    ...
    "The one wants a friend for his own advantage; the other wants to make himself an advantage to his friend.",
    ...
    "Consider individuals, survey men in general; there is none whose life does not look forward to the morrow. 13. \"What harm is there in this,\" you ask? Infinite harm; for such persons do not live, but are preparing to live.",
    ...
    "En wanneer de natuur mijn levensadem terugvraagt of mijn verstand hem heenzendt, zal ik heengaan met het getuigenis dat ik een eerlijk geweten en een eerlijke inzet beminde, dat niemands vrijheid door mij is ingeperkt, en wel in het minst die van mijzelf.",
    ...
    "And besides this, in order that virtue may be perfect, there should be an even temperament and a scheme of life that is consistent with itself throughout; and this result cannot be attained without knowledge of things, and without the art1 which enables us to understand things human and things divine.",
    ...
    "What we have to seek for, then, is that which does not each day pass more and more under the control of some power which cannot be withstood. And what is this? It is the soul—but the soul that is upright, good, and great. What else could you call such a soul than a god dwelling as a guest in a human body? A soul like this may descend into a Roman knight just as well as into a freedman’s son or a slave. For what is a Roman knight, or a freedman’s son, or a slave? They are mere titles, born of ambition or of wrong. One may leap to heaven from the very slums. Only rise And mould thyself to kinship with thy God. This moulding will not be done in gold or silver; an image that is to be in the likeness of God cannot be fashioned of such materials;",
    ...
    "We cease to be so angry once we cease to be so hopeful. “Nothing”",
    ...
    "J'ai tant désiré le jour et voici qu'il me brûle les yeux!",
    ...
    "Nature gave us legs with which to do our own walking, and eyes with which to do our own seeing.",
    ...
    "We live in the middle of things which have all been destined to die. Mortal have you been born, to mortals you have given birth. Reckon on everything, expect everything.",
    "Fortune attacks us as often as we attack Fortune.  It",
    ...
    "Sometimes it is sweet to be mad,",
    "He suffers more than necessary, who suffers before it is necessary…",
    "Lay hold of to-day's task, and you will not need to depend so much upon tomorrow's.",
    ...
    "LETTERA 3 LA VERA AMICIZIAMa se stimi amico uno, e poi non hai in lui la stessa fiducia che hai in te stesso, commetti un grave errore e ignori il valore della vera amicizia.",
    ...
    "There is only one chain which binds us to life, and that is the love of life. The chain may not be cast off, but it may be rubbed away,",
    ...
    "There is no great genius without tincture of madness.",
    ...
    "For obstinacy, from which Fortune often extorts something, is bound to bring wretchedness and anxiety, and much more serious is the fickleness that nowhere restrains itself. Both are hostile to tranquillity, and find change impossible and endurance impossible.",
    ...
    "It's not on our account that the world enjoys the cycle of winter and summer: such things follow their own laws, by which the divine purpose is carried out.20' We think too much of ourselves if we fancyourselves worthy of causing such great stirrings. None of these things, then, happens with the aim of wronging us-rather, quite the opposite, none of these things happens save for our well-being.",
    ...
    "longing for the future and weariness of the present.",
    ...
    "You ask what progress I have made? I have begun to be a friend to myself.",
    "They lose the day in waiting for the night, and the night in fearing the dawn.",
    "Hence, good does not spring from evil, any more than figs grow from olive-trees. Things which grow correspond to their seed; and goods cannot depart from their class.",
    "There is no enjoying the possession of anything valuable unless one has someone to share it with.",
    ...
    "Just as a lingering illness makes men querulous and irritable and drives them wild at the least crossing of their desires,",
    ...
    "in you has been seen that matchless ornament, that loveliest beauty which is not dependent on any time of life, that greatest glory of all – modesty.",
    ...
    "why should I demand of Fortune that she give rather than demand of myself that I should not crave? And why should I crave? Shall I heap up my winnings, and forget that man’s lot is unsubstantial? For what end should I toil?",
    ...
    "Granted that as a murderer he deserved this punishment, what have you done, you wretched fellow, to deserve to watch it?",
    ...
    "For certain ailments must be treated while the patient is unaware of them:",
    "He is ungrateful who denies that he has received a kindness which has been bestowed upon him; he is ungrateful who conceals it; he is ungrateful who makes no return for it; most ungrateful of all is he who forgets it.",
    ...
    "takes the whole of life to learn how to live, and — what will perhaps make you wonder more — it takes the whole of life to learn how to die.",
    ...
    "He who ponders these things [death, poverty, temptation, and suffering] in his heart is indeed full of joy; but it is not a cheerful joy. It is just this joy, however, of which I would have you become the owner; for it will never fail you when once you have found its source.",
    ...
    "The primary indication, to my thinking, of a well-ordered mind is a man’s ability to remain in one place and linger in his own company. Be",
    "Look at those whose good fortune people gather to see: they are choked by their own blessings. How many find their riches a burden! How many burst a blood vessel by their eloquence and their daily striving to show off their talents!",
    ...
    "Nullus accusator caret culpa; omnes peccaviums.",
    ...
    "Let me indicate here how men can prove that their words are their own: let them put theirpreaching into practice",
    ...
    "For these two things are, as it were, at opposite poles—good Fortune and good sense; that is why we are wiser when in the midst of adversity. It is prosperity that takes away righteousness.",
    ...
    "Philosophy neither rejects nor selects anyone; its light shines for all. Socrates was no aristocrat. Cleanthes worked at a well and served as a hired man watering a garden. Philosophy did not find Plato already a nobleman; it made him one. Why then should you despair of becoming able to rank with men like these?",
    ...
    "Който не умее да мълчи, той не е способен да говори.",
    "he has published the truth abroad that he is most happy who has no need of happiness, and that he is most powerful who has power over himself.",
    ...
    "It is bothersome always to be beginning life. Or another, which will perhaps express the meaning better: “They live ill who are always beginning to live.” You are right in asking why; the saying certainly stands in need of a commentary. It is because the life of such persons is always incomplete.”",
    ...
    "write in this way, – provided that while you write you read, remembering that everything you hear or read, is to be applied to conduct, and to the alleviation of passion's fury.",
    ...
    "Ölümün çevresinde koparılan yaygara ölümün kendisinden daha çok korkutur.",
    ...
    "There never was great genius without some madness.",
    "LETTERA 28 È L'ANIMO CHE DEVI CAMBIARE, NON IL CIELO SOTTO CUI VIVIPrima esercita la funzione di accusatore, poi quella di giudice; e in ultimo quella di avvocato difensore. All'occorrenza, sappi anche infliggerti una condanna.",
    "LETTERA 27 LA VIRTÙ È FONTE DI FELICITÀResta ancora molto lavoro a cui tu, di persona, devi dedicare le tue veglie, le tue fatiche, se desideri che sia portato a compimento. A differenza di altri generi di lavoro, questo non ammette deleghe o aiuti.",
    ...
    "Вкажи мені людину, яка бодай трохи цінувала б час, дорожила днем, яка б розуміла, що вмирає, власне, щоденно?..",
    "Vivere militare est.",
    "Where is the man who sets some value on his time, who knows the worth of a day and who realizes that he is dying every instant? While we put things off until tomorrow, life slips away. Nothing is ours, Lucilles, save only our time. And yet we let the first comer deprive us of our sole and fleeting fortune.",
    ...
    "LETTERA 20 I FATTI DEVONO ANDARE D'ACCORDO CON LE PAROLECerto, il lettuccio e i panni rozzi non sono una prova sufficiente per dimostrare la buona disposizione d'animo, se non risulta chiaro che la povertà è stata scelta liberamente, non già tollerata per necessità.",
    ...
    "Bohatství chytrému slouží, hloupému vládne.",
    ...
    "Quemadmodum\" - inquit - \"magnus luctator est, non qui omnes numeros nexusque perdidicit, quorum usus sub adversario rarus est, sed qui in uno se aut altero bene ac diligenter exercuit et eorum occasiones intentus expectat (neque enim refert, quam multa sciat, si scit, quantum victoriae satis est), sic in hoc studio multa delectant, pauca vincuntSeneca, De Beneficiis, VII, 1, 4”",
    "The greatest obstacle to living is expectation, which depends on tomorrow and wastes today.",
    "LETTERA 36 CONSIGLI PER UN AMICO DI LUCILIOLa notte nasconde il sole, ma subito dopo il giorno porta via la notte.",
    ...
    "Of all men they alone are at leisure who take time for philosophy, they alone really live; for they are not content to be good guardians of their own lifetime only.  They annex every age to their own; all the years that have gone ere them are an addition to their store.",
    ...
    "Nothing is so bitter that a calm mind cannot find comfort in it.",
    "LETTERA 39 BISOGNA DOMINARE LE PASSIONINessun nemico ha portato tanta offesa agli uomini quanto le loro passioni.",
    ...
    "LETTERA 25 DIVERSI MODI DI EDUCAZIONECol peccatore inveterato penso che bisogni agire con un certo tatto, perché non giunga a disperare di sé stesso.",
    ...
    "Vindica te tibi",
    "The day which we fear as our last is but the birthday of eternity",
    "LETTERA 14 NON DOBBIAMO ESSERE SCHIAVI DEL CORPOIl marinaio temerario non si cura delle minacce dell'austro che agita il mare siciliano e suscita i vortici, e non si dirige verso la parte sinistra della costa, ma passa vicino a quel tratto costiero da cui Cariddi sconvolge il mare. Il marinaio più cauto, invece, chiede a chi conosce i luoghi quali correnti ci siano e quali indizi si possano trarre dalle nubi, e tiene la rotta ben lungi da quella zona malfamata per i suoi gorghi.",
    ...
    "For life should be provided with conspicuous illustrations. Let us not always be harking back to the dim past.",
    ...
    "Putting off things is the biggest waste of life: it snatches away each day it comes and denies us the present by promising the future.",
    "Drunkenness is nothing but voluntary madness.",
    "Bion’s dictum, that all the activities of men are like their beginnings, and their life is not more high-souled or serious than their conception, and that being born from nothing they are reduced to nothing.",
    ...
    "LETTERA 13 IL SAGGIO NON SI PREOCCUPA DEL FUTUROOsservali ad uno ad uno: troverai vecchi che ancora brigano per ottenere cariche politiche, o iniziano nuovi viaggi, o intraprendono nuovi affari. Che c'è di più brutto di un vecchio che vuole ricominciare a vivere?",
    ...
    "LETTERA 31 IL VERO BENE È STRETTAMENTE CONNESSO ALLA VIRTÙLe voci che egli temeva erano carezzevoli ma isolate. Queste che dobbiamo temere noi non vengono da uno scoglio, ma risuonano tutt'intorno da ogni parte della terra. Perciò devi lasciarti dietro non solo un luogo sospetto per i suoi insidiosi piaceri, ma tutte le città.",
    "It is certainly foolish to make yourself wretched now just because you are going to be wretched some time in the future.",
    "If God is pleased to add another day, we should welcome it with glad hearts.- Seneca",
    "Life is neither a Good nor an Evil; it is simply the place where good and evil exist.",
    "In fact, we are wrong to think that death lies ahead: much of it has passed us by already, for all our past life is in the grip of death.*",
    "LETTERA 32 ACCELERA I TUOI PROGRESSI SPIRITUALIinvero è molto dannoso anche chi fa indugiare, specialmente in una vita così breve, che noi abbreviamo ancor più con la nostra incostanza, ricominciando a viverla ora in un modo ora in un altro: la riduciamo a pezzetti e a brandelli.",
    "...Nos pasamos la vida entera aprendiendo a vivir, pero más sorprendente es que también dediquemos toda la vida a aprender a morir...",
    "A great, a good, and a right mind is a kind of divinity lodged in flesh, and may be the blessing of a slave as well as of a prince: it came from heaven, and to heaven it must return; and it is a kind of heavenly felicity, which a pure and virtuous mind enjoys, in some degree, even upon earth.",
    "Who — only let him be a man and intent upon honor — is not eager for the honorable ordeal and prompt to assume perilous duties? To what energetic man is not idleness a punishment?",
    ...
    "LETTERA 11 IL SENSO DEL PUDORECi occorre-ripeto-una persona a cui adeguare i nostri costumi: non possiamo correggere le cattive abitudini se non ci riferiamo costantemente a una norma.",
    "Unblest is he who thinks himself unblest.",
    ...
    "Quanta foscor llança a les nostres ments una felicitat excessiva!¡Cuanta oscuridad lanza sobre nuestras mentes una felicidad excesiva!",
    ...
    "Así como todos los vicios echan raíces profundas, si no se les arranca en cuanto germinan; así también en un ánimo triste y desgraciado, el dolor, cebándose en él, concluye por alimentarse de sus propias amarguras, y el infortunado encuentra en el pesar censurable goce.",
    "LETTERA 29 BISOGNA CONSIGLIARE A TEMPO UTILEHo intenzione di avvicinarlo e di mostrargli come egli varrebbe di più se valesse di meno nella stima della folla.",
    ...
    "I have not stopped my reading in the slightest degree. And reading, I hold, is indispensable – primarily, to keep me from being satisfied with myself alone,",
    ...
    "Въпросът не е, че разполагаме с малко време.Въпросът е, че прекалено много го губим",
    ...
    "LETTERA 38 VANTAGGI DELLA CONVERSAZIONE FAMILIAREI discorsi già preparati e pronunciati a gran voce davanti al pubblico degli ascoltatori hanno maggior risonanza, ma meno familiarità. La filosofia non è che un buon consiglio, ma nessuno dà un consiglio ad alta voce.",
    ...
    "I force my mind to concentrate, and keep from straying to things outside itself. All outdoors may be bedlam, provided that there is no disturbance within.",
    "It doesn't matter how much wind is in your sails if you don't have a harbor.",
    ...
    "Everything resounds with mighty preparations, - as if the Saturnalia differed at all from the usual business day! So true it is that the difference is nil, that I regard as correct the remark of the man who said: \"Once December was a month; now it is a year.\" [i.e., the whole year is a Saturnalia.]",
    ...
    "LETTERA 17 LA FILOSOFIA GIOVA IN OGNI CIRCOSTANZA DELLA VITACosì non importa se un animo malato sia posto fra le ricchezze o nella povertà: lo seguirà sempre il suo male.",
    ...
    "¿No es inexplicable demencia la de castigarse por los propios quebrantos y aumentar el número de los males?",
    "ad astra per aspera",
    "we pray for something opposite to that which we have prayed for in the past.",
    "You want to live but do you know how to live? You are scared of dying and tell me, is the kind of life you lead really any different from being dead?",
    ...
    "LETTERA 33 DEVI ACQUISTARE UN PENSIERO ORIGINALE, FRUTTO DELLA TUA ESPERIENZARicordare è custodire ciò che è stato affidato alla memoria, mentre sapere significa far proprie le nozioni apprese e non star sempre attaccato al modello, con lo sguardo sempre rivolto al maestro.",
    ...
    "LETTERA 26 TI GIUDICHERÀ LA MORTEApparirà ciò che hai fatto nella vita solo quando esalerai l'ultimo respiro.",
    ...
    "LETTERA 21 LA VERA GLORIAIn questi giardini gli stimoli della fame non si eccitano, ma si estinguono; né la sere aumenta col bere, ma è sedata da un rimedio naturale e gratuito.",
    ...
    "De Epicuro', dizes, 'é essa afirmação. O que tem uma outra escola a ver com a nossa?' Tudo o que é verdadeiro também é meu.",
    "Beware of doing that again – and this time I pardon you.",
    "LETTERA 2 LA LETTURA CHE GIOVAÈ povero non chi possiede poco, ma chi brama avere di più.",
    ...
    "El deleite no es paga ni causa de la virtud, si no una añadidura, y no agrada porque deleita, sino que deleita porque agrada",
    ...
    "LETTERA 12 ANCHE LA VECCHIAIA HA LE SUE GIOIETutta la nostra esistenza è fatta di parti, è costituita, cioè, di cerchi più ampi che cingono cerchi sempre minori.",
    ...
    "Некоторые помешались уже до такой степени, что считают возможным быть оскорбленными женщиной. Какая разница, как ее содержат, сколько у нее носильщиков, сколько весят серьги в ее ушах и насколько просторно ее кресло? Все равно она остается тем же неразумным животным, диким и не умеющим сдерживать свои вожделения, если только она не получила особенно тщательного воспитания и образования в науках.",
    "<>. Sì: tutto lo spazio rimanente non è vita, ma tempo.",
    "Todo lo que está por venir es incierto. Viveel presente, y advierte que el mayor de los poetas, como inflamado de algúndivino oráculo, cantó aquel saludable verso: «El mejor día de todos los mortaleses el primero que huye.» ¿Cómo te detienes? (dice) ¿Cómo tardas? El tiempohuye si no le ocupas; y aunque le ocupes, huye; y así, se ha de contrastar suceleridad con la presteza de aprovecharle, cogiendo con prisa el agua como dearroyo rápido que en pasando la corriente queda seco. También es muy apropósito para condenar los pensamientos prolongados, que no llaman buena a laedad sino al día.",
    "In order to banish hunger and thirst, it is not necessary for you to pay court at the doors of the purse-proud, or to submit to the stern frown, or to the kindness that humiliates; nor is it necessary for you to scour the seas, or go campaigning",
    ...
    "piccola è la parte di vita che viviamo. Sì: tutto lo spazio rimanente non è vita, ma tempo.",
    "The part of life we really live is small. All the rest of existence is not life, but merely time.”",
    "По заслугам меня оскорбили или нет? Если по заслугам, то это не оскорбление, а справедливое суждение; если не по заслугам, то пусть краснеет тот, кто совершил несправедливость.",
    ...
    "Свобода — не в том, чтобы никогда не становиться жертвой обиды или насмешки. Свобода — в том, чтобы поднять свой дух на недосягаемую для любых обид высоту; чтобы сделать самого себя единственным источником все своих радостей, а все внешнее удалить от себя;",
    "The primary indication, to my thinking, of a well-ordered mind is a man's ability to remain in one place and linger in his own company",
    "Как это чаще всего и бывает: чем больше человек склонен обижать других, тем хуже он сам переносит обиды.",
    "He who fears death will never do anything worthy of a living man.",
    "Homo sit naturaliter animal socialis",
    "LETTERA 22 OCCORRE ABBANDONARE LA VITA PUBBLICA AL MOMENTO GIUSTONessuno si preoccupa di una vita virtuosa, ma pensa solo a quanto tempo potrà vivere. Tuttavia tutti possono vivere bene, nessuno ha il potere di vivere a lungo.",
    ...
    "El que veía que todos los asuntosdependían de él solo, el que asignaba su suerte a hombres y naciones",
    ...
    "The favor of ignoble men can be won only by ignoble means.",
    ...
    "La soledad no es estar solo, la soledad es estar vacío",
    ...
    "of",
    "To what lengths would so precocious an ambition not go?",
    ...
    "Ninguno de esos personajes que ves ataviados con púrpura es feliz, no más que aquellos actores a quienes la pieza teatral asigna los distintivos del cetro y la clámide en la representación. En presencia del público caminan engreídos sobre sus coturnos; tan pronto salen de la escena y se descalzan vuelven a su talla normal. Ninguno de esos individuos, a los que riqueza y cargo sitúan a un nivel superior, es grande",
    "Sometimes even to live is an act of courage",
    "LETTERA 4 IL SAGGIO NON TEME LA MORTEGli uomini, in maggioranza, ondeggiano tra il timore della morte e i tormenti della vita; non hanno il coraggio di vivere, né sanno morire.",
    ...
    "for the soul is never greater than when it has laid aside all extraneous things, and has secured peace for itself by fearing nothing, and riches by craving no riches.",
    ...
    "Nichts ist so bitter, dass man darin nicht mit Gefasstheit Trost fände.",
    ...
    "Nichts ist so bitter, daß man darin nicht mit Gefaßtheit Trost fände.",
    ...
    "LETTERA 19 LA VITA TRANQUILLA E I SUOI VANTAGGINel tuo modo di vivere non devi distinguerti troppo dagli altri, ma neppure devi rimanere nella completa oscurità.",
    ...
    "...el que no deja ningún momento sin dedicarlo a sus intereses, el que organiza todos sus días como si fueran el último, ni ansía el mañana ni lo teme. ¿Qué placer nuevo puede ya reportarle una hora? Todo le es conocido, todo experimentado hasta la saciedad. De lo demás, que la suerte disponga como quiera: su vida está ya a salvo.",
    ...
    "Es ist also [...] nicht die Schuld des Ortes, an dem wir leiden, sondern unsere eigene.",
    ...
    "(About Philosophy) Give your whole mind to her. Sit at her side and pay her constant court, and an enormous gap will widen between yourself and other men. You'll end up far in advance of all mankind, and not far behind the gods themselves.",
    ...
    "LETTERA 37 IL DIFFICILE ESERCIZIO DELLA VIRTÙLa fortuna viene incontro a noi non meno spesso di quanto noi andiamo incontro a lei. È cosa vergognosa, anziché andare verso di lei, lasciarsi trascinare e, presi in mezzo al turbine degli eventi, chiederci con stupore. “Come mai son giunto qui?",
    ...
    "What‟s the use of overcoming opponent after opponent in the wrestling or boxing rings if you can be overcome by your temper?",
    "LETTERA 30 COME AUFIDIO BASSO SI PREPARA ALLA MORTENoi, più che la morte, temiamo il pensiero della morte. In ogni momento siamo ugualmente distanti dalla morte. Se essa deve essere temuta, dobbiamo temerla sempre, perché nessun periodo è esente dalla morte.",
    ...
    "Men do not care how nobly they live, but only how long, although it is within the reach of every man to live nobly, but within no man’s power to live long.",
    "Mad men work for their own destruction",
    ...
    "Philosophy is not something for just a little spare time. Wehave to ignore everything else, work only at this, for whichno time is ever enough. . . . It does not matter if you leave offfor a moment or leave off forever, for once put aside, philosophydoes not last. . . . Give up all other business: do notsimply put it in order—eliminate it.",
    ...
    "LETTERA 16 LA NOSTRA VITA DEVE ESSERE REGOLATA DALLA FILOSOFIAAbbandona, quindi, le vanità e, quando vorrai sapere se i tuoi desideri sono secondo natura oppure ciechi, considera se hanno un termine dove arrestarsi: se, andando avanti nel soddisfare un desiderio, senti sempre più lontano il suo appagamento, sappi che non è un desiderio naturale.",
    ...
    "LETTERA 34 SODDISFAZIONE PER I PROGRESSI DI LUCILIOCosa credi che possa provare chi ha educato una coscienza e, mentre ha incominciato a formarla ancora tenera, la vede ad un tratto matura?",
    ...
    "For over-analysis is faulty in precisely the same way as no analysis at all;",
    ...
    "Fortuna est quae fit cum praeparatio in occasionem incidit. \"Luck is what happens when preparation meets opportunity",
    "Пьянство – это добровольное сумасшествие",
    "El mejor remedio para la ira es el tiempo. No le pidas al principio que perdone, sino que juzgue; si espera, se disipa. No trates de comprimirla de un solo golpe; su primer arrebato es demasiado enérgico; perose la vence por completo si se le ataca por partes.",
    "Tanrı'ya yakın olmak sarsılmamaktır.",
    ...
    "I now warn you not to drown your soul in these petty anxieties of yours; if you do, the soul will be dulled and will have too little vigour left when the time comes for it to arise.",
    ...
    "While he puzzles over increasing his wealth, he forgets how to use it. He collects his accounts, he wears out the pavement in the forum, he turns over his ledger, – in short, he ceases to be master and becomes a steward.",
    "LETTERA 34 INVITO ALLA VERA AMICIZIAÈ vero che, anche quando si è lontani, quelli che amiamo ci danno motivo di gioia, ma essa è lieve e fugace. Invece il loro aspetto, la loro presenza, la loro conversazione danno un senso di vivo piacere, specie se vediamo non solo la persona che desideriamo, ma come la desideriamo.",
    ...
    "Let us think of everything that can happen as something which will happen. 16. I know that you have really done what I advise you to do; I now warn you not to drown your soul in these petty anxieties of yours; if you do, the soul will be dulled and will have too little vigour left when the time comes for it to arise.",
    ...
    "Call to mind when you ever had a fixed purpose; how few days have passed as you had planned; when you were ever at your own disposal; when your face wore its natural expression; when your mind was undisturbed; what work you have achieved in such a long life; how many have plundered your life when you were unawareof your losses; how much you have lost through groundless sorrow, foolish joy, greedy desire, the seductions ofsociety; how little of your own was left: to you. You will realize that you are dying prematurely.'So what is the reason for this? You are living as if destined to live for ever; your own frailty never occurs to you; you don't notice how much time has already passed, but squander it as though you had a full and overflowing supply - though all the while that very day which you are devoting to somebody or something maybe your last. You act like mortals in all that you fear, and like immortals in all that you desire.",
    ...
    "Awake, my heart,And do such deeds as in the time to comeNo tongue shall praise, but none refuse to tell.",
    "What is the happy life? It is peace of mind, and lasting tranquillity. This will be yours if you possess greatness of soul; it will be yours if you possess the steadfastness that resolutely clings to a good judgment just reached.",
    ...
    "Lo principal que pretende la filosofía es sentido común, cortesía y sociabilidad; de tales supuestos nos separará la extravagancia.",
    ...
    "Ta không có quyền thay đổi khi những hoàn cảnh ấy đến với mình. Thay vào đó, điều ta có thể làm là rèn luyện những phẩm cách kiên cường, trở thành một con người sáng suốt và vững vàng, để có thể dũng cảm chịu đựng mọi nghịch cảnh có thể xảy đến, và sống thuận với tự nhiên.",
    ...
    "We think that death comes after, whereas in fact it comes both before and after.",
    ...
    "LETTERA 24 COME SI DEVE AFFRONTARE LA MORTECome non vuota la clessidra l'ultima goccia, ma tutte quelle che sono già cadute, così, l'ultima ora in cui cessiamo di esistere, non produce, da sola, la morte, ma la compie; allora noi giungiamo al termine, ma da tempo vi siamo avviati.",
    "Men trifle with the most precious thing in the world; but they are blind to it because it is an incorporeal thing, because it does not come beneath the sight of the eye, and for this reason it is counted a very cheap thing-nay, of almost no value at all.",
    "Every new beginning comes from some other beginning’s end.",
    "If virtue only stands her ground, she cannot be driven from the field; she must either conquer or be conquered.",
    "For the real Good does not perish; it is certain and lasting and it consists of wisdom and virtue; it is the only immortal thing that falls to mortal lot. But men are so wayward, and so forgetful of their goal and of the point toward which every day jostles them, that they are surprised at losing anything, although some day they are bound to lose everything.",
    ...
    "LETTERA 18 ELOGIO DELLA POVERTÀSe non vuoi che uno si affanni e sia preso dal panico di fronte ad una triste realtà, fallo esercitare prima che essa si presenti.",
    "pues para vivir mucho necesitas al destino, pero para vivir plenamente, la sola diligencia del espíritu.",
    ...
    "LETTERA 15: BISOGNA ESERCITARE LO SPIRITO, PIU' CHE IL CORPONé il freddo, né il caldo, e neppure la vecchiaia, potrà impedire di esercitare le forze dell'animo: cura dunque questo bene, che diventa migliore col passare del tempo.",
    ...
    "Kau ingin hidup, tapi apa kau tahu caranya? Kau takut mati: kenapa? Bukankah hidupmu sudah mati?",
    "LETTERA 23 LA VERA GIOIAMa è difficile avere il senso della misura riguardo a ciò che si ritiene un bene.",
